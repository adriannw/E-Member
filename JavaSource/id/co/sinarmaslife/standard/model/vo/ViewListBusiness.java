...
public class ViewListBusiness implements Serializable
{
    ...
    public ViewListBusiness()
    {
        logger.info( "---------- ViewListBusiness constructor is called ..." );
    }

    public ViewListBusiness(String lsbsId, String lsbsName, String lsdbsNumber, String lsdbsName, String flag,String hardcodedFlag) {
		super();

...
public class Cepr01030113Business
{
    ...
    public Cepr01030113Business( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil )
    {
        this.eproposalManager = eproposalManager;
        this.editorUtil = editorUtil;
    }

    public void resetForm( Cepr01030113Form cepr01030113Form )
    {
        cepr01030113Form.setParticipantVOList( LookupList.getParticipantMedicalPlusVOList() );
    }

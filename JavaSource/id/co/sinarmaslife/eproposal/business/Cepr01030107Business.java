...
public class Cepr01030107Business
{
    ...
    public Cepr01030107Business( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil )
    {
        this.eproposalManager = eproposalManager;
        this.editorUtil = editorUtil;
    }

    public void resetForm( Cepr01030107Form cepr01030107Form )
    {
        cepr01030107Form.setParticipantVOList( LookupList.getParticipantEkaSehatVOList() );
    }

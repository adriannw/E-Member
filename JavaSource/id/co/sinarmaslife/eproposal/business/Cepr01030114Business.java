...
public class Cepr01030114Business
{
    ...
    public Cepr01030114Business( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil )
    {
        this.eproposalManager = eproposalManager;
        this.editorUtil = editorUtil;
    }

    public void resetForm( Cepr01030114Form cepr01030114Form )
    {
        cepr01030114Form.setParticipantVOList( LookupList.getParticipantEkaSehatExtraVOList() );
    }

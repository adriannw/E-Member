...
public class Cepr01030111Business
{
    ...
    public Cepr01030111Business( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil )
    {
        this.eproposalManager = eproposalManager;
        this.editorUtil = editorUtil;
    }

    public void resetForm( Cepr01030111Form cepr01030111Form )
    {
        cepr01030111Form.setParticipantVOList( LookupList.getParticipantLadiesMedExpenseVOList() );
    }

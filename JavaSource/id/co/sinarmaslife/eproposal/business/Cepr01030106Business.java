 ...
 * Function Id         	: 
 * Program Name   		: Cepr01030106Business
 * Description         	:
...
public class Cepr01030106Business
{
    ...
    public Cepr01030106Business( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil )
    {
        this.eproposalManager = eproposalManager;
        this.editorUtil = editorUtil;
    }

    public void resetForm( Cepr01030106Form cepr01030106Form )
    {
        cepr01030106Form.setParticipantVOList( LookupList.getParticipantVOList() );
    }

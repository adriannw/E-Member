 ...
 * Function Id         	: 
 * Program Name   		: Cepr01030110Business
 * Description         	:
...
public class Cepr01030110Business
{
    ...
    public Cepr01030110Business( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil )
    {
        this.eproposalManager = eproposalManager;
        this.editorUtil = editorUtil;
    }

    public void resetForm( Cepr01030110Form cepr01030110Form )
    {
        cepr01030110Form.setParticipantVOList( LookupList.getParticipantHcpLadiesVOList() );
    }

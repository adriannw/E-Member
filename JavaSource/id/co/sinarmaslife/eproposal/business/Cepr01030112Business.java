...
public class Cepr01030112Business
{
    ...
    public Cepr01030112Business( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil )
    {
        this.eproposalManager = eproposalManager;
        this.editorUtil = editorUtil;
    }

    public void resetForm( Cepr01030112Form cepr01030112Form )
    {
        cepr01030112Form.setParticipantVOList( LookupList.getParticipantLadiesMedExpenseInnerLimitVOList() );
    }

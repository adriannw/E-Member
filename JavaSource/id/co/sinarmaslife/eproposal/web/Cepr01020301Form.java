...
public class Cepr01020301Form implements Serializable{
	 ...
	 * Version              : 1.0
	 * Creation Date    	: Nov 28, 2012 10:37:52 AM
	 *
	 ...
	 ***********************************************************************/
	private static final long serialVersionUID = 1112834574649606470L;
	...
	private List< OptionVO > allDivision;
    private List< OptionVO > listRecords;
    private List< OptionVO > acPassList;
	...
	public List<OptionVO> getAllDivision() {
		return allDivision;
	}
	public void setAllDivision(List<OptionVO> allDivision) {
	...
	public List<OptionVO> getAcPassList() {
		return acPassList;
	}
	public void setAcPassList(List<OptionVO> acPassList) {
		this.acPassList = acPassList;
	}

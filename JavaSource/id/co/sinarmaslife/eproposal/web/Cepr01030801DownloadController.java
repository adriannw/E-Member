...
public class Cepr01030801DownloadController extends StandardParent implements Controller
{

    public ModelAndView handleRequest( HttpServletRequest request, HttpServletResponse response )
            throws ServletException
    {
        logger.info( "*-*-*-* Cepr01030801DownloadController.handleRequest" );
...
//        String dirName = "d:\\EproposalLite\\pdf";
        String fileName = "KETENTUAN_EKA_SEHAT.pdf";

...
public class Cepr01030802DownloadController extends StandardParent implements Controller
{

    public ModelAndView handleRequest( HttpServletRequest request, HttpServletResponse response )
            throws ServletException
    {
        logger.info( "*-*-*-* Cepr01030802DownloadController.handleRequest" );
...
//        String dirName = "d:\\EproposalLite\\pdf";
        String fileName = "FORM_PROFIL_RISIKO_NASABAH.pdf";

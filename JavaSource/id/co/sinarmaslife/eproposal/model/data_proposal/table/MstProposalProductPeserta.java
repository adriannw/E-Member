package id.co.sinarmaslife.eproposal.model.data_proposal.table;
...
public class MstProposalProductPeserta implements Serializable {
	...
	private Integer sex; //IGA 19112020 Khusus untuk medical plus menggunakan validasi gender
	
	public MstProposalProductPeserta(){};
	
	public MstProposalProductPeserta(HashMap<String, Object> map){
        ...
        if(map.get("SEX")!=null)			sex = new BigDecimal(map.get("SEX").toString()).intValue(); //IGA 19112020 Khusus untuk medical plus menggunakan validasi gender
	}
    ...
    public Integer getSex() {//IGA 19112020 Khusus untuk medical plus menggunakan validasi gender
        return sex;
    }

    
    public void setSex(Integer sex) {//IGA 19112020 Khusus untuk medical plus menggunakan validasi gender
        this.sex = sex;
    }
}

...
public class S_medicalPlus implements Serializable
{
    /**********************************************************************
	 * Program History
	 *
	 ...
	 * Version              : 1.0
	 * Creation Date    	: Aug 30, 2012 10:21:45 AM
	 *
	 * Version      Re-fix date                 Person in charge    Description
	 *
	 *
	 ...
	 ***********************************************************************/
	private static final long serialVersionUID = -8392934684654134260L;
	public int peserta;
    public String[] nama = new String[4 + 1]; 
    public Date[] tgl = new Date[4 + 1];
    public int[] usia = new int[4 + 1];
    public String[] gender = new String[4 + 1];
    public String[] medicalPlusRbFlag = new String[4 + 1];

...
//            hcpIdrList.add( optionVO );
            ...
            hcpIdrList.add( optionVO );
            optionVO = new OptionVO( "11", "R-1500" );
            hcpIdrList.add( optionVO );
            optionVO = new OptionVO( "12", "R-2000" );
            hcpIdrList.add( optionVO );
        }
        return hcpIdrList;
    }
...
//            hcpUsdList.add( optionVO );
            optionVO = new OptionVO( "13", "D-10" );
            hcpUsdList.add( optionVO );
            optionVO = new OptionVO( "14", "D-20" );
            hcpUsdList.add( optionVO );
            optionVO = new OptionVO( "15", "D-30" );
            hcpUsdList.add( optionVO );
            optionVO = new OptionVO( "16", "D-40" );
            hcpUsdList.add( optionVO );
            optionVO = new OptionVO( "17", "D-50" );
            hcpUsdList.add( optionVO );
            optionVO = new OptionVO( "18", "D-60" );
            hcpUsdList.add( optionVO );
            optionVO = new OptionVO( "19", "D-70" );
            hcpUsdList.add( optionVO );
            optionVO = new OptionVO( "20", "D-80" );
            hcpUsdList.add( optionVO );
            optionVO = new OptionVO( "21", "D-90" );
            hcpUsdList.add( optionVO );
            optionVO = new OptionVO( "22", "D-100" );
            hcpUsdList.add( optionVO );
            optionVO = new OptionVO( "23", "D-150" );
            hcpUsdList.add( optionVO );
            optionVO = new OptionVO( "24", "D-200" );
            hcpUsdList.add( optionVO );
        }
        return hcpUsdList;
    }

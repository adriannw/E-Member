...
public class FormatString implements Serializable { 
	...
	protected final static Log logger = LogFactory.getLog( FormatString.class );
...
//		Regex reg14 = new Regex("\\d{14,14}");
	...
	/**
	  ...
	  public static void main(String [] args){
		...
		//  System.out.print("jumlah karakter ="+result.length);
		  logger.debug( "jumlah karakter ="+result.length );
		  logger.info(" ");

...
public class Cepr01030501Dao extends EproposalDao
{
    public List<ViewListProvider> selectAllProviderList( Map<String, Object> params ) throws DataAccessException
    {  	
    	
    		return query( "selectAllProviderList", params );
    	
    }
    
    public List<OptionVO> selectAllCityProvider( Map<String, Object> params ) throws DataAccessException
    {  	
    	
    		return query( "selectAllCityProvider", params );
    	
    }
    
    public List<TotalPage> selectTotalProviderPage( Map<String, Object> params ) throws DataAccessException
    {  	
    	
    		return query( "selectTotalProviderPage", params );

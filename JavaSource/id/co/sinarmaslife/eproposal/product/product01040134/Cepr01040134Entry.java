 ...
 * Function Id         	: 01040134
 * Program Name   		: Cepr01040134Entry
...
public class Cepr01040134Entry extends Cepr01040000Entry implements Cepr01040000EntryInterface
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040134Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
        super( eproposalManager, editorUtil, command, errors );
        logger.info( "*-*-*-* Cepr01040134Entry constructor is called ..." );
        setDownloadUrl( "wepr01040134.pdf" );
    }

    public void initDisplayedForm()
    {
        logger.info( "*-*-*-* Cepr01040134Entry.initDisplayedForm" );
        displayStandardForm();
//        displayAdditionalAssurance( true );
    ...
    {
        logger.info( "*-*-*-* Cepr01040134Entry.initDisabledForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040134Entry.initReadOnlyForm" );
        readOnlyAllForm( false );
    }

    public void fillDefaultValueEachTimeRightPartOfBusinessCdChanged()
    {
        logger.info( "*-*-*-* Cepr01040134Entry.fillDefaultValueEachTimeRightPartOfBusinessCdChanged" );
        ...
        if( cepr01030102Form.getRightPartOfBusinessCd() ==  Cepr01040134Mapper.X19 || cepr01030102Form.getRightPartOfBusinessCd() ==  Cepr01040134Mapper.X22 )
	    {
        	premiumList = Cepr00000000Generator.genMoneyList( editorUtil, 5000000, 17000000, 1000000 );
	    }
        else if( cepr01030102Form.getRightPartOfBusinessCd() ==  Cepr01040134Mapper.X20|| cepr01030102Form.getRightPartOfBusinessCd() ==  Cepr01040134Mapper.X23)
	    {
        	premiumList = Cepr00000000Generator.genMoneyList( editorUtil, 21000000, 33000000, 1000000 );
	    }
        else if( cepr01030102Form.getRightPartOfBusinessCd() ==  Cepr01040134Mapper.X21|| cepr01030102Form.getRightPartOfBusinessCd() ==  Cepr01040134Mapper.X24)
	    {
        	premiumList = Cepr00000000Generator.genMoneyList( editorUtil, 76000000, 88000000, 1000000 );
	    }
    ...
    public void validateCurrentPage()
    {
        if( cepr01030102Form.getPremium() != null )
        {
            ...
            if( Cepr01040134Mapper.X19 == cepr01030102Form.getRightPartOfBusinessCd() || Cepr01040134Mapper.X22 == cepr01030102Form.getRightPartOfBusinessCd() )
    	    {
            ...
            else if( Cepr01040134Mapper.X20 == cepr01030102Form.getRightPartOfBusinessCd() || Cepr01040134Mapper.X23 == cepr01030102Form.getRightPartOfBusinessCd() )
    	    {
            	if( cepr01030102Form.getPaymentModeCd() == Hardcode.PAY_MODE_CD_TRIWULANAN )
                {
                	minimumPremiumIdr = 5400000;
                    maksimumPremiumIdr = 20250000;
                }
                else if( cepr01030102Form.getPaymentModeCd() == Hardcode.PAY_MODE_CD_SEMESTERAN ) 
                {
                	minimumPremiumIdr = 10500000;
                    maksimumPremiumIdr = 39375000;
                }
                else if( cepr01030102Form.getPaymentModeCd() == Hardcode.PAY_MODE_CD_TAHUNAN )
                {
                	minimumPremiumIdr = 20000000;
                    maksimumPremiumIdr = 75000000;
                }
    	    }
            else if( Cepr01040134Mapper.X21 == cepr01030102Form.getRightPartOfBusinessCd() || Cepr01040134Mapper.X24 == cepr01030102Form.getRightPartOfBusinessCd() )
    	    {
            	if( cepr01030102Form.getPaymentModeCd() == Hardcode.PAY_MODE_CD_TRIWULANAN )
                {
                	minimumPremiumIdr = 20250000;
                    maksimumPremiumIdr = 270000000;
                }
                else if( cepr01030102Form.getPaymentModeCd() == Hardcode.PAY_MODE_CD_SEMESTERAN ) 
                {
                	minimumPremiumIdr = 39375000;
                    maksimumPremiumIdr = 525000000;
                }
                else if( cepr01030102Form.getPaymentModeCd() == Hardcode.PAY_MODE_CD_TAHUNAN )
                {
                	minimumPremiumIdr = 75000000;
    ...
    {
        logger.info( "*-*-*-* Cepr01040134Entry.validatePreviousPage" );

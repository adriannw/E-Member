 ...
 * Function Id         	: 01040135
 * Program Name   		: Cepr01040135Entry
...
public class Cepr01040135Entry extends Cepr01040000Entry implements Cepr01040000EntryInterface

{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040135Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
        super( eproposalManager, editorUtil, command, errors );
        logger.info( "*-*-*-* Cepr01040135Entry constructor is called ..." );
        setDownloadUrl( "wepr01040135.pdf" );
    }

    public void initDisplayedForm()
    {
        logger.info( "*-*-*-* Cepr01040135Entry.initDisplayedForm" );
        displayStandardForm();
    ...
    {
        logger.info( "*-*-*-* Cepr01040135Entry.initDisabledForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040135Entry.initReadOnlyForm" );
        readOnlyAllForm( false );
    }

    public void fillDefaultValueEachTimeRightPartOfBusinessCdChanged()
    {
        logger.info( "*-*-*-* Cepr01040135Entry.fillDefaultValueEachTimeRightPartOfBusinessCdChanged" );
    }

    public void fillDefaultValueEachTimeFormCalled()
    {
        logger.info( "*-*-*-* Cepr01040135Entry.fillDefaultValueEachTimeFormCalled" );
        ...
        if( Hardcode.CUR_IDR_CD.equals( cepr01030102Form.getCurrencyCd() ) )
        {
            ...
            {	t = "";
                if(i > 9){
                	t = i+"";
                	value = "" + t.substring(0, 1) + "," + t.substring(1) + "00,000.00";
                }else{
                	value = "" + i + "00,000.00";
                }
        ...
        cepr01030102Form.setMgiList( comboLookupBusiness.getMonthOptionVOList( true, new Integer[]{ 1 } ) );
    ...
    {
        logger.info( "*-*-*-* Cepr01040135Entry.validateCurrentPage" );
...
//        if( Cepr01040135Mapper.X5 == rightPartOfBusinessCd )
//        {
...
//        }
    ...
    {
        logger.info( "*-*-*-* Cepr01040135Entry.validatePreviousPage" );
        commonValidator.validateInsuredAge( Cepr01030102FormConst.ASSURANCE_PLAN_CD, 1, 68 );
    }

    public void processFormAfterSubmitBeforeValidation()
    {
        logger.info( "*-*-*-* Cepr01040135Entry.processFormAfterSubmitBeforeValidation" );

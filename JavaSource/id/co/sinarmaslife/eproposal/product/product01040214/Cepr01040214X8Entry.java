...
public class Cepr01040214X8Entry extends Cepr01040214Entry
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040214X8Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
        super( eproposalManager, editorUtil, command, errors );
        logger.info( "*-*-*-* Cepr01040214X8Entry constructor is called ..." );
    }

    public void initDisplayedForm()
    {
        logger.info( "*-*-*-* Cepr01040214X8Entry.initDisplayedForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040214X8Entry.initDisabledForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040214X8Entry.initReadOnlyForm" );
        super.initReadOnlyForm();
    }

    public void fillDefaultValueEachTimeRightPartOfBusinessCdChanged()
    {
        logger.info( "*-*-*-* Cepr01040214X8Entry.fillDefaultValueEachTimeRightPartOfBusinessCdChanged" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040214X8Entry.fillDefaultValueEachTimeFormCalled" );
...
//        cepr01030102Form.setPremiumCombinationList( LookupList.getPremiumCombinationFoldedList( 20 ) );
    ...
    {
        logger.info( "*-*-*-* Cepr01040214X8Entry.validateCurrentPage" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040214X8Entry.processFormAfterSubmitBeforeValidation" );
        double premium = LazyConverter.toDouble( cepr01030102Form.getPremium() );

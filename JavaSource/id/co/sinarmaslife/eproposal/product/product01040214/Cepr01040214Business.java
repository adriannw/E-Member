 ...
 * Function Id         	: 
 * Program Name   		: Cepr01040214Business
 * Description         	:
...
public class Cepr01040214Business extends Cepr01040000Ilustration116Business {
	protected final Log logger = LogFactory.getLog(getClass());

	public Cepr01040214Business(EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command) {
		super(eproposalManager, editorUtil, command);
		// setSekaligusRightPartCdArr( new Integer[]{ Cepr01040214Mapper.X5,
		// Cepr01040214Mapper.X6 } );
		setBerkalaRightPartCdArr(new Integer[] { Cepr01040214Mapper.X7, Cepr01040214Mapper.X8, Cepr01040214Mapper.X9,
				Cepr01040214Mapper.X10 });
	...
	public String[][] getRiderPremiumList(Cepr01030102Form cepr01030102Form) throws IOException {
		...
		// If (Pos('01, 03, 07, 09', string(istr_prop.bisnis_no, '00#')) > 0) and
		// istr_prop.bisnis_id = 127 Then
		// //cerdas siswa A/B 5
		// istr_prop.rider_baru[1] = 1 //810 pa
		// istr_prop.rider_baru[6] = 14 //815 payor tpd
		// istr_prop.rider_baru[8] = 5 //817 payor ci
		// Elseif (Pos('02, 04, 08, 10', string(istr_prop.bisnis_no, '00#')) > 0) and
		// istr_prop.bisnis_id = 127 Then
		// //cerdas siswa A/B 10
		// istr_prop.rider_baru[1] = 1 //810 pa
		...
		if (cepr01030102Form.getRightPartOfBusinessCd() == 1 || cepr01030102Form.getRightPartOfBusinessCd() == 3
				|| cepr01030102Form.getRightPartOfBusinessCd() == 7
			...
			if (istr_prop.rider_baru[8] > 0)
				istr_prop.rider_baru[8] = 5; // 817 payor ci
		} else if (cepr01030102Form.getRightPartOfBusinessCd() == 2 || cepr01030102Form.getRightPartOfBusinessCd() == 4
				|| cepr01030102Form.getRightPartOfBusinessCd() == 8
	...
	public Map<String, Object> getIllustration214Result(int lamaBayar) {
		...
		for (int i = 1; i <= istr_prop.ins_per; i++) {
			...
			logger.info("----***ldec_coi" + ldec_coi);
			logger.info("----***ldec_mfc" + ldec_mfc);
			logger.info("----***ldec_cost" + ldec_cost);

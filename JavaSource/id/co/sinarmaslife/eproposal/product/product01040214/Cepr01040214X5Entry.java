 ...
 * Function Id         	: 
 * Program Name   		: Cepr01040214X4Entry
 * Description         	:
...
public class Cepr01040214X5Entry extends Cepr01040214Entry
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040214X5Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
        super( eproposalManager, editorUtil, command, errors );
        logger.info( "*-*-*-* Cepr01040214X4Entry constructor is called ..." );
    }

    public void initDisplayedForm()
    {
        logger.info( "*-*-*-* Cepr01040214X4Entry.initDisplayedForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040214X4Entry.initDisabledForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040214X4Entry.initReadOnlyForm" );
        super.initReadOnlyForm();
    }

    public void fillDefaultValueEachTimeRightPartOfBusinessCdChanged()
    {
        logger.info( "*-*-*-* Cepr01040214X4Entry.fillDefaultValueEachTimeRightPartOfBusinessCdChanged" );
        cepr01030102Form.setTotalSumInsuredIsDisabled( CommonConst.DISABLED_TRUE );
    ...
    {
        logger.info( "*-*-*-* Cepr01040214X4Entry.fillDefaultValueEachTimeFormCalled" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040214X4Entry.validateCurrentPage" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040214X4Entry.processFormAfterSubmitBeforeValidation" );
        double premium = LazyConverter.toDouble( cepr01030102Form.getPremium() );

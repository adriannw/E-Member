 ...
 * Function Id         	: 
 * Program Name   		: Cepr01040214X10Entry
 * Description         	:
...
public class Cepr01040214X10Entry extends Cepr01040214Entry
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040214X10Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
        super( eproposalManager, editorUtil, command, errors );
        logger.info( "*-*-*-* Cepr01040214X10Entry constructor is called ..." );
    }

    public void initDisplayedForm()
    {
        logger.info( "*-*-*-* Cepr01040214X10Entry.initDisplayedForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040214X10Entry.initDisabledForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040214X10Entry.initReadOnlyForm" );
        super.initReadOnlyForm();
    }

    public void fillDefaultValueEachTimeRightPartOfBusinessCdChanged()
    {
        logger.info( "*-*-*-* Cepr01040214X10Entry.fillDefaultValueEachTimeRightPartOfBusinessCdChanged" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040214X10Entry.fillDefaultValueEachTimeFormCalled" );
...
//        cepr01030102Form.setPremiumCombinationList( LookupList.getPremiumCombinationFoldedList( 20 ) );
    ...
    {
        logger.info( "*-*-*-* Cepr01040214X10Entry.validateCurrentPage" );
        ...
        if( cepr01030101Form.getInsuredAge() < 	6 ){
        	commonValidator.validateMaximumMoney( Cepr01030102FormConst.TOTAL_SUM_INSURED, cepr01030102Form.getTotalSumInsured().doubleValue(), 500000000, 50000 );
        }
    ...
    {
        logger.info( "*-*-*-* Cepr01040214X10Entry.processFormAfterSubmitBeforeValidation" );
        double premium = LazyConverter.toDouble( cepr01030102Form.getPremium() );

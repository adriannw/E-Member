...
public class Cepr01040214X2Entry extends Cepr01040214Entry
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040214X2Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
        super( eproposalManager, editorUtil, command, errors );
        logger.info( "*-*-*-* Cepr01040214X2Entry constructor is called ..." );
    }

    public void initDisplayedForm()
    {
        logger.info( "*-*-*-* Cepr01040214X2Entry.initDisplayedForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040214X2Entry.initDisabledForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040214X2Entry.initReadOnlyForm" );
        super.initReadOnlyForm();
    }

    public void fillDefaultValueEachTimeRightPartOfBusinessCdChanged()
    {
        logger.info( "*-*-*-* Cepr01040214X2Entry.fillDefaultValueEachTimeRightPartOfBusinessCdChanged" );
        cepr01030102Form.setTotalSumInsuredIsDisabled( CommonConst.DISABLED_TRUE );
    ...
    {
        logger.info( "*-*-*-* Cepr01040214X2Entry.fillDefaultValueEachTimeFormCalled" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040214X2Entry.validateCurrentPage" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040214X2Entry.processFormAfterSubmitBeforeValidation" );
        double premium = LazyConverter.toDouble( cepr01030102Form.getPremium() );

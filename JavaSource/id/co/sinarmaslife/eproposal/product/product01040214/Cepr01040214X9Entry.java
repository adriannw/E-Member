 ...
 * Function Id         	: 
 * Program Name   		: Cepr01040214X9Entry
 * Description         	:
...
public class Cepr01040214X9Entry extends Cepr01040214Entry
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040214X9Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
        super( eproposalManager, editorUtil, command, errors );
        logger.info( "*-*-*-* Cepr01040214X9Entry constructor is called ..." );
    }

    public void initDisplayedForm()
    {
        logger.info( "*-*-*-* Cepr01040214X9Entry.initDisplayedForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040214X9Entry.initDisabledForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040214X9Entry.initReadOnlyForm" );
        super.initReadOnlyForm();
    }

    public void fillDefaultValueEachTimeRightPartOfBusinessCdChanged()
    {
        logger.info( "*-*-*-* Cepr01040214X9Entry.fillDefaultValueEachTimeRightPartOfBusinessCdChanged" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040214X9Entry.fillDefaultValueEachTimeFormCalled" );
...
//        cepr01030102Form.setPremiumCombinationList( LookupList.getPremiumCombinationFoldedList( 20 ) );
    ...
    {
        logger.info( "*-*-*-* Cepr01040214X9Entry.validateCurrentPage" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040214X9Entry.processFormAfterSubmitBeforeValidation" );
        double premium = LazyConverter.toDouble( cepr01030102Form.getPremium() );

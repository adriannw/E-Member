...
public class Cepr01040114DownloadController extends StandardParent implements Controller
{
            ...
            throws ServletException, IOException
    {
        ...
        Cepr01040114Business cepr01040114Business = new Cepr01040114Business( eproposalManager, editorUtil, command );

        ModelAndView result;
        if( request.getSession().getAttribute( "messageEkaSehatList" ) == null )
        {
        	List<String> messageEkaSehatList = cepr01040114Business.getEkaSehatMsgBox();
        ...
        {
            List<String> messageBoxList = cepr01040114Business.getMedicalMsgBox();
        ...
        else
        {
            ...
            jasperViewer.setUrl( "/WEB-INF/classes/" + "id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040114_product.jasper" );
            
            //params.put( "title", "SMiLe LINK EDUVEST" );
           ...
           // params.put( "placeAndDate", "Jakarta, " + FormatDate.toIndonesian( eproposalManager.selectNowDate() ) );
            ...
            String[][] riderTambahan = cepr01040114Business.getRiderPremiumList( cepr01030102Form );
...
//                alokasiInvestasiTinggi = alokasiInvestasiTinggi + "0.00%";
            ...
            String tipeMedisPP = cepr01040114Business.getTipeMedis(cepr01030101Form.getPolicyHolderAge());
            String tipeMedisTT = cepr01040114Business.getTipeMedis(cepr01030101Form.getInsuredAge());
            ...
            mapMaster = cepr01040114Business.getIllustration114Result(cepr01030102Form.getTermOfPayment());
            ...
            logger.info( "*-*-*-* cepr01040201Business.getInvestmentYield() = " + cepr01040114Business.getInvestmentYield() );
            params.put( "totalInvestmentAllocation", cepr01040114Business.getInvestmentYield().getTotalInvestmentAllocation() );
            params.put( "totalAssumptionLow", cepr01040114Business.getInvestmentYield().getTotalAssumptionLow() );
            params.put( "totalAssumptionMid", cepr01040114Business.getInvestmentYield().getTotalAssumptionMid() );
            params.put( "totalAssumptionHi", cepr01040114Business.getInvestmentYield().getTotalAssumptionHi() );
            ...
            params.put( "dsInvestmentYield", JasperReportsUtils.convertReportData( cepr01040114Business.getInvestmentYield().getYieldList() ) );
...
//            paymentMode
            ...
            params.put( "dsEkalinkRider", JasperReportsUtils.convertReportData( cepr01040114Business.getRiderPremiumList(cepr01030102Form, cepr01030101Form.getInsuredAge()) ) );
            ...
            params.put( "dataSource", cepr01040114Business.getPageList( currentIdx ) );
          ...
          //  String fileName="testx.pdf";
            ...
            List temp = cepr01040114Business.getPageList( currentIdx );
           ...
           try{
	        	   ...
	        	   //if(cekDataApprovedOrNot.get(0).getPosisi()<3){
			            JasperUtils.exportReportToPdf(
			            		"id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040114_product.jasper",
			            		dirName,
			                fileName,
							params,
							temp,

 ...
 * Function Id         	: 
 * Program Name   		: Cepr01040101DownloadController
...
public class Cepr01040101DownloadController extends StandardParent implements Controller
{

    public ModelAndView handleRequest( HttpServletRequest request, HttpServletResponse response )
            throws ServletException, IOException
    {
        logger.info( "*-*-*-* Cepr01040101DownloadController.handleRequest" );
...
//            jasperViewer.setUrl( "/WEB-INF/classes/" + "id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040101_product.jasper" );
...
//            jasperViewer.setReportDataKey( "dataSource" );
            ...
            params.put( "insuredName", cepr01030101Form.getInsuredName() );
            ...
            params.put( "clazzCd", editorUtil.convertToString( cepr01030102Form.getClazzCd() ) + " (" + AngkaTerbilang.indonesian( cepr01030102Form.getClazzCd().toString() )  + ")" );
            String currencySymbol = MappingUtil.getLabel( cepr01030102Form.getCurrencyList(), cepr01030102Form.getCurrencyCd() );
            params.put( "totalSumInsured", currencySymbol + editorUtil.convertToString( cepr01030102Form.getTotalSumInsured() ) );
            params.put( "premium", currencySymbol + editorUtil.convertToString( cepr01030102Form.getPremium() ) );
            params.put( "paymentMode", MappingUtil.getLabel( cepr01030102Form.getPaymentModeList(), editorUtil.convertToString( cepr01030102Form.getPaymentModeCd() ) ) );
           ...
           try{      
	        	   //if(cekDataApprovedOrNot.get(0).getPosisi()<3){
			            JasperUtils.exportReportToPdf(
			            		"id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040101_product.jasper",
			            		dirName,
			                fileName,
							params,
							temp,

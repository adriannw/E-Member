...
public class Cepr01040221Entry extends Cepr01040000UlinkEntry implements Cepr01040000EntryInterface
{
    protected final Log logger = LogFactory.getLog( getClass() );
    private static final int ASSURANCE_TERM = 100;

    public Cepr01040221Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
        super( eproposalManager, editorUtil, command, errors );
        logger.info( "*-*-*-* Cepr01040221Entry constructor is called ..." );
        setDownloadUrl( "wepr01040221.pdf" );
    }
...
//        restore investment choice
    ...
    public void fillDefaultValueEachTimeFormCalled()
    {
        ...
        if( Hardcode.CUR_IDR_CD.equals( cepr01030102Form.getCurrencyCd() ) )
        {
            ...
            cepr01030102Form.setLjiAggresiveUsdListDisplay( CommonConst.DISPLAY_FALSE ); /**USD Fund BSIM Products**/
        ...
        else if( Hardcode.CUR_USD_CD.equals( cepr01030102Form.getCurrencyCd() ) )
        {
            ...
            cepr01030102Form.setLjiAggresiveUsdList(LookupList.getJenisGlobalEquityUsdList());
        }

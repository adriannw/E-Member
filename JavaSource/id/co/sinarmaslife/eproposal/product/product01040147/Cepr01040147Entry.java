...
public class Cepr01040147Entry extends Cepr01040000UlinkEntry implements Cepr01040000EntryInterface
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040147Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
        super( eproposalManager, editorUtil, command, errors );
        logger.info( "*-*-*-* Cepr01040147Entry constructor is called ..." );
        setDownloadUrl( "wepr01040147.pdf" );
    } 
...
//        	cepr01030102Form.setSpecialOfferListIsDisabled( CommonConst.DISABLED_TRUE );
    ...
    public void fillDefaultValueEachTimeFormCalled()
    {
        ...
        if( Cepr01040147Mapper.X1 == rightPartOfBusinessCd )
        {
            cepr01030102Form.setTermOfPayment( 5 );
        }
        else if( Cepr01040147Mapper.X2 == rightPartOfBusinessCd )
        {

...
public class Cepr01040147Business extends Cepr01040000Ilustration116Business
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040147Business( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command )
    {
        super( eproposalManager, editorUtil, command );
        setSekaligusRightPartCdArr( new Integer[]{ Cepr01040147Mapper.X1 } );
        setBerkalaRightPartCdArr( new Integer[]{ Cepr01040147Mapper.X2} );
        ...
        setInvestmentTitleAndDescrArr( new String[][] {
            ...
            { "", "- EXCELLINK Dynamic Syariah Fund : minimum 50% Fixed Income dan maksimum 50% Ekuitas", "  Penempatan dana pada investasi pendapatan tetap, ekuitas serta instrumen pasar uang." },

 ...
 * Function Id         	: 
 * Program Name   		: Cepr01040209Entry (134)
 * Description         	:
...
public class Cepr01040209Entry extends Cepr01040000UlinkEntry implements Cepr01040000EntryInterface
{
    protected final Log logger = LogFactory.getLog( getClass() );
    private static final int ASSURANCE_TERM = 80;

    public Cepr01040209Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
        super( eproposalManager, editorUtil, command, errors );
        logger.info( "*-*-*-* Cepr01040209Entry constructor is called ..." );
        setDownloadUrl( "wepr01040209.pdf" );
    }

    public void initDisplayedForm()
    {
        logger.info( "*-*-*-* Cepr01040209Entry.initDisplayedForm" );
        displayStandardForm();
    ...
    {
        logger.info( "*-*-*-* Cepr01040209Entry.initDisabledForm" );
...
//        restore investment choice
    ...
    {
        logger.info( "*-*-*-* Cepr01040209Entry.initReadOnlyForm" );
        readOnlyAllForm( false );
    }

    public void fillDefaultValueEachTimeRightPartOfBusinessCdChanged()
    {
        logger.info( "*-*-*-* Cepr01040209Entry.fillDefaultValueEachTimeRightPartOfBusinessCdChanged" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040209Entry.fillDefaultValueEachTimeFormCalled" );
        ...
        cepr01030102Form.setPremiumFurloughYearList( LookupList.getSequenceNumberList( 10, 10, 5, false ) );
        ...
        {
            premiumList = Cepr00000000Generator.genMoneyList( editorUtil, 5000000, 14000000, 1000000 );
        }
        else if( Hardcode.CUR_USD_CD.equals( cepr01030102Form.getCurrencyCd() ) )
        {
            premiumList = Cepr00000000Generator.genMoneyList( editorUtil, 500, 400, 50 );
        }
    ...
    {
        logger.info( "*-*-*-* Cepr01040209Entry.validateCurrentPage" );
...
//        super.validateCurrentPage( parVO );
    ...
    {
        logger.info( "*-*-*-* Cepr01040209Entry.validatePreviousPage" );
        commonValidator.validateInsuredAge( Cepr01030102FormConst.ASSURANCE_PLAN_CD, 0, 70 );
    }

    public void processFormAfterSubmitBeforeValidation()
    {
        logger.info( "*-*-*-* Cepr01040209Entry.processFormAfterSubmitBeforeValidation" );
        ...
        // Proses ini dijalankan setelah tombol: Lihat Proposal diklik sebelum Validasi
        // proses kalkulasi otomatis: UP dijalankan jika combobox premi diubah / tombol HITUNG diklik
        // Nilai textbox UP: enabled & dapat diedit
            ...
            || new BigDecimal( "0" ).equals( cepr01030102Form.getTotalSumInsured() ) )
        {
            ...
            // Minimum Uang Pertanggungan (UP) Berkah Link (166-X2) 7.500.000
            if (idec_up<7500000){
            	idec_up=7500000;
            }
    ...
    {
        logger.info( "*-*-*-* Cepr01040209Entry.validateCurrentPageInCommon" );
        double premium = LazyConverter.toDouble( cepr01030102Form.getPremium() );
        ...
        switch( cepr01030102Form.getPaymentModeCd() )
        {
            ...
            case Hardcode.PAY_MODE_CD_BULANAN:
                ...
                break;
            default:
                throw new RuntimeException( "*-*-*-* cepr01030102Form.getPaymentModeCd() not listed in Cepr01040209Entry.validateCurrentPage" );
        }
    ...
    public static List<OptionVO> getHcpList()
    {
        ...
        if( hcpList == null )
        {
            ...
            OptionVO optionVO;
            optionVO = new OptionVO( "1", "R100" );
            hcpList.add( optionVO );
            optionVO = new OptionVO( "2", "R200" );
            hcpList.add( optionVO );
            optionVO = new OptionVO( "3", "R300" );
            hcpList.add( optionVO );
            optionVO = new OptionVO( "4", "R400" );
            hcpList.add( optionVO );
            optionVO = new OptionVO( "5", "R500" );
            hcpList.add( optionVO );
            optionVO = new OptionVO( "6", "R1000" );
            hcpList.add( optionVO );
        }
        return hcpList;
    }
    ...
    public static List<OptionVO> getPremiumCombinationList()
    {
        ...
        value = 60 + ".00";
        label = "Premi Pokok " + 60 + "%, Premi Top-Up Berkala " + ( 100 - 60 ) + "%";
        optionVO = new OptionVO( value, label );
        premiumCombinationList.add( optionVO );
        ...
        value = 40 + ".00";
        label = "Premi Pokok " + 40 + "%, Premi Top-Up Berkala " + ( 100 - 40 ) + "%";
        optionVO = new OptionVO( value, label );
        premiumCombinationList.add( optionVO );
        
        value = 20 + ".00";
        label = "Premi Pokok " + 20 + "%, Premi Top-Up Berkala " + ( 100 - 20 ) + "%";
        optionVO = new OptionVO( value, label );
        premiumCombinationList.add( optionVO );

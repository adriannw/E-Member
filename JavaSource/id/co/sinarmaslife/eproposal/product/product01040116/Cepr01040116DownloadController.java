...
public class Cepr01040116DownloadController extends StandardParent implements Controller
{
    ...
    {
        logger.info( "*-*-*-* Cepr01040116DownloadController.handleRequest" );
        ...
        Cepr01040116Business cepr01040112Business = new Cepr01040116Business( eproposalManager, editorUtil, command );
        ...
        else
        {
            ...
            // EKASISWA EMAS NEW
            int[] akhirTahunAnak = {12, 15, 18, 19, 20, 21, 22, 25};
            // EKASISWA EMAS
            ...
            // 01 -> rupiah
            // 02 -> dolar
            if(insuredAge>=0 && insuredAge<=9){
            	if("01".equals(cepr01030102Form.getCurrencyCd())){
            		int[] akhirTahunAnakTemp = {12, 15, 18, 19, 20, 21, 22, 25};
                	int[] persentaseUpTemp = {40, 40, 100, 25, 25, 25, 25, 100};
                	akhirTahunAnak2 = akhirTahunAnakTemp;
                	persentaseUp = persentaseUpTemp;
            	}else if("02".equals(cepr01030102Form.getCurrencyCd())){
            		int[] akhirTahunAnakTemp = {12, 15, 18, 19, 20, 21, 22, 25};
                	int[] persentaseUpTemp = {10, 15, 100, 50, 50, 50, 50, 100};
                	akhirTahunAnak2 = akhirTahunAnakTemp;
                	persentaseUp = persentaseUpTemp;
            	}
            }else if(insuredAge>=10 && insuredAge<=12){
            	if("01".equals(cepr01030102Form.getCurrencyCd())){
            		int[] akhirTahunAnakTemp = {15, 18, 19, 20, 21, 22, 25};
                	int[] persentaseUpTemp = {0, 40, 100, 25, 25, 25, 25, 100};
                	persentaseUp = persentaseUpTemp;
                	akhirTahunAnak2 = akhirTahunAnakTemp;
            	}else if("02".equals(cepr01030102Form.getCurrencyCd())){
            		int[] akhirTahunAnakTemp = {15, 18, 19, 20, 21, 22, 25};
                	int[] persentaseUpTemp = {0, 15, 100, 50, 50, 50, 50, 100};
                	persentaseUp = persentaseUpTemp;
                	akhirTahunAnak2 = akhirTahunAnakTemp;
            	}
            }
            ...
            if(insuredAge>=0 && insuredAge<=9){
            	...
            	for(int i = 0 ; i < 8; i++){
            		if(akhirTahunAnak[i] <= (cepr01030102Form.getTermOfContract() + insuredAge) ){
            			...
            			tglSkr.setYear(tglSkr.getYear() + (akhirTahunAnak[i]-insuredAge));
            			map.put( "tahunPolis", (akhirTahunAnak[i]-insuredAge) + "(" + sdf.format(tglSkr) + ")" );
            ...
            for(int i = 1 ; i <= cepr01030102Form.getTermOfContract() ; i++){
            	...
            	if(i <= cepr01030102Form.getTermOfPayment()){
            		...
            		if(cepr01030102Form.getRightPartOfBusinessCd() != Cepr01040116Mapper.X4){
            			// UNTUK TAHUNAN
            			if( i == 1){
            				cepr01030102Form.setPremium(cepr01030102Form.getPremium().subtract(cepr01030102Form.getPremium().divide(new BigDecimal(10))));
            			}
            		}
            	...
            	if(cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040116Mapper.X4){
            		// SEKALIGUS
                	if(i > 0 && i < cepr01030102Form.getTermOfContract() && i <= rateListLength){
                		nilaiTunai = new Double(rateList.get(i).toString()) * multiplier * multiplierCurrency;
                ...
                }else if(cepr01030102Form.getRightPartOfBusinessCd() != Cepr01040116Mapper.X4){
                	// TAHUNAN
              // @Adrian (25/07/2013) -> Disesuaikan dengan EAS-ProLite
              //  	if((i-1) == 0){
              //  		nilaiTunai = 0.00;
              //  		map.put("nilaiTunai", nilaiTunai.toString());
              //  	}
            	...
            	if(cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040116Mapper.X4){
                	...
                	}else if( i > 0 && nodeTahapanDanaPlus == 0){
                		// ada perhitungan akumulasi tdp
                		totalBenefitTdp = nilaiTunai + totalTdp;
                		map.put("totalBenefitTdp", editorUtil.convertToTwoDigit(totalBenefitTdp) );
                	}	
            	}else if(cepr01030102Form.getRightPartOfBusinessCd() != Cepr01040116Mapper.X4){
            		if( i >= 1 && nodeTahapanDanaPlus == 1){
                		totalTdp = totalTdp + new Double(tahapanDanaList.get(nodeTahapanDana).toString());
                		totalBenefitTdp = nilaiTunai + totalTdp;
                		map.put("totalBenefitTdp", editorUtil.convertToTwoDigit(totalBenefitTdp) );
                	}else if( i >= 1 && nodeTahapanDanaPlus == 0){
                		// ada perhitungan akumulasi tdp
                		totalBenefitTdp = nilaiTunai + totalTdp;
                		map.put("totalBenefitTdp", editorUtil.convertToTwoDigit(totalBenefitTdp) );
                	}	
            	// @Adrian (25/07/2013) -> Disesuaikan dengan EAS-ProLite	
                //	else if( i == 1 ){
                //		totalBenefitTdp = 0.00;
                //		map.put("totalBenefitTdp", totalBenefitTdp.toString());
                //	}
            	}
            ...
            jasperViewer.setUrl( "/WEB-INF/classes/" + "id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040116_product.jasper" );
            jasperViewer.setReportDataKey( "dataSource" );
            
            String formatTanggal = sdf.format(tglSkr);
            
            String formatTglSkr = FormatDate.toIndonesian(tglSkr);
            
            BigDecimal premiSemesteran = premi.multiply(new BigDecimal( Hardcode.FACTOR_SEMESTER ));
            BigDecimal premiTriwulanan = premi.multiply(new BigDecimal( Hardcode.FACTOR_TRIWULAN ));
            BigDecimal premiBulanan = premi.multiply(new BigDecimal(Hardcode.FACTOR_MONTHLY));
            ...
            if(cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040116Mapper.X4){
            	params.put( "labelMasaPembayaranPremi", "");
            	params.put( "simbolMasaPembayaranPremi", "");
            	params.put( "masaPembayaranPremi", "");
            }else if(cepr01030102Form.getRightPartOfBusinessCd() != Cepr01040116Mapper.X4){
            	params.put( "labelMasaPembayaranPremi", "Masa Pembayaran Premi");
            	params.put( "simbolMasaPembayaranPremi", ":");
            ...
            params.put( "tanggal", formatTanggal);
           ...
           // params.put( "placeAndDate", "Jakarta, " + FormatDate.toIndonesian( eproposalManager.selectNowDate() ) );
            ...
            if("01".equals(cepr01030102Form.getCurrencyCd())){
            	...
            	params.put( "currencySymbol", "Rp." );
            	params.put( "totalPremiPokok1", "Rp. " + editorUtil.convertToTwoDigit(totalPremiPokok) );
                params.put( "totalDana1", "Rp. " + editorUtil.convertToTwoDigit(totalDana) );
            	params.put( "keterangan" , "Bunga tidak mengikat. Ilustrasi pada Akumulasi Tahapan menggunakan tingkat investasi 10.00 % pertahun.");
            	params.put( "up1" , "Rp. " + editorUtil.convertToTwoDigit(cepr01030102Form.getTotalSumInsured()));
            	if(cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040116Mapper.X4)
                {
            		params.put( "up2" , "Rp. " + editorUtil.convertToTwoDigit(cepr01030102Form.getTotalSumInsured().multiply(new BigDecimal(2))) );
                }
                else{
                	params.put( "up2" , "Rp. " + editorUtil.convertToTwoDigit(cepr01030102Form.getTotalSumInsured().multiply(new BigDecimal(2))) + " , BEBAS PREMI apabila Cacat Tetap Total");
                }
            	
            }else if("02".equals(cepr01030102Form.getCurrencyCd())){
            	params.put( "investasi", "5.00 % **" );
            	params.put( "currencySymbol", "US$" );
            	params.put( "totalPremiPokok1", "US$ " + editorUtil.convertToTwoDigit(totalPremiPokok) );
                params.put( "totalDana1", "US$ " + editorUtil.convertToTwoDigit(totalDana) );
            	params.put( "keterangan" , "Bunga tidak mengikat. Ilustrasi pada Akumulasi Tahapan menggunakan tingkat investasi 5.00 % pertahun.");
            	params.put( "up1" , "US$ " + editorUtil.convertToTwoDigit(cepr01030102Form.getTotalSumInsured()));
            	if(cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040116Mapper.X4)
                {
            		params.put( "up2" , "US$ " + editorUtil.convertToTwoDigit(cepr01030102Form.getTotalSumInsured().multiply(new BigDecimal(2))) );
                }
            	else{
                	params.put( "up2" , "US$ " + editorUtil.convertToTwoDigit(cepr01030102Form.getTotalSumInsured().multiply(new BigDecimal(2))) + " , BEBAS PREMI apabila Cacat Tetap Total");
                }
            	
            }
            
            params.put( "up1-1" , editorUtil.convertToTwoDigit(cepr01030102Form.getTotalSumInsured()));
        	params.put( "up1-2" , editorUtil.convertToTwoDigit(cepr01030102Form.getTotalSumInsured().multiply(new BigDecimal(2))));
        	//params.put( "title", "SMiLe SARJANA" );
        	Integer lsbsId = cepr01030102Form.getLeftPartOfBusinessCd();
            params.put( "title", eproposalManager.selectTitleBisnis(1, lsbsId));
        	
            if(cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040116Mapper.X4){            
            	params.put( "type", "Premi Sekaligus" );
            }else if(cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040116Mapper.X5){
            	params.put( "type", "Premi Tahunan" );
            	params.put( "premiTh1", editorUtil.convertToTwoDigit(premi) );
            	params.put( "premiTh2", editorUtil.convertToTwoDigit(premi.subtract(premi.divide(new BigDecimal(10)))) );
            ...
            params.put( "premiTahunan", editorUtil.convertToTwoDigit(premi) );
           ...
           try{
	        	   ...
	        	   //if(cekDataApprovedOrNot.get(0).getPosisi()<3){
			            JasperUtils.exportReportToPdf(
			            		"id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040116_product.jasper",
			            		dirName,
			                fileName,
							params,
							temp,

...
public class Cepr01040224Business extends Cepr01040000Ilustration134Business
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040224Business( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command )
    {
        super( eproposalManager, editorUtil, command );
        setSekaligusRightPartCdArr( new Integer[]{ } );
        setBerkalaRightPartCdArr( new Integer[]{ Cepr01040224Mapper.X1 } );
        ...
        setInvestmentTitleArr( new String[] {
                "",
                " EXCELLINK Stabile Fund Syariah",
                " EXCELLINK Balance Fund Syariah",
                " EXCELLINK Equity Fund Syariah",
                " Simas Stabile Fund Syariah",
                " Simas Balance Fund Syariah",
                " Simas Equity Fund Syariah",
                " Simas Stabile Dollar Fund Syariah",
                " Simas Balance Dollar Fund Syariah"
            } );        	
   			 ...
   			 cepr01030102Form.getLjiFixCd().equals("47"))
        {
   		 productLabelFixedFund = "EXCELLINK";
			 ...
			 (cepr01030102Form.getLjiFixCd().equals("42") || cepr01030102Form.getLjiFixCd().equals("50")) )
        {	 
   			 ...
   			 cepr01030102Form.getLjiDynamicCd().equals("48"))
        {
   		 productLabelDynamicFund = "EXCELLINK";
   			 ...
   			 (cepr01030102Form.getLjiDynamicCd().equals("43") || cepr01030102Form.getLjiDynamicCd().equals("51")) )
        {
   			 ...
   			 cepr01030102Form.getLjiAggresiveCd().equals("49"))
        {
   		 productLabelAggresiveFund = "EXCELLINK";
   			 ...
   			 (cepr01030102Form.getLjiAggresiveCd().equals("44") || cepr01030102Form.getLjiAggresiveCd().equals("52")) )
        {
        ...
        setInvestmentTitleAndDescrArr( new String[][] {
            { "", "", "" },
            { "", "- " + productLabelFixedFund + " Stabile Fund Syariah", "Penempatan minimum 80% (delapan puluh perseratus) dana investasi pada  instrumen-instrumen investasi berpendapatan tetap dan/atau maksimum 20% (dua puluh perseratus) instrumen-instrumen investasi pasar uang." },
            { "", "- " + productLabelDynamicFund + " Balance Fund Syariah", "Penempatan maksimum 79% (tujuh puluh sembilan perseratus) dana investasi pada instrumen-instrumen investasi berpendapatan tetap dan/atau instrumen-instrumen investasi pasar uang dan investasi pasar modal (ekuitas)." },
            { "", "- " + productLabelAggresiveFund + " Equity Fund Syariah", "Penempatan minimum 80% (delapan puluh perseratus) dana investasi pada instrumen-instrumen investasi pasar modal (ekuitas) dan/atau maksimum penempatan 20% (dua puluh perseratus) dana investasi pada instrumen-instrumen investasi pasar uang. " },
            { "", "- Simas Stabile Dollar Fund Syariah", "Penempatan minimum 80% (delapan puluh perseratus) dana investasi pada  instrumen-instrumen investasi berpendapatan tetap dan/atau maksimum 20% (dua puluh perseratus) instrumen-instrumen investasi pasar uang, dimana semua instrumen-instrumen investasi tersebut dalam mata uang US Dollar" },
            { "", "- Simas Balance Dollar Fund Syariah", "Penempatan maksimum 79% (tujuh puluh sembilan perseratus) dana investasi pada instrumen-instrumen investasi berpendapatan tetap dan/atau instrumen-instrumen investasi pasar uang dan investasi pasar modal (ekuitas), dimana semua instrumen-instrumen investasi tersebut dalam mata uang US Dollar" },
        } );
...
//        	surrender charge
    ...
    public List<Map<String, Object>> getCommonHeaderRincianRowList() throws IOException
    {
        ...
        if( cepr01030102Form.getLeftPartOfBusinessCd() == 153 || cepr01030102Form.getLeftPartOfBusinessCd() == 160 || cepr01030102Form.getLeftPartOfBusinessCd() == 200 ||
            	cepr01030102Form.getLeftPartOfBusinessCd() == 202 || cepr01030102Form.getLeftPartOfBusinessCd() == 215 || cepr01030102Form.getLeftPartOfBusinessCd() == 216){ //SYARIAH
        	result.addAll( source.getPolicyHolderNameMap() );
            result.addAll( source.getPolicyHolderAgeMap() );
            result.addAll( source.getInsuredNameSyariahMap() );
            result.addAll( source.getInsuredAgeSyariahMap() );
    ...
    public Cepr00000000YieldResultVO of_get_rate_ds()
    {
        ...
        for( i = a; i <= b; i++ )
        {
            ...
            // => 6 Pilihan Investasi Fund: EXCELLINK & Simas
        	 if("01".equals( istr_prop.kurs_id )){
        		 if( (i==1 && cepr01030102Form.getFixIdr() != null && cepr01030102Form.getFixIdr().compareTo( new BigDecimal( "0" ) ) > 0  && (cepr01030102Form.getLjiFixCd().equals("47")||cepr01030102Form.getLjiFixCd().equals("53"))) ||
        			 (i==2 && cepr01030102Form.getDynamicIdr() != null && cepr01030102Form.getDynamicIdr().compareTo( new BigDecimal( "0" ) ) > 0  && (cepr01030102Form.getLjiDynamicCd().equals("48")|| cepr01030102Form.getLjiDynamicCd().equals("54") )) ||
        			 (i==3 && cepr01030102Form.getAggresiveIdr() != null && cepr01030102Form.getAggresiveIdr().compareTo( new BigDecimal( "0" ) ) > 0  && (cepr01030102Form.getLjiAggresiveCd().equals("49")||cepr01030102Form.getLjiAggresiveCd().equals("55"))) ||
        			 (i==4 && cepr01030102Form.getFixIdr() != null && cepr01030102Form.getFixIdr().compareTo( new BigDecimal( "0" ) ) > 0  && (cepr01030102Form.getLjiFixCd().equals("42") || cepr01030102Form.getLjiFixCd().equals("50") )) ||
        			 (i==5 && cepr01030102Form.getDynamicIdr() != null && cepr01030102Form.getDynamicIdr().compareTo( new BigDecimal( "0" ) ) > 0  && (cepr01030102Form.getLjiDynamicCd().equals("43")|| cepr01030102Form.getLjiDynamicCd().equals("51")) ) ||
        			 (i==6 && cepr01030102Form.getAggresiveIdr() != null && cepr01030102Form.getAggresiveIdr().compareTo( new BigDecimal( "0" ) ) > 0  && (cepr01030102Form.getLjiAggresiveCd().equals("44")||cepr01030102Form.getLjiAggresiveCd().equals("52")) )
        		){	       
            ...
            if( ("01".equals( istr_prop.kurs_id ) && i<4) ||  ("02".equals( istr_prop.kurs_id ) && i<6))
            {
    ...
    public List<Map<String, Object>> getInvestmentChoiceSmallRowList() throws IOException
    {
        ...
        if( Hardcode.CUR_IDR_CD.equals( cepr01030102Form.getCurrencyCd() ) )
        {
            ...
            {
           	 	if(cepr01030102Form.getLjiFixCd().equals("47") || cepr01030102Form.getLjiFixCd().equals("53")){
           	 		i=1;
           	 	}else if(cepr01030102Form.getLjiFixCd().equals("42") || cepr01030102Form.getLjiFixCd().equals("50")){
           	 		i=4;		
           	 	}
                params = new HashMap<String, Object>();
            ...
            {
            	if(cepr01030102Form.getLjiDynamicCd().equals("48") || cepr01030102Form.getLjiDynamicCd().equals("54")){
           	 		i=2;
           	 	}else if(cepr01030102Form.getLjiDynamicCd().equals("43") || cepr01030102Form.getLjiDynamicCd().equals("51")){
           	 		i=5;		
           	 	}            	
                params = new HashMap<String, Object>();
                params.put( "description", "- " + investmentTitleArr[ i ] );
            ...
            {
            	if(cepr01030102Form.getLjiAggresiveCd().equals("49") || cepr01030102Form.getLjiAggresiveCd().equals("55")){
           	 		i=3;
           	 	}else if(cepr01030102Form.getLjiAggresiveCd().equals("44") || cepr01030102Form.getLjiAggresiveCd().equals("52")){
           	 		i=6;		
           	 	}        
                params = new HashMap<String, Object>();
                params.put( "description", "- " + investmentTitleArr[ i ] );

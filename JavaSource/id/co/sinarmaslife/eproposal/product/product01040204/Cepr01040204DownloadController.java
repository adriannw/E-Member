 ...
 * Function Id         	: 
 * Program Name   		: Cepr01040204DownloadController
...
public class Cepr01040204DownloadController extends StandardParent implements Controller
{
    ...
    {
        logger.info( "*-*-*-* Cepr01040204DownloadController.handleRequest" );
        ...
        Cepr01040204Business cepr01040204Business = new Cepr01040204Business( eproposalManager, editorUtil, command );

        ModelAndView result;
        if( request.getSession().getAttribute( "messageEkaSehatList" ) == null )
        {
        	List<String> messageEkaSehatList = cepr01040204Business.getEkaSehatMsgBox();
        ...
        {
        	List<String> messageEkaSehatILList = cepr01040204Business.getEkaSehatILMsgBox();
        ...
        {
            List<String> messageBoxList = cepr01040204Business.getMedicalMsgBox();
        ...
        else
        {
            ...
            jasperViewer.setUrl( "/WEB-INF/classes/" + "id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040204_product.jasper" );

            params.put( "title", "EKA LINK 80" );
          ...
          //  params.put( "placeAndDate", "Jakarta, " + FormatDate.toIndonesian( eproposalManager.selectNowDate() ) );
            ...
            IllustrationResultVO illustrationResultVO = cepr01040204Business.getIllustrationResult();
            ...
            logger.info( "*-*-*-* cepr01040204Business.getInvestmentYield() = " + cepr01040204Business.getInvestmentYield() );
            params.put( "totalInvestmentAllocation", cepr01040204Business.getInvestmentYield().getTotalInvestmentAllocation() );
            params.put( "totalAssumptionLow", cepr01040204Business.getInvestmentYield().getTotalAssumptionLow() );
            params.put( "totalAssumptionMid", cepr01040204Business.getInvestmentYield().getTotalAssumptionMid() );
            params.put( "totalAssumptionHi", cepr01040204Business.getInvestmentYield().getTotalAssumptionHi() );

            params.put( "dsCommonHeader", JasperReportsUtils.convertReportData( cepr01040204Business.getCommonHeaderRowList() ) );
            params.put( "dsCommonHeaderSmall", JasperReportsUtils.convertReportData( cepr01040204Business.getCommonHeaderSmallRowList() ) );
            params.put( "dsInvestmentChoice", JasperReportsUtils.convertReportData( cepr01040204Business.getInvestmentChoiceRowList() ) );
            params.put( "dsInvestmentChoiceSmall", JasperReportsUtils.convertReportData( cepr01040204Business.getInvestmentChoiceSmallRowList() ) );
            params.put( "dsMonthlyPremium", JasperReportsUtils.convertReportData( cepr01040204Business.getMonthlyPremiumList( cepr01030102Form ) ) );
            params.put( "dsInvestmentPerformance", JasperReportsUtils.convertReportData( cepr01040204Business.getInvestmentPerformanceList() ) );
            params.put( "dsInvestmentYield", JasperReportsUtils.convertReportData( cepr01040204Business.getInvestmentYield().getYieldList() ) );
            params.put( "dsOneRow", JasperReportsUtils.convertReportData( cepr01040204Business.getOneRowList() ) );
            params.put( "dsNoteSekaligus", JasperReportsUtils.convertReportData( cepr01040204Business.getNoteSekaligusRowList() ) );
            params.put( "dsNoteBerkala", JasperReportsUtils.convertReportData( cepr01040204Business.getNoteBerkalaRowList() ) );
            ...
            params.put( "dataSource", cepr01040204Business.getPageList( currentIdx ) );
          ...
          //  String fileName="testx.pdf";
            ...
            List temp = cepr01040204Business.getPageList( currentIdx );
           ...
           try{      
	        	   //if(cekDataApprovedOrNot.get(0).getPosisi()<3){
			            JasperUtils.exportReportToPdf(
			            		"id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040204_product.jasper",
			            		dirName,
			                fileName,
							params,
							temp,

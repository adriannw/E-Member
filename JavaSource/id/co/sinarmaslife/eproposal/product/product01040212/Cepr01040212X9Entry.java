 ...
 * Function Id         	: 
 * Program Name   		: Cepr01040212X9Entry
 * Description         	:
...
public class Cepr01040212X9Entry extends Cepr01040212Entry
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040212X9Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
        super( eproposalManager, editorUtil, command, errors );
        logger.info( "*-*-*-* Cepr01040212X9Entry constructor is called ..." );
    }

    public void initDisplayedForm()
    {
        logger.info( "*-*-*-* Cepr01040212X9Entry.initDisplayedForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040212X9Entry.initDisabledForm" );
...
//        cepr01030102Form.setTotalSumInsuredIsDisabled( CommonConst.DISABLED_FALSE );
    ...
    {
        logger.info( "*-*-*-* Cepr01040212X9Entry.initReadOnlyForm" );
        super.initReadOnlyForm();
    }

    public void fillDefaultValueEachTimeRightPartOfBusinessCdChanged()
    {
        logger.info( "*-*-*-* Cepr01040212X9Entry.fillDefaultValueEachTimeRightPartOfBusinessCdChanged" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040212X9Entry.fillDefaultValueEachTimeFormCalled" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040212X9Entry.validateCurrentPage" );
...
//        commonValidator.validateMinimumMoney( Cepr01030102FormConst.PREMIUM, premium, minPremiumIdr, minPremiumUsd );
    ...
    {
        logger.info( "*-*-*-* Cepr01040212X9Entry.processFormAfterSubmitBeforeValidation" );
        double premium = LazyConverter.toDouble( cepr01030102Form.getPremium() );

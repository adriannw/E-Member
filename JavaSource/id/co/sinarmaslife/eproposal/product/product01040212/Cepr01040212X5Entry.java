...
public class Cepr01040212X5Entry extends Cepr01040212Entry
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040212X5Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
        super( eproposalManager, editorUtil, command, errors );
        logger.info( "*-*-*-* Cepr01040212X5Entry constructor is called ..." );
    }

    public void initDisplayedForm()
    {
        logger.info( "*-*-*-* Cepr01040212X5Entry.initDisplayedForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040212X5Entry.initDisabledForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040212X5Entry.initReadOnlyForm" );
        super.initReadOnlyForm();
    }

    public void fillDefaultValueEachTimeRightPartOfBusinessCdChanged()
    {
        logger.info( "*-*-*-* Cepr01040212X5Entry.fillDefaultValueEachTimeRightPartOfBusinessCdChanged" );
        cepr01030102Form.setTotalSumInsuredIsDisabled( CommonConst.DISABLED_TRUE );
    ...
    {
        logger.info( "*-*-*-* Cepr01040212X5Entry.fillDefaultValueEachTimeFormCalled" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040212X5Entry.validateCurrentPage" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040212X5Entry.processFormAfterSubmitBeforeValidation" );
        double premium = LazyConverter.toDouble( cepr01030102Form.getPremium() );

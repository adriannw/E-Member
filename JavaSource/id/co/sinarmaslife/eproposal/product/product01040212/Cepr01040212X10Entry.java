 ...
 * Function Id         	: 
 * Program Name   		: Cepr01040212X10Entry
 * Description         	:
...
public class Cepr01040212X10Entry extends Cepr01040212Entry
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040212X10Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
        super( eproposalManager, editorUtil, command, errors );
        logger.info( "*-*-*-* Cepr01040212X10Entry constructor is called ..." );
    }

...
public class Cepr01040212X6Entry extends Cepr01040212Entry
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040212X6Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
        super( eproposalManager, editorUtil, command, errors );
        logger.info( "*-*-*-* Cepr01040212X6Entry constructor is called ..." );
    }

    public void initDisplayedForm()
    {
        logger.info( "*-*-*-* Cepr01040212X6Entry.initDisplayedForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040212X6Entry.initDisabledForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040212X6Entry.initReadOnlyForm" );
        super.initReadOnlyForm();
    }

    public void fillDefaultValueEachTimeRightPartOfBusinessCdChanged()
    {
        logger.info( "*-*-*-* Cepr01040212X6Entry.fillDefaultValueEachTimeRightPartOfBusinessCdChanged" );
        cepr01030102Form.setTotalSumInsuredIsDisabled( CommonConst.DISABLED_TRUE );
    ...
    {
        logger.info( "*-*-*-* Cepr01040212X6Entry.fillDefaultValueEachTimeFormCalled" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040212X6Entry.validateCurrentPage" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040212X6Entry.processFormAfterSubmitBeforeValidation" );
        double premium = LazyConverter.toDouble( cepr01030102Form.getPremium() );

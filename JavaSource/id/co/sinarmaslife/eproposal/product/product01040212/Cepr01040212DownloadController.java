 ...
 * Function Id         	: 
 * Program Name   		: Cepr01040212DownloadController
 * Description         	:
...
public class Cepr01040212DownloadController extends StandardParent implements Controller
{
    ...
    {
        logger.info( "*-*-*-* Cepr01040212DownloadController.handleRequest" );
        ...
        Cepr01040212Business cepr01040212Business = new Cepr01040212Business( eproposalManager, editorUtil, command );

        ModelAndView result = null;
        if( request.getSession().getAttribute( "messageEkaSehatList" ) == null )
        {
        	List<String> messageEkaSehatList = cepr01040212Business.getEkaSehatMsgBox();
        ...
        {
            List<String> messageBoxList = cepr01040212Business.getMedicalMsgBox();
...
//            jasperViewer.setUrl( "/WEB-INF/classes/" + "id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040212_product.jasper" );
            double li_kali = 0.0;
...
//          TITLE
            if(cepr01030102Form.getRightPartOfBusinessCd() == 1){
            	params.put( "title", "CERDAS PROTEKSI 5" );
            	params.put( "titleRider", "CERDAS PROTEKSI 5" );
            }else if(cepr01030102Form.getRightPartOfBusinessCd() == 2){
            	params.put( "title", "CERDAS PROTEKSI 10" );
            	params.put( "titleRider", "CERDAS PROTEKSI 10" );
            }else if(cepr01030102Form.getRightPartOfBusinessCd() == 5){
            	params.put( "title", "CERDAS PROTEKSI SINGLE" );
            	params.put( "titleRider", "CERDAS PROTEKSI SINGLE" );
            }else if(cepr01030102Form.getRightPartOfBusinessCd() == 3){
            	params.put( "title", "CERDAS PROTEKSI PLUS 5" );
            	params.put( "titleRider", "CERDAS PROTEKSI PLUS 5" );
            }else if(cepr01030102Form.getRightPartOfBusinessCd() == 4){
            	params.put( "title", "CERDAS PROTEKSI PLUS 10" );
            	params.put( "titleRider", "CERDAS PROTEKSI PLUS 10" );
            }else if(cepr01030102Form.getRightPartOfBusinessCd() == 6){
            	params.put( "title", "CERDAS PROTEKSI PLUS SINGLE" );
            	params.put( "titleRider", "CERDAS PROTEKSI PLUS SINGLE" );
            }else if(cepr01030102Form.getRightPartOfBusinessCd() == 7){
            	params.put( "title", "Excellent Link \n (For Your Protection)" );
            	params.put( "titleRider", "EXCELLENT LINK (FOR YOUR PROTECTION)" );
            }else if(cepr01030102Form.getRightPartOfBusinessCd() == 8){
            	params.put( "title", "Excellent Link \n (For Your Protection)" );
            	params.put( "titleRider", "EXCELLENT LINK (FOR YOUR PROTECTION)" );
            }else if(cepr01030102Form.getRightPartOfBusinessCd() == 9){
            	params.put( "title", "Excellent Link \n (For Your Protection Plus)" );
            	params.put( "titleRider", "EXCELLENT LINK (FOR YOUR PROTECTION PLUS)" );
...
//            BigDecimal biayaAsuransiPokok = cepr01030102Form.getBasePremium().multiply(new BigDecimal("0.00094"));
            BigDecimal biayaAsuransiPokok =  new BigDecimal(cepr01040212Business.of_get_coi_basic(1));
            ...
            params.put( "uangPertanggunganPa3", currencySymbol + " " + editorUtil.convertToTwoDigit(Math.min(up * 0.4,maksUangPertanggunganPa3)) );
            params.put( "UPManfaatKematian", currencySymbol + " " + editorUtil.convertToTwoDigit(up) );
            ...
            String tipeMedisPP = cepr01040212Business.getTipeMedis(cepr01030101Form.getPolicyHolderAge());
            String tipeMedisTT = cepr01040212Business.getTipeMedis(cepr01030101Form.getInsuredAge());
            ...
            params.put( "kurs", cepr01030102Form.getCurrencyCd() );
...
//            jasperViewer.setJdbcDataSource( eproposalManager.getDataSource() );
            ...
            mapMaster = cepr01040212Business.getIllustration212Result(cepr01030102Form.getTermOfPayment());
            ...
            //int exr = 0;
            String[][] riderTambahan = cepr01040212Business.getRiderPremiumList( cepr01030102Form );
            ...
            logger.info( "*-*-*-* cepr01040201Business.getInvestmentYield() = " + cepr01040212Business.getInvestmentYield() );
            params.put( "totalInvestmentAllocation", cepr01040212Business.getInvestmentYield().getTotalInvestmentAllocation() );
            params.put( "totalAssumptionLow", cepr01040212Business.getInvestmentYield().getTotalAssumptionLow() );
            params.put( "totalAssumptionMid", cepr01040212Business.getInvestmentYield().getTotalAssumptionMid() );
            params.put( "totalAssumptionHi", cepr01040212Business.getInvestmentYield().getTotalAssumptionHi() );

            params.put( "dsCommonHeader", JasperReportsUtils.convertReportData( cepr01040212Business.getCommonHeaderRowList() ) );
            params.put( "dsCommonHeader2", JasperReportsUtils.convertReportData( cepr01040212Business.getCommonHeaderRowList() ) );
            params.put( "dsCommonHeader3", JasperReportsUtils.convertReportData( cepr01040212Business.getCommonHeaderRowList() ) );
            params.put( "dsCommonHeaderSmall", JasperReportsUtils.convertReportData( cepr01040212Business.getCommonHeaderSmallRowList() ) );
            params.put( "dsInvestmentChoice", JasperReportsUtils.convertReportData( cepr01040212Business.getInvestmentChoiceRowList() ) );
            params.put( "dsInvestmentChoiceSmall", JasperReportsUtils.convertReportData( cepr01040212Business.getInvestmentChoiceSmallRowList() ) );
            ...
            params.put( "dsInvestmentYield", JasperReportsUtils.convertReportData( cepr01040212Business.getInvestmentYield().getYieldList() ) );
            ...
            params.put( "dataSource", cepr01040212Business.getPageList( currentIdx ) );
          ...
          //  String fileName="testx.pdf";
            ...
            List temp = cepr01040212Business.getPageList( currentIdx );
            ...
            try{      
	        	   //if(cekDataApprovedOrNot.get(0).getPosisi()<3){
			            JasperUtils.exportReportToPdf(
			            		"id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040212_product.jasper",
			            		dirName,
			                fileName,
							params,
							temp,

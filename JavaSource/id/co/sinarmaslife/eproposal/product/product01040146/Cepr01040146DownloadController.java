...
public class Cepr01040146DownloadController extends StandardParent implements Controller
{
            ...
            throws ServletException, IOException
    {
        ...
        Cepr01040146Business cepr01040146Business = new Cepr01040146Business( eproposalManager, editorUtil, command );

        ModelAndView result = null;
        if( request.getSession().getAttribute( "messageEkaSehatList" ) == null )
        {
        	List<String> messageEkaSehatList = cepr01040146Business.getEkaSehatMsgBox();
        ...
        {
            List<String> messageBoxList = cepr01040146Business.getMedicalMsgBox();
        ...
        //    jasperViewer.setUrl( "/WEB-INF/classes/" + "id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040146_product.jasper" );
            
           // params.put( "title", "SMiLe LINK MEDIVEST SYARIAH" );
            ...
            if( credentialsVO != null && credentialsVO.getGroupId() != null && credentialsVO.getGroupId().equals( Hardcode.GROUP_MNC ) && 
            		cepr01030102Form.getRightPartOfBusinessCd()== Cepr01040146Mapper.X2 ){
            	mnc = "mnc";
            ...
            String[][] riderTambahan = cepr01040146Business.getRiderPremiumList( cepr01030102Form );
            ...
            String tipeMedisPP = cepr01040146Business.getTipeMedis(cepr01030101Form.getPolicyHolderAge());
            String tipeMedisTT = cepr01040146Business.getTipeMedis(cepr01030101Form.getInsuredAge());
       ...
       //     jasperViewer.setJdbcDataSource( eproposalManager.getDataSource() );
            ...
            IllustrationResultVO illustrationResultVO = cepr01040146Business.getIllustration123Result();
            ...
            params.put( "dsEkalinkIllustration2", JasperReportsUtils.convertReportData( illustrationResultVO.getIllustrationList() ) );
            ...
            logger.info( "*-*-*-* cepr01040201Business.getInvestmentYield() = " + cepr01040146Business.getInvestmentYield() );
            params.put( "totalInvestmentAllocation", cepr01040146Business.getInvestmentYield().getTotalInvestmentAllocation() );
            params.put( "totalAssumptionLow", cepr01040146Business.getInvestmentYield().getTotalAssumptionLow() );
            params.put( "totalAssumptionMid", cepr01040146Business.getInvestmentYield().getTotalAssumptionMid() );
            params.put( "totalAssumptionHi", cepr01040146Business.getInvestmentYield().getTotalAssumptionHi() );

            params.put( "dsCommonHeader", JasperReportsUtils.convertReportData( cepr01040146Business.getCommonHeaderRow123List() ) );
            params.put( "dsCommonHeaderSmall", JasperReportsUtils.convertReportData( cepr01040146Business.getCommonHeaderSmallRow123List() ) );
            params.put( "dsCommonHeaderSmall2", JasperReportsUtils.convertReportData( cepr01040146Business.getCommonHeaderSmallRow123List() ) );
            params.put( "dsInvestmentChoice", JasperReportsUtils.convertReportData( cepr01040146Business.getInvestmentChoiceRowList() ) );
            params.put( "dsInvestmentChoiceSmall", JasperReportsUtils.convertReportData( cepr01040146Business.getInvestmentChoiceSmallRow123List() ) );
            params.put( "dsInvestmentChoiceSmall2", JasperReportsUtils.convertReportData( cepr01040146Business.getInvestmentChoiceSmallRow123List() ) );
            params.put( "dsMonthlyPremium", JasperReportsUtils.convertReportData( cepr01040146Business.getMonthlyPremiumList( cepr01030102Form ) ) );
            params.put( "dsInvestmentPerformance", JasperReportsUtils.convertReportData( cepr01040146Business.getInvestmentPerformanceList() ) );
            params.put( "dsInvestmentYield", JasperReportsUtils.convertReportData( cepr01040146Business.getInvestmentYield().getYieldList() ) );
            params.put( "dsInvestmentYield2", JasperReportsUtils.convertReportData( cepr01040146Business.getInvestmentYield().getYieldList() ) );
            //params.put( "dsOneRow", JasperReportsUtils.convertReportData( cepr01040146Business.getOneRowList() ) );
...
//            putRiderParam( params, riderBusiness.getRiderWaiverCiList(), "dsRiderWaiverCi", "riderWaiverCiIndex" );
          ...
          //SMiLe Medical Extra Syariah Maret 2021
            ...
            //SMiLe Medical Extra Syariah Maret 2021
            params.put( "dsCommonHeaderRincianRiderEkaSehatExtra", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040146Business.getCommonHeaderRincianSmallRowList(29) ) );
            params.put( "dsCommonBiayaRincianRiderEkaSehatExtra", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040146Business.getCommonBiayaRincianRider(29) ) );     
            ...
            params.put( "tipeEkaSehat", cepr01040146Business.checkTipeEkaSehat(29) );
            
            params.put( "dataSource", cepr01040146Business.getPageList( currentIdx ) );            
            params.put( "dsEkalinkRider", JasperReportsUtils.convertReportData( cepr01040146Business.getRiderPremiumList(cepr01030102Form, cepr01030101Form.getInsuredAge()) ) );
            params.put( "dsEkalinkRider2", JasperReportsUtils.convertReportData( cepr01040146Business.getRiderPremiumList(cepr01030102Form, cepr01030101Form.getInsuredAge()) ) );
            ...
            List temp = cepr01040146Business.getPageList( currentIdx );
           ...
           try{
			       JasperUtils.exportReportToPdf(
			    		   "id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040146_product.jasper",
			            		dirName,
			                fileName,
							params,
							temp,

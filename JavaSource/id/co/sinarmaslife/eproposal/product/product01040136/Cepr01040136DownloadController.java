...
public class Cepr01040136DownloadController extends StandardParent implements Controller
{
            ...
            throws ServletException, IOException
    {
        ...
        Cepr01040136Business cepr01040136Business = new Cepr01040136Business( eproposalManager, editorUtil, command );
        ...
        else
        {
            ...
            jasperViewer.setUrl( "/WEB-INF/classes/" + "id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040136_product.jasper" );
            ...
            if( cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040136Mapper.X1 || cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040136Mapper.X6 ||
            		cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040136Mapper.X11 || cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040136Mapper.X16 )
            	{ businessIdx = "5"; sekaligusOrTahunan = "tahunan"; }
            else if( cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040136Mapper.X2 || cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040136Mapper.X7 ||
            		cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040136Mapper.X12 || cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040136Mapper.X17 )
            	{ businessIdx = "10"; sekaligusOrTahunan = "tahunan"; }
            else if( cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040136Mapper.X3 || cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040136Mapper.X8 ||
            		cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040136Mapper.X13 || cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040136Mapper.X18 )
        		{ businessIdx = "15"; sekaligusOrTahunan = "tahunan";}
            else if( cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040136Mapper.X4 || cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040136Mapper.X9 ||
            		cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040136Mapper.X14 || cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040136Mapper.X19 )
        		{ businessIdx = "20"; sekaligusOrTahunan = "tahunan"; }
            else if( cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040136Mapper.X5 || cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040136Mapper.X10 ||
            		cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040136Mapper.X15 || cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040136Mapper.X20 )
            ...
            if( 	cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040136Mapper.X6  ||
            		...
            		cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040136Mapper.X16 ||
            		cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040136Mapper.X17 ||
            		cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040136Mapper.X18 ||
            		cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040136Mapper.X19 ||
            		cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040136Mapper.X20	)
            {
...
//        params.put( "termOfContract", editorUtil.convertToString( cepr01030102Form.getTermOfContract() ) + " tahun" );
           ...
           // params.put( "placeAndDate", "Jakarta, " + FormatDate.toIndonesian( eproposalManager.selectNowDate() ) );
            ...
            if( CommonConst.CHECKED_TRUE.equals( cepr01030102Form.getTermRiderFlag() ) && CommonConst.DISPLAY_TRUE.equals( cepr01030102Form.getTermRiderFlagDisplay() ) )
            {
                ...
                Cepr01040136Entry entry = new Cepr01040136Entry( eproposalManager, editorUtil, command, null );
                manfaatTermRiderAmount = entry.computeManfaat( cepr01030102Form.getPaymentModeCd(), Hardcode.MANFAAT_TERM_OF_RIDER_CD );
                manfaatTermRiderList.add( cepr01040136Business.getManfaatTermRiderParamsMap( command, editorUtil ) );
            ...
            if( CommonConst.CHECKED_TRUE.equals( cepr01030102Form.getPersonalAccidentFlag() ) && CommonConst.DISPLAY_TRUE.equals( cepr01030102Form.getPersonalAccidentFlagDisplay() ) )
            {
                ...
                manfaatPersonalAccidentList.add( cepr01040136Business.getManfaatPersonalAccidentParamsMap( command, editorUtil ) );
...
//                manfaatWaiverPremiumAmount = entry.computeManfaat( cepr01030102Form.getPaymentModeCd(), Hardcode.MANFAAT_WAIVER_PREMIUM_DISABILITY );
            ...
            params.put( "dsCommonHeader", JasperReportsUtils.convertReportData( getHeaderRowList( command, "title" ) ) );
            params.put( "dsCommonHeaderAboveDetail", JasperReportsUtils.convertReportData( getHeaderRowList( command, "aboveDetail" ) ) );
           ...
           try{
			            JasperUtils.exportReportToPdf(
			            		"id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040136_product.jasper",
			            		dirName,
			                fileName,
							params,
							temp,
...
//          =========================
    ...
    {
        logger.info( "*-*-*-* Cepr01040136DownloadController.getCommonHeaderRowList" );
        ...
        {
	        Cepr01040136Business cepr01040136Business = new Cepr01040136Business( eproposalManager, editorUtil, command );
	        result.addAll( source.getPolicyHolderMedicalCheckUpMap( ( String ) cepr01040136Business.of_cek_medis( command ).get( "medis_pp" ) ) );
	        result.addAll( source.getInsuredMedicalCheckUpMap( ( String ) cepr01040136Business.of_cek_medis( command ).get( "medis_tt" ) ) );
        }
        return result;
    }

...
public class Cepr01040218X1Entry extends Cepr01040218Entry
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040218X1Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
...
//        commonValidator.validateMinimumMoney( Cepr01030102FormConst.PREMIUM, premium, minPremiumIdr, minPremiumUsd );
    ...
    public void validatePreviousPage()
    {
        ...
        if( cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040218Mapper.X4 ){
	...
	//    	double minUp	= ( LazyConverter.toDouble( cepr01030102Form.getBasePremium() ) / factor_percentage ) * 5;
        ...
        case Hardcode.PAY_MODE_CD_TAHUNAN:
        	if( cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040218Mapper.X7){
        ...
        case Hardcode.PAY_MODE_CD_SEMESTERAN:
        	if( cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040218Mapper.X4){ 
        		...
        		minPremiumUsd = 262.5;        		
        	}else if( cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040218Mapper.X7){

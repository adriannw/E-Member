...
public class Cepr01040113Business extends Cepr01040000ProductBusiness
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040113Business( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command )
    {
    ...
    {
        logger.info( "*-*-*-* Cepr01040113DownloadController.getCommonHeaderRowList" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040113Business.getDetailList" );

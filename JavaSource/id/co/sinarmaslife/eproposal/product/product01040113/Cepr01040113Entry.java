...
public class Cepr01040113Entry extends Cepr01040000Entry implements Cepr01040000EntryInterface
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040113Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
        super( eproposalManager, editorUtil, command, errors );
        logger.info( "*-*-*-* Cepr01040113Entry constructor is called ..." );
        setDownloadUrl( "wepr01040113.pdf" );
    }

    public void initDisplayedForm()
    {
        logger.info( "*-*-*-* Cepr01040113Entry.initDisplayedForm" );
        displayStandardForm();
    ...
    {
        logger.info( "*-*-*-* Cepr01040113Entry.initDisabledForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040113Entry.initReadOnlyForm" );
        readOnlyAllForm( false );
    }

    public void fillDefaultValueEachTimeRightPartOfBusinessCdChanged()
    {
        logger.info( "*-*-*-* Cepr01040113Entry.fillDefaultValueEachTimeRightPartOfBusinessCdChanged" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040113Entry.fillDefaultValueEachTimeFormCalled" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040113Entry.validateCurrentPage" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040113Entry.validatePreviousPage" );
        commonValidator.validateInsuredAge( Cepr01030102FormConst.ASSURANCE_PLAN_CD, 17, 65 );
    }

    public void processFormAfterSubmitBeforeValidation()
    {
        logger.info( "*-*-*-* Cepr01040113Entry.processFormAfterSubmitBeforeValidation" );
    ...
    public double countRatePremium()
    {
	    ...
	    if( Cepr01040113Mapper.X2 == rightPartOfBusinessCd )
        {
	    	ratePremium = 1.8;
        }
	    else if( Cepr01040113Mapper.X3 == rightPartOfBusinessCd )
        {
	    	ratePremium = 3.9;
        }
	    else if( Cepr01040113Mapper.X4 == rightPartOfBusinessCd )
        {
	    	ratePremium = 6.2;
        }
	    else if( Cepr01040113Mapper.X9 == rightPartOfBusinessCd )
        {
	    	ratePremium = 2.1;
        }
	    else if( Cepr01040113Mapper.X10 == rightPartOfBusinessCd )
        {
	    	ratePremium = 4.6;
        }
	    else if( Cepr01040113Mapper.X11 == rightPartOfBusinessCd )
        {
	    	ratePremium = 7.3;
        }   
    	return ratePremium;

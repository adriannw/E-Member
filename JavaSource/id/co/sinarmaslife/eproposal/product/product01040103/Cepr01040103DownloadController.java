 ...
 * Function Id         	: 
 * Program Name   		: Cepr01040103DownloadController
 * Description         	: Super Sehat Plus (54)
 * Environment      	: Java  1.5.0_06
 * Author               : samuel
 * Version              : 1.0
 * Creation Date    	: Jul 24, 2007 9:49:38 AM
 *
...
public class Cepr01040103DownloadController extends StandardParent implements Controller
{
    ...
    {
        logger.info( "*-*-*-* Cepr01040103DownloadController.handleRequest" );
        ...
        else
        {
            ...
            jasperViewer.setUrl( "/WEB-INF/classes/" + "id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040103_product.jasper" );
            ...
            params.put( "compensation5", editorUtil.convertToString( totalSumInsured.multiply( Hardcode.CUR_IDR_CD.equals( cepr01030102Form.getCurrencyCd() )? new BigDecimal( 50.0 ) : new BigDecimal( 40.0 ) ) ) );
           ...
           try{      
	        	   //if(cekDataApprovedOrNot.get(0).getPosisi()<3){
			            JasperUtils.exportReportToPdf(
			            		"id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040103_product.jasper",
			            		dirName,
			                fileName,
							params,
							temp,

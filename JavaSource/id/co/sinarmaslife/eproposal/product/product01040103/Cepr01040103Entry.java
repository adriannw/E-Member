package id.co.sinarmaslife.eproposal.product.product01040103;

/**********************************************************************
 * Program History
 *
 * Project Name      	: E-Proposal
 * Function Id         	: 01040103
 * Program Name   		: Cepr01040103Entry
 * Description         	: Super Sehat Plus (54)
 * Environment      	: Java  1.5.0_06
 * Author               : samuel
 * Version              : 1.0
 * Creation Date    	: Jul 24, 2007 8:55:13 AM
 *
...
public class Cepr01040103Entry extends Cepr01040000Entry implements Cepr01040000EntryInterface

{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040103Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
        super( eproposalManager, editorUtil, command, errors );
        logger.info( "*-*-*-* Cepr01040103Entry constructor is called ..." );
        setDownloadUrl( "wepr01040103.pdf" );
    }

    public void initDisplayedForm()
    {
        logger.info( "*-*-*-* Cepr01040103Entry.initDisplayedForm" );
        displayStandardForm();
    ...
    {
        logger.info( "*-*-*-* Cepr01040103Entry.initDisabledForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040103Entry.initReadOnlyForm" );
        readOnlyAllForm( false );
    }

    public void fillDefaultValueEachTimeRightPartOfBusinessCdChanged()
    {
        logger.info( "*-*-*-* Cepr01040103Entry.fillDefaultValueEachTimeRightPartOfBusinessCdChanged" );
    }

    public void fillDefaultValueEachTimeFormCalled()
    {
        logger.info( "*-*-*-* Cepr01040103Entry.fillDefaultValueEachTimeFormCalled" );
        ...
        if( rightPartOfBusinessCd.equals( Cepr01040103Mapper.X1 ) )
        {
            totalSumInsured = currencyCd.equals( Hardcode.CUR_IDR_CD ) ? new BigDecimal( "100000" ) : new BigDecimal( "50" );
        ...
        else if( rightPartOfBusinessCd.equals( Cepr01040103Mapper.X2 ) )
        {
            totalSumInsured = currencyCd.equals( Hardcode.CUR_IDR_CD ) ? new BigDecimal( "200000" ) : new BigDecimal( "100" );
            cepr01030102Form.setCurrencyListIsDisabled( CommonConst.DISABLED_FALSE );
            cepr01030102Form.setCurrencyList( comboLookupBusiness.selectCurrencyOptionVOList( false, new String[]{ Hardcode.CUR_IDR_CD, Hardcode.CUR_USD_CD } ) );
        }
        else if( rightPartOfBusinessCd.equals( Cepr01040103Mapper.X3 ) )
        {
            totalSumInsured = currencyCd.equals( Hardcode.CUR_IDR_CD ) ? new BigDecimal( "300000" ) : new BigDecimal( "150" );
            cepr01030102Form.setCurrencyListIsDisabled( CommonConst.DISABLED_FALSE );
            cepr01030102Form.setCurrencyList( comboLookupBusiness.selectCurrencyOptionVOList( false, new String[]{ Hardcode.CUR_IDR_CD, Hardcode.CUR_USD_CD } ) );
        }
        else if( rightPartOfBusinessCd.equals( Cepr01040103Mapper.X4 ) )
        {
            totalSumInsured = currencyCd.equals( Hardcode.CUR_IDR_CD ) ? new BigDecimal( "400000" ) : new BigDecimal( "200" );
            cepr01030102Form.setCurrencyListIsDisabled( CommonConst.DISABLED_FALSE );
            cepr01030102Form.setCurrencyList( comboLookupBusiness.selectCurrencyOptionVOList( false, new String[]{ Hardcode.CUR_IDR_CD, Hardcode.CUR_USD_CD } ) );
        }
        else if( rightPartOfBusinessCd.equals( Cepr01040103Mapper.X5 ) )
        {
            totalSumInsured = new BigDecimal( "500000" );
        ...
        else if( rightPartOfBusinessCd.equals( Cepr01040103Mapper.X6 ) )
        {
            totalSumInsured = new BigDecimal( "600000" );
            cepr01030102Form.setCurrencyListIsDisabled( CommonConst.DISABLED_TRUE );
            cepr01030102Form.setCurrencyList( comboLookupBusiness.selectCurrencyOptionVOList( false, new String[]{ Hardcode.CUR_IDR_CD } ) );
            cepr01030102Form.setCurrencyCd( Hardcode.CUR_IDR_CD );
        }
        else if( rightPartOfBusinessCd.equals( Cepr01040103Mapper.X7 ) )
        {
            totalSumInsured = new BigDecimal( "700000" );
            cepr01030102Form.setCurrencyListIsDisabled( CommonConst.DISABLED_TRUE );
            cepr01030102Form.setCurrencyList( comboLookupBusiness.selectCurrencyOptionVOList( false, new String[]{ Hardcode.CUR_IDR_CD } ) );
            cepr01030102Form.setCurrencyCd( Hardcode.CUR_IDR_CD );
        }
        else if( rightPartOfBusinessCd.equals( Cepr01040103Mapper.X8 ) )
        {
            totalSumInsured = new BigDecimal( "800000" );
            cepr01030102Form.setCurrencyListIsDisabled( CommonConst.DISABLED_TRUE );
            cepr01030102Form.setCurrencyList( comboLookupBusiness.selectCurrencyOptionVOList( false, new String[]{ Hardcode.CUR_IDR_CD } ) );
            cepr01030102Form.setCurrencyCd( Hardcode.CUR_IDR_CD );
        }
        else if( rightPartOfBusinessCd.equals( Cepr01040103Mapper.X9 ) )
        {
            totalSumInsured = new BigDecimal( "900000" );
            cepr01030102Form.setCurrencyListIsDisabled( CommonConst.DISABLED_TRUE );
            cepr01030102Form.setCurrencyList( comboLookupBusiness.selectCurrencyOptionVOList( false, new String[]{ Hardcode.CUR_IDR_CD } ) );
            cepr01030102Form.setCurrencyCd( Hardcode.CUR_IDR_CD );
        }
        else if( rightPartOfBusinessCd.equals( Cepr01040103Mapper.X10 ) )
        {
            totalSumInsured = new BigDecimal( "1000000" );
            cepr01030102Form.setCurrencyListIsDisabled( CommonConst.DISABLED_TRUE );
            cepr01030102Form.setCurrencyList( comboLookupBusiness.selectCurrencyOptionVOList( false, new String[]{ Hardcode.CUR_IDR_CD } ) );
            cepr01030102Form.setCurrencyCd( Hardcode.CUR_IDR_CD );
        }
        else
        { totalSumInsured = new BigDecimal( "0" ); }
    ...
    {
        logger.info( "*-*-*-* Cepr01040103Entry.validateCurrentPage" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040103Entry.validatePreviousPage" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040103Entry.computePremium" );
        ...
        premium = eproposalManager.selectProduct54Rate( sqlParams );
    ...
    {
        logger.info( "*-*-*-* Cepr01040103Entry.processFormAfterSubmitBeforeValidation" );

 ...
 * Function Id         	: 
 * Program Name   		: Cepr01040137Business
 * Description         	:
...
public class Cepr01040137Business extends Cepr01040000ProductBusiness
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040137Business( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command )
    {
    ...
    {
        logger.info( "*-*-*-* Cepr01040137Business.computeManfaat" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040137Business.of_get_rate_for_pk" );
        double result;
        Cepr01030101Form cepr01030101Form = ( ( Cepr01030000HoldingForm ) command ).getCepr01030101Form();
        Cepr01030102Form cepr01030102Form = ( ( Cepr01030000HoldingForm ) command ).getCepr01030102Form();
        Map<String, Object> sqlParams = new HashMap<String, Object>();
    ...
    {
        logger.info( "*-*-*-* Cepr01040137DownloadController.getCommonHeaderRowList" );

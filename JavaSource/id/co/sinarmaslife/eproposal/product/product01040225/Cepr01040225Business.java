...
public class Cepr01040225Business extends Cepr01040000Ilustration134Business
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040225Business( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command )
    {
        super( eproposalManager, editorUtil, command );
        setSekaligusRightPartCdArr( new Integer[]{ } );
        setBerkalaRightPartCdArr( new Integer[]{ Cepr01040225Mapper.X1 } );
...
//        			ldec_premi_invest = 0;
        			...
        			if(istr_prop.pct_premi != 100 || (istr_prop.pct_premi == 100 && cekAdaTopUp) ){
        				...
        				//nilai tebus prosentase utk non 100%( ada kombinasi)
        			...
        			//nilai tebus prosentase komb.100% beda
...
//        			ldec_premi_invest = 0;
    ...
    {
        logger.info( "*-*-*-* Cepr01040225Business.getCommonHeaderRincianRowList" );

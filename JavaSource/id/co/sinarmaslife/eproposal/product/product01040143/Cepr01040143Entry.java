...
public class Cepr01040143Entry extends Cepr01040000Entry implements Cepr01040000EntryInterface

{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040143Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
        super( eproposalManager, editorUtil, command, errors );
        logger.info( "*-*-*-* Cepr01040144Entry constructor is called ..." );
        setDownloadUrl( "wepr01040143.pdf" );
    }
    ...
    public void fillDefaultValueEachTimeFormCalled()
    {
        ...
        if( Cepr01040143Mapper.X1 == rightPartOfBusinessCd ){ minTotalSumInsuredIdr = 100000;}
        else if( Cepr01040143Mapper.X2 == rightPartOfBusinessCd ){minTotalSumInsuredIdr = 150000;}
        else if( Cepr01040143Mapper.X3 == rightPartOfBusinessCd ){minTotalSumInsuredIdr = 200000;}
        else if( Cepr01040143Mapper.X4 == rightPartOfBusinessCd ){minTotalSumInsuredIdr = 250000;}
        else if( Cepr01040143Mapper.X5 == rightPartOfBusinessCd ){minTotalSumInsuredIdr = 300000;}
        else if( Cepr01040143Mapper.X6 == rightPartOfBusinessCd ){minTotalSumInsuredIdr = 350000;}
        else if( Cepr01040143Mapper.X7 == rightPartOfBusinessCd ){minTotalSumInsuredIdr = 400000;}
        else if( Cepr01040143Mapper.X8 == rightPartOfBusinessCd ){minTotalSumInsuredIdr = 500000;}
        else if( Cepr01040143Mapper.X9 == rightPartOfBusinessCd ){minTotalSumInsuredIdr = 600000;}
        else if( Cepr01040143Mapper.X10 == rightPartOfBusinessCd ){minTotalSumInsuredIdr = 700000;}
        else if( Cepr01040143Mapper.X11 == rightPartOfBusinessCd ){minTotalSumInsuredIdr = 800000;}
        else if( Cepr01040143Mapper.X12 == rightPartOfBusinessCd ){minTotalSumInsuredIdr = 900000;}
        else if( Cepr01040143Mapper.X13 == rightPartOfBusinessCd ){minTotalSumInsuredIdr = 1000000;}
        else if( Cepr01040143Mapper.X14 == rightPartOfBusinessCd ){minTotalSumInsuredIdr = 1500000;}
        else if( Cepr01040143Mapper.X15 == rightPartOfBusinessCd ){minTotalSumInsuredIdr = 2000000;}

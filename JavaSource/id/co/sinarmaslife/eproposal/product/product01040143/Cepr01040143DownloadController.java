...
public class Cepr01040143DownloadController extends StandardParent implements Controller
{
            ...
            throws ServletException, IOException
    {
        ...
        Cepr01040143Business cepr01040143Business = new Cepr01040143Business( eproposalManager, editorUtil, command );
       ...
       //    jasperViewer.setUrl( "/WEB-INF/classes/" + "id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040143_product.jasper" );
       ...
       //     jasperViewer.setReportDataKey( "dataSource" );
            ...
            params.put( "dataSource", cepr01040143Business.getPageList( currentIdx ) );
            ...
            List temp = cepr01040143Business.getPageList( currentIdx );
           ...
           try{
	        	   ...
	        	   //if(cekDataApprovedOrNot.get(0).getPosisi()<3){
			            JasperUtils.exportReportToPdf(
			            		"id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040143_product.jasper",
			            		dirName,
			                fileName,
							params,
							temp,

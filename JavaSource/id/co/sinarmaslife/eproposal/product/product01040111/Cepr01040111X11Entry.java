 ...
 * Function Id         	: 
 * Program Name   		: Cepr01040111X11Entry
 * Description         	:
...
public class Cepr01040111X11Entry extends Cepr01040000Entry implements Cepr01040000EntryInterface
{
    @SuppressWarnings( { "WeakerAccess" } )
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040111X11Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
...
//        cepr01030102Form.setInvestCostInPercentDisplay( CommonConst.DISPLAY_TRUE );
        ...
        cepr01030102Form.setJenisListDisplay( CommonConst.DISPLAY_FALSE );
    ...
    public void initDisabledForm()
    {
        ...
        cepr01030102Form.setJenisListIsDisabled( CommonConst.DISABLED_TRUE );
    }
    ...
    {
        cepr01030102Form.setMtiList( comboLookupBusiness.getMonthOptionVOList( false, new Integer[]{ 36 } ) );
        cepr01030102Form.setMtiCd( 12 );
        cepr01030102Form.setJenisList( comboLookupBusiness.getJenisOptionVOList(false));
        ...
        cepr01030102Form.setInvestRateInPercent( new BigDecimal( "1" ) );
...
//        }
    ...
    public void validateCurrentPage()
    {
        ...
        commonValidator.validateInsuredAge( Cepr01030102FormConst.ASSURANCE_PLAN_CD, 1, 65 );

 ...
 * Function Id         	: 
 * Program Name   		: Cepr01040111X7Entry
 * Description         	:
...
public class Cepr01040111X7Entry extends Cepr01040000Entry implements Cepr01040000EntryInterface
{
    @SuppressWarnings( { "WeakerAccess" } )
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040111X7Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
        super( eproposalManager, editorUtil, command, errors );
        logger.info( "*-*-*-* Cepr01040111X7Entry constructor is called ..." );
        setDownloadUrl( "wepr01040111.pdf" );
    }

    public void initDisplayedForm()
    {
        logger.info( "*-*-*-* Cepr01040111X7Entry.initDisplayedForm" );
        displayStandardForm();
...
//        cepr01030102Form.setInvestCostInPercentDisplay( CommonConst.DISPLAY_TRUE );
    ...
    {
        logger.info( "*-*-*-* Cepr01040111X7Entry.initDisabledForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040111X7Entry.initReadOnlyForm" );
    }

    public void fillDefaultValueEachTimeRightPartOfBusinessCdChanged()
    {
        logger.info( "*-*-*-* Cepr01040111X7Entry.fillDefaultValueEachTimeRightPartOfBusinessCdChanged" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040111X7Entry.fillDefaultValueEachTimeFormCalled" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040111X7Entry.validateCurrentPage" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040111X7Entry.validatePreviousPage" );
//        commonValidator.validateInsuredAge( Cepr01030102FormConst.ASSURANCE_PLAN_CD, 0, 70 );
    }

    public void processFormAfterSubmitBeforeValidation()
    {
        logger.info( "*-*-*-* Cepr01040111X7Entry.processFormAfterSubmitBeforeValidation" );
    }

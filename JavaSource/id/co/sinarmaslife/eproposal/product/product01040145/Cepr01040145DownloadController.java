 ...
 * Function Id         	: 
 * Program Name   		: Cepr01040145DownloadController
...
public class Cepr01040145DownloadController extends StandardParent implements Controller
{
	protected final static Log logger = LogFactory.getLog( Cepr01040145DownloadController.class );
	static Integer currentIdx;
	
    public ModelAndView handleRequest( HttpServletRequest request, HttpServletResponse response )
            throws ServletException, IOException
    {
        logger.info( "*-*-*-* Cepr01040145DownloadController.handleRequest" );
        ...
        Cepr01040145Business cepr01040145Business = new Cepr01040145Business( eproposalManager, editorUtil, command );
        ...
        {
        	List<String> messageEkaSehatList = cepr01040145Business.getEkaSehatMsgBox();
        ...
        {
            List<String> messageBoxList = cepr01040145Business.getMedicalMsgBox();
        ...
        else
        {
            ...
            jasperViewer.setUrl( "/WEB-INF/classes/" + "id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040145_product.jasper" );
            ...
            double[] nonCelaka = { 20, 40, 60, 80, 100, 0, 0, 0 };
...
//            	cashValueCount =SIMAS MAXISAVE
            ...
            ciRider = cepr01040145Business.of_get_coi_ci(kursId, cepr01030101Form.getInsuredAge(), premiTotalSekaligus, premiTotalTahunan, premiTotalSemesteran, premiTotalTriwulanan, premiTotalBulanan);
            termRider = cepr01040145Business.of_get_coi_term(kursId, cepr01030101Form.getInsuredAge(), premiTotalSekaligus, premiTotalTahunan, premiTotalSemesteran, premiTotalTriwulanan, premiTotalBulanan);
            paRider = cepr01040145Business.of_get_coi_pa(kursId, cepr01030101Form.getInsuredAge(), premiTotalSekaligus, premiTotalTahunan, premiTotalSemesteran, premiTotalTriwulanan, premiTotalBulanan);
            hcpRider = cepr01040145Business.of_get_coi_hcp(kursId, cepr01030101Form.getInsuredAge(), premiTotalSekaligus, premiTotalTahunan, premiTotalSemesteran, premiTotalTriwulanan, premiTotalBulanan);
            tpdRider = cepr01040145Business.of_get_coi_tpd(kursId, cepr01030101Form.getInsuredAge(), premiTotalSekaligus, premiTotalTahunan, premiTotalSemesteran, premiTotalTriwulanan, premiTotalBulanan);
            ekaSehatRider = cepr01040145Business.of_get_coi_eka_sehat(kursId, cepr01030101Form.getInsuredAge(), premiTotalSekaligus, premiTotalTahunan, premiTotalSemesteran, premiTotalTriwulanan, premiTotalBulanan);
            ekaSehatIlRider = cepr01040145Business.of_get_coi_eka_sehat_il(kursId, cepr01030101Form.getInsuredAge(), premiTotalSekaligus, premiTotalTahunan, premiTotalSemesteran, premiTotalTriwulanan, premiTotalBulanan);
            ladiesInsRider = cepr01040145Business.of_get_coi_ladies_ins(kursId, cepr01030101Form.getInsuredAge(), premiTotalSekaligus, premiTotalTahunan, premiTotalSemesteran, premiTotalTriwulanan, premiTotalBulanan);
            hcpLadRider = cepr01040145Business.of_get_coi_hcp_lad(kursId, cepr01030101Form.getInsuredAge(), premiTotalSekaligus, premiTotalTahunan, premiTotalSemesteran, premiTotalTriwulanan, premiTotalBulanan);
            ladiesMedRider = cepr01040145Business.of_get_coi_ladies_med(kursId, cepr01030101Form.getInsuredAge(), premiTotalSekaligus, premiTotalTahunan, premiTotalSemesteran, premiTotalTriwulanan, premiTotalBulanan);
            ladiesMedIlRider = cepr01040145Business.of_get_coi_ladies_med_il(kursId, cepr01030101Form.getInsuredAge(), premiTotalSekaligus, premiTotalTahunan, premiTotalSemesteran, premiTotalTriwulanan, premiTotalBulanan);
            hcpProRider = cepr01040145Business.of_get_coi_hcp_pro(kursId, cepr01030101Form.getInsuredAge(), premiTotalSekaligus, premiTotalTahunan, premiTotalSemesteran, premiTotalTriwulanan, premiTotalBulanan);
            if(jenis != 0){
            	source = JrUtil.convertToDsAndSetNullIfEmpty( riderBusiness.getRiderHcpFamilyList() );
                if( source != null ){
	            	hcpFamilyRider = cepr01040145Business.of_get_coi_hcp_family(jenis, kursId, cepr01030101Form.getInsuredAge(), premiTotalSekaligus, premiTotalTahunan, premiTotalSemesteran, premiTotalTriwulanan, premiTotalBulanan);
            ...
            if(currentIdx > 0){ 
            	params.put( "dsCommonHeader2", JasperReportsUtils.convertReportData( cepr01040145Business.getHeaderRowList( command ) ) );
            	params.put( "dsCommonHeaderx", JasperReportsUtils.convertReportData( cepr01040145Business.getHeaderRowList( command ) ) );
            }
            
            params.put( "dataSource", cepr01040145Business.getPageList(currentIdx) );
            ...
            params.put( "dsCommonHeader", JasperReportsUtils.convertReportData( cepr01040145Business.getHeaderRowList( command ) ) );
            ...
            List temp = cepr01040145Business.getPageList(currentIdx);
           ...
           try{
			       JasperUtils.exportReportToPdf(
			            		"id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040145_product.jasper",
			            		dirName,
			                fileName,
							params,
							temp,
    ...
    {
       // logger.info( "*-*-*-* Cepr01040145DownloadController.getManfaatPersonalAccidentParamsMap" );
    	logger.info( "*-*-*-* Cepr01040145DownloadController.getManfaatPersonalAccidentParamsMap" );
        Cepr01030000HoldingForm cepr01030000HoldingForm = ( Cepr01030000HoldingForm ) command;
        Cepr01030102Form cepr01030102Form = cepr01030000HoldingForm.getCepr01030102Form();

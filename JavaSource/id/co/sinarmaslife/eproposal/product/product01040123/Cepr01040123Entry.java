...
public class Cepr01040123Entry extends Cepr01040000UlinkEntry implements Cepr01040000EntryInterface
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040123Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
        super( eproposalManager, editorUtil, command, errors );
        logger.info( "*-*-*-* Cepr01040123Entry constructor is called ..." );
        setDownloadUrl( "wepr01040123.pdf" );
    } 

    public void initDisplayedForm()
    {
        logger.info( "*-*-*-* Cepr01040123Entry.initDisplayedForm" );
        displayStandardForm();
...
//           	  cepr01030102Form.setSpecialOfferListIsDisabled( CommonConst.DISABLED_TRUE );
    ...
    {
        logger.info( "*-*-*-* Cepr01040123Entry.initDisabledForm" );
...
//        	cepr01030102Form.setSpecialOfferListIsDisabled( CommonConst.DISABLED_TRUE );
    ...
    {
        logger.info( "*-*-*-* Cepr01040123Entry.initReadOnlyForm" );
    ...
    public void fillDefaultValueEachTimeRightPartOfBusinessCdChanged()
    {
        ...
        logger.info( "*-*-*-* Cepr01040123Entry.fillDefaultValueEachTimeRightPartOfBusinessCdChanged" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040123Entry.fillDefaultValueEachTimeFormCalled" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040123Entry.validateCurrentPage" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040123Entry.validatePreviousPage" );
        if( Cepr01040123Mapper.X1 == cepr01030102Form.getRightPartOfBusinessCd() )
        {
...
//        commonValidator.validatePolicyHolderIsInsured( Cepr01030102FormConst.ASSURANCE_PLAN_CD );
    ...
    {
        logger.info( "*-*-*-* Cepr01040123Entry.processFormAfterSubmitBeforeValidation" );
...
//                }
    ...
    {
        logger.info( "*-*-*-* Cepr01040123Entry.validateCurrentPageInCommon" );
        double premium = LazyConverter.toDouble( cepr01030102Form.getPremium() );
        double minPremiumIdr;
        double minPremiumUsd = -1;
      ...
      */
        ...
        if(Cepr01040123Mapper.X2 == cepr01030102Form.getRightPartOfBusinessCd())
	    {

...
public class Cepr01040123Business extends Cepr01040000Ilustration116Business
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040123Business( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command )
    {
        super( eproposalManager, editorUtil, command );
        setSekaligusRightPartCdArr( new Integer[]{ Cepr01040123Mapper.X1 } );
        setBerkalaRightPartCdArr( new Integer[]{ Cepr01040123Mapper.X2} );
...
//        result.add( params );
    ...
    {
        logger.info( "*-*-*-* Cepr01040123Business.getCommonHeaderRow123List" );
        ...
        result.addAll( source.getTermOfContractWithLimitMap( 80 ) );
    ...
    public List<Map<String, Object>> getCommonHeaderSmallRow123List() throws IOException
    {
        ...
        result.addAll( source.getInsuredNameMap() );
        result.addAll( source.getInsuredAgeMap() );
        result.addAll( source.getTermOfContractWithLimitMapInTwoRows( 80 ) );
    ...
    {
    	// from wf_set_116
    	return getIllustrationResult();
    }
    
    //    I got this from wf_set_116
    public IllustrationResultVO getIllustrationResult_Surrender()
    {

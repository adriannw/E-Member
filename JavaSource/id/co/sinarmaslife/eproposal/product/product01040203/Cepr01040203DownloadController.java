 ...
 * Function Id         	: 
 * Program Name   		: Cepr01040203DownloadController
 * Description         	: Artha/Eka Link 88 (162)
 * Environment      	: Java  1.5.0_06
 * Author               : samuel
 * Version              : 1.0
 * Creation Date    	: Jan 31, 2008 9:09:51 AM
 *
...
public class Cepr01040203DownloadController extends StandardParent implements Controller
{
    ...
    {
        logger.info( "*-*-*-* Cepr01040203DownloadController.handleRequest" );
        ...
        Cepr01040203Business cepr01040203Business = new Cepr01040203Business( eproposalManager, editorUtil, command );

        ModelAndView result;
        if( request.getSession().getAttribute( "messageEkaSehatList" ) == null )
        {
        	List<String> messageEkaSehatList = cepr01040203Business.getEkaSehatMsgBox();
        ...
        {
            List<String> messageBoxList = cepr01040203Business.getMedicalMsgBox();
        ...
        else
        {
            ...
            jasperViewer.setUrl( "/WEB-INF/classes/" + "id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040203_product.jasper" );
            ...
            {
                productLabel = "EKA LINK 88 PLUS";
            }

            params.put( "title", "SMiLe LINK 88" );
           ...
           // params.put( "placeAndDate", "Jakarta, " + FormatDate.toIndonesian( eproposalManager.selectNowDate() ) );
            ...
            IllustrationResultVO illustrationResultVO = cepr01040203Business.getIllustrationResult();
            ...
            params.put( "totalInvestmentAllocation", cepr01040203Business.getInvestmentYield().getTotalInvestmentAllocation() );
            params.put( "totalAssumptionLow", cepr01040203Business.getInvestmentYield().getTotalAssumptionLow() );
            params.put( "totalAssumptionMid", cepr01040203Business.getInvestmentYield().getTotalAssumptionMid() );
            params.put( "totalAssumptionHi", cepr01040203Business.getInvestmentYield().getTotalAssumptionHi() );

            params.put( "dsCommonHeader", JasperReportsUtils.convertReportData( cepr01040203Business.getCommonHeaderRowList( ) ) );
            params.put( "dsCommonHeaderSmall", JasperReportsUtils.convertReportData( cepr01040203Business.getCommonHeaderSmallRowList() ) );
            params.put( "dsInvestmentChoice", JasperReportsUtils.convertReportData( cepr01040203Business.getInvestmentChoiceRowList() ) );
            params.put( "dsInvestmentChoiceSmall", JasperReportsUtils.convertReportData( cepr01040203Business.getInvestmentChoiceSmallRowList() ) );
            params.put( "dsMonthlyPremium", JasperReportsUtils.convertReportData( cepr01040203Business.getMonthlyPremiumList( cepr01030102Form ) ) );
            params.put( "dsInvestmentPerformance", JasperReportsUtils.convertReportData( cepr01040203Business.getInvestmentPerformanceList() ) );
            params.put( "dsInvestmentYield", JasperReportsUtils.convertReportData( cepr01040203Business.getInvestmentYield().getYieldList() ) );
            params.put( "dsOneRow", JasperReportsUtils.convertReportData( cepr01040203Business.getOneRowList() ) );
            params.put( "dsNoteSekaligus", JasperReportsUtils.convertReportData( cepr01040203Business.getNoteSekaligusRowList() ) );
            params.put( "dsNoteBerkala", JasperReportsUtils.convertReportData( cepr01040203Business.getNoteBerkalaRowList() ) );
            ...
            params.put( "dataSource", cepr01040203Business.getPageList( currentIdx ) );
          ...
          //  String fileName="testx.pdf";
            ...
            List temp = cepr01040203Business.getPageList( currentIdx );
           ...
           try{      
	        	   //if(cekDataApprovedOrNot.get(0).getPosisi()<3){
			            JasperUtils.exportReportToPdf(
			            		"id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040203_product.jasper",
			            		dirName,
			                fileName,
							params,
							temp,

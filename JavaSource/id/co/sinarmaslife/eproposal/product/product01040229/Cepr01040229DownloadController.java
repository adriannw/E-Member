...
public class Cepr01040229DownloadController extends StandardParent implements Controller
{
    ...
    {
        logger.info( "*-*-*-* Cepr01040228DownloadController.handleRequest" );
    ...
    //    AbstractJasperReportsView jasperViewer = null;
        ...
        Cepr01040229Business cepr01040229Business = new Cepr01040229Business( eproposalManager, editorUtil, command );
...
//        }        
        ...
        {
        	List<String> messageEkaSehatList = cepr01040229Business.getEkaSehatMsgBox();
    ...
    {    	
    	  HashMap<String, Object> result = new HashMap<String, Object>();
    	   Cepr01040229Business cepr01040229Business = new Cepr01040229Business( eproposalManager, editorUtil, cepr01030000HoldingForm );    	 
        ...
        // jasperViewer.setUrl( "/WEB-INF/classes/" + "id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040228_product.jasper" );
        ...
        // params.put( "title", "RENCANA CERDAS" );
         ...
         if( cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040229Mapper.X2 ){
            	params.put( "title", "JEMPOL LINK SYARIAH");
         }else if( cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040229Mapper.X3 ){
         	params.put( "title", "B SMiLe PROTECTION SYARIAH");
         }
...
//         params.put( "logoPath", eproposalManager.getProps().getProperty( "logo.syariah" ) );
         ...
         IllustrationResultVO illustrationResultVO = cepr01040229Business.getIllustrationResult();
         ...
         //
         IllustrationResultVO illustrationResultVO2 = cepr01040229Business.getIllustrationResult2(); // perhitungan polis
         ...
         //params.put( "dsInvestmentYield2", JasperReportsUtils.convertReportData( cepr01040229Business.getInvestmentYield().getYieldList() ) );  
         params.put( "dsInvestmentYield2", JasperReportsUtils.convertReportData( cepr01040229Business.of_get_rate_ds().getYieldList() ) );
         
         params.put( "dsCommonHeaderSmall2", JasperReportsUtils.convertReportData( cepr01040229Business.getCommonHeaderSmallRowList() ) );
         params.put( "dsInvestmentChoiceSmall2", JasperReportsUtils.convertReportData( cepr01040229Business.getInvestmentChoiceSmallRowList() ) );          
         ...
         logger.info( "*-*-*-* cepr01040216Business.getInvestmentYield() = " + cepr01040229Business.getInvestmentYield() );
         //params.put( "totalInvestmentAllocation", cepr01040229Business.getInvestmentYield().getTotalInvestmentAllocation() );
         //params.put( "totalAssumptionLow", cepr01040229Business.getInvestmentYield().getTotalAssumptionLow() );
         //params.put( "totalAssumptionMid", cepr01040229Business.getInvestmentYield().getTotalAssumptionMid() );
         //params.put( "totalAssumptionHi", cepr01040229Business.getInvestmentYield().getTotalAssumptionHi() );
         params.put( "totalInvestmentAllocation", cepr01040229Business.of_get_rate_ds().getTotalInvestmentAllocation() );
         params.put( "totalAssumptionLow", cepr01040229Business.of_get_rate_ds().getTotalAssumptionLow() );
         params.put( "totalAssumptionMid", cepr01040229Business.of_get_rate_ds().getTotalAssumptionMid() );
         params.put( "totalAssumptionHi", cepr01040229Business.of_get_rate_ds().getTotalAssumptionHi() );
         
         params.put( "dsCommonHeader", JasperReportsUtils.convertReportData( cepr01040229Business.getCommonHeaderRowList() ) );
         params.put( "dsCommonHeaderSmall", JasperReportsUtils.convertReportData( cepr01040229Business.getCommonHeaderSmallRowList() ) );
         params.put( "dsCommonHeaderSmall2", JasperReportsUtils.convertReportData( cepr01040229Business.getCommonHeaderSmallRowList() ) );
             
         //IllustrationResultVO illustrationResultVO3 = cepr01040229Business.getIllustrationResult();
         IllustrationResultVO illustrationResultVO3 = cepr01040229Business.getIllustrationResult(); // perhitungan polis
         params.put( "EkalinkIllustration3", JasperReportsUtils.convertReportData(illustrationResultVO3.getIllustrationList() ) );
         
         
         params.put( "dsCommonHeaderSmall3", JasperReportsUtils.convertReportData( cepr01040229Business.getCommonHeaderSmallRowList() ) );      
         params.put( "dsInvestmentYield3", JasperReportsUtils.convertReportData( cepr01040229Business.getInvestmentYield().getYieldList() ) );
         
         params.put( "dsCommonHeaderSmall4", JasperReportsUtils.convertReportData( cepr01040229Business.getCommonHeaderSmallRowList() ) );
         IllustrationResultVO illustrationResultVO4 = cepr01040229Business.getIllustrationResult2(); // perhitungan polis
         params.put( "dsEkalinkIllustration4", JasperReportsUtils.convertReportData( illustrationResultVO2.getIllustrationList() ) );
         params.put( "dsInvestmentYield4", JasperReportsUtils.convertReportData( cepr01040229Business.getInvestmentYield().getYieldList() ) );
         
         if( cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040228Mapper.X3 ){
        	 params.put( "dsInvestmentChoice", JasperReportsUtils.convertReportData( cepr01040229Business.getInvestmentChoiceRowList2() ) );
        	 params.put( "dsInvestmentChoiceSmall", JasperReportsUtils.convertReportData( cepr01040229Business.getInvestmentChoiceSmallRowList2() ) );
        	 params.put( "dsInvestmentChoiceSmall3", JasperReportsUtils.convertReportData( cepr01040229Business.getInvestmentChoiceSmallRowList2() ) );
         }else{         
        	 params.put( "dsInvestmentChoice", JasperReportsUtils.convertReportData( cepr01040229Business.getInvestmentChoiceRowList() ) );
        	 params.put( "dsInvestmentChoiceSmall", JasperReportsUtils.convertReportData( cepr01040229Business.getInvestmentChoiceSmallRowList() ) );
        	 params.put( "dsInvestmentChoiceSmall3", JasperReportsUtils.convertReportData( cepr01040229Business.getInvestmentChoiceSmallRowList() ) );
         }
         params.put( "dsMonthlyPremium", JasperReportsUtils.convertReportData( cepr01040229Business.getMonthlyPremiumList( cepr01030102Form ) ) );
         params.put( "dsInvestmentPerformance", JasperReportsUtils.convertReportData( cepr01040229Business.getInvestmentPerformanceList() ) );
         params.put( "dsInvestmentYield", JasperReportsUtils.convertReportData( cepr01040229Business.of_get_rate_ds().getYieldList() ) );
         params.put( "dsOneRow", JasperReportsUtils.convertReportData( cepr01040229Business.getOneRowList() ) );
         params.put( "dsNoteSekaligus", JasperReportsUtils.convertReportData( cepr01040229Business.getNoteSekaligusRowList() ) );
         params.put( "dsNoteBerkala", JasperReportsUtils.convertReportData( cepr01040229Business.getNoteBerkalaRowList() ) );
...
putRiderParam( params, riderBusiness.getRiderEkaSehatExtraListMap(), "dsRiderEkaSehatExtra", "riderEkaSehatExtraIndex");
         ...
         params.put( "dataSource", cepr01040229Business.getPageList( currentIdx ) );
         ...
         params.put( "dsEkalinkRider", JasperReportsUtils.convertReportData( cepr01040229Business.getRiderPremiumList(cepr01030102Form, cepr01030101Form.getInsuredAge()) ) );
         params.put( "dsEkalinkRider2", JasperReportsUtils.convertReportData( cepr01040229Business.getRiderPremiumList(cepr01030102Form, cepr01030101Form.getInsuredAge()) ) );

         
         params.put( "dsCommonHeaderRincian", JasperReportsUtils.convertReportData( cepr01040229Business.getCommonHeaderRincianRowList()) );
         double ldec_coi = cepr01040229Business.of_get_coi_basic_220( 1 );
         BigDecimal biayaAsuransiPokok =  new BigDecimal(ldec_coi);
         params.put( "dsCommonBiayaRincian", JasperReportsUtils.convertReportData( cepr01040229Business.getCommonBiayaRincianRowList( biayaAsuransiPokok ) ) );
         
         params.put("pageRider", cepr01040229Business.getPageRider( currentIdx ));
         params.put( "dsCommonHeaderRincianRiderPa", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040229Business.getCommonHeaderRincianSmallRowList(1) ) );
         params.put( "dsCommonBiayaRincianRiderPa", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040229Business.getCommonBiayaRincianRider(1) ) );
         params.put( "dsCommonHeaderRincianRiderTpd", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040229Business.getCommonHeaderRincianSmallRowList(3) ) );
         params.put( "dsCommonBiayaRincianRiderTpd", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040229Business.getCommonBiayaRincianRider(3) ) ); 
         params.put( "dsCommonHeaderRincianRiderCi", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040229Business.getCommonHeaderRincianSmallRowList(4) ) );
         params.put( "dsCommonBiayaRincianRiderCi", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040229Business.getCommonBiayaRincianRider(4) ) ); 
         params.put( "dsCommonHeaderRincianRiderHCPFamily", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040229Business.getCommonHeaderRincianSmallRowList(11) ) );
         params.put( "dsCommonBiayaRincianRiderHCPFamily", JasperReportsUtils.convertReportData( cepr01040229Business.getCommonBiayaRincianRider(11) ) );
         ...
         params.put( "dsCommonHeaderRincianRiderHCP", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040229Business.getCommonHeaderRincianSmallRowList(2) ) );
         params.put( "dsCommonBiayaRincianRiderHCP", JasperReportsUtils.convertReportData( cepr01040229Business.getCommonBiayaRincianRider(2) ) );
         params.put( "dsRincianRiderHCP", JrUtil.convertToDsAndSetNullIfEmpty( riderBusiness.getRiderHcpSyariahList() ));    
         
         params.put( "dsCommonHeaderRincianRiderHCPProvider", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040229Business.getCommonHeaderRincianSmallRowList(16) ) );
         params.put( "dsCommonBiayaRincianRiderHCPProvider", JasperReportsUtils.convertReportData( cepr01040229Business.getCommonBiayaRincianRider(16) ) );
         params.put( "dsRincianRiderHCPProvider", JrUtil.convertToDsAndSetNullIfEmpty( riderBusiness.getRiderHcpProviderList()));    
         
         params.put( "dsCommonHeaderRincianRiderTerm", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040229Business.getCommonHeaderRincianSmallRowList(12) ) );
         params.put( "dsCommonBiayaRincianRiderTerm", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040229Business.getCommonBiayaRincianRider(12) ) ); 
         params.put( "dsCommonHeaderRincianRiderEkaSehat", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040229Business.getCommonHeaderRincianSmallRowList(13) ) );
         params.put( "dsCommonBiayaRincianRiderEkaSehat", JasperReportsUtils.convertReportData( cepr01040229Business.getCommonBiayaRincianRider(13) ) );     
         ...
         params.put( "dsCommonHeaderRincianRiderEkaSehatInnerLimit", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040229Business.getCommonHeaderRincianSmallRowList(15) ) );
         params.put( "dsCommonBiayaRincianRiderEkaSehatInnerLimit", JasperReportsUtils.convertReportData( cepr01040229Business.getCommonBiayaRincianRider(15) ) );     
         ...
         params.put( "dsCommonHeaderRincianRiderWaiverTpdCi", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040229Business.getCommonHeaderRincianSmallRowList(17) ) );
         params.put( "dsCommonBiayaRincianRiderWaiverTpdCi", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040229Business.getCommonBiayaRincianRider(17) ) );
         params.put( "dsCommonHeaderRincianRiderPayorTpdCiDeath", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040229Business.getCommonHeaderRincianSmallRowList(18) ) );
         params.put( "dsCommonBiayaRincianRiderPayorTpdCiDeath", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040229Business.getCommonBiayaRincianRider(18) ) );
         
         params.put( "dsCommonHeaderRincianRiderLadiesIns", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040229Business.getCommonHeaderRincianSmallRowList(19) ) );
         params.put( "dsCommonBiayaRincianRiderLadiesIns", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040229Business.getCommonBiayaRincianRider(19) ) ); 
         params.put( "dsCommonHeaderRincianRiderHCPLadies", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040229Business.getCommonHeaderRincianSmallRowList(20) ) );
         params.put( "dsCommonBiayaRincianRiderHCPLadies", JasperReportsUtils.convertReportData( cepr01040229Business.getCommonBiayaRincianRider(20) ) );
         params.put( "dsRincianRiderHcpLadies", JrUtil.convertToDsAndSetNullIfEmpty( riderBusiness.getRiderHcpLadiesList()));
         params.put( "dsCommonHeaderRincianRiderLadiesMedExpense", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040229Business.getCommonHeaderRincianSmallRowList(21) ) );
         params.put( "dsCommonBiayaRincianRiderLadiesMedExpense", JasperReportsUtils.convertReportData( cepr01040229Business.getCommonBiayaRincianRider(21) ) );     
         ...
         params.put( "dsCommonHeaderRincianRiderLadiesMedExpenseInnerLimit", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040229Business.getCommonHeaderRincianSmallRowList(22) ) );
         params.put( "dsCommonBiayaRincianRiderLadiesMedExpenseInnerLimit", JasperReportsUtils.convertReportData( cepr01040229Business.getCommonBiayaRincianRider( 22) ) );     
         ...
         params.put( "dsCommonHeaderRincianRiderPayor5Tpd10CiDeath", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040229Business.getCommonHeaderRincianSmallRowList(23) ) );
         params.put( "dsCommonBiayaRincianRiderPayor5Tpd10CiDeath", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040229Business.getCommonBiayaRincianRider(23) ) );
         params.put( "dsCommonHeaderRincianRiderWaiver5Tpd10Ci", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040229Business.getCommonHeaderRincianSmallRowList(24) ) );
         params.put( "dsCommonBiayaRincianRiderWaiver5Tpd10Ci", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040229Business.getCommonBiayaRincianRider(24) ) );
         params.put( "dsCommonHeaderRincianRiderScholar", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040229Business.getCommonHeaderRincianSmallRowList(25) ) );
         params.put( "dsCommonBiayaRincianRiderScholar", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040229Business.getCommonBiayaRincianRider(25) ) ); 
         params.put( "dsCommonHeaderRincianRiderEarlyStageCi99", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040229Business.getCommonHeaderRincianSmallRowList(27) ) );
         params.put( "dsCommonBiayaRincianRiderEarlyStageCi99", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040229Business.getCommonBiayaRincianRider(27) ) );            
         params.put( "dsCommonHeaderRincianRiderMedicalPlus", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040229Business.getCommonHeaderRincianSmallRowList(28) ) );
         params.put( "dsCommonBiayaRincianRiderMedicalPlus", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040229Business.getCommonBiayaRincianRider(28) ) );  
       ...
       //SMiLe Medical Extra Syariah Maret 2021
         params.put( "dsCommonHeaderRincianRiderEkaSehatExtra", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040229Business.getCommonHeaderRincianSmallRowList(29) ) );
         params.put( "dsCommonBiayaRincianRiderEkaSehatExtra", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040229Business.getCommonBiayaRincianRider(29) ) );     
         ...
         params.put( "tipeEkaSehat", cepr01040229Business.checkTipeEkaSehat(29) );
         
         params.put("jenis", cepr01030102Form.getRightPartOfBusinessCd()+"");
         params.put( "dsOneRow2", JasperReportsUtils.convertReportData( cepr01040229Business.getOneRowList() ) );
         params.put( "dsOneRow22", JasperReportsUtils.convertReportData( cepr01040229Business.getOneRowList() ) );
       ...
       //  String fileName="testx.pdf";
         ...
         List temp = cepr01040229Business.getPageList( currentIdx );
         ...
         try{      
	        	   //if(cekDataApprovedOrNot.get(0).getPosisi()<3){
			            JasperUtils.exportReportToPdf(
			            		"id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040229_product.jasper",
			            		dirName,
			                fileName,
							params,
							temp,

...
public class Cepr01040149Business extends Cepr01040000ProductBusiness
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040149Business( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command )
    {
        ...
        List<Map<String, Object>> result = new ArrayList<Map<String, Object>>();
          ...
          result.addAll( source.getPolicyHolderNameMap() );
            result.addAll( source.getPolicyHolderAgeMap() );
            	 ...
            	 param = new HashMap<String, Object>();            
            	 param.put( "label", "Cara Pembayaran Kontribusi" );
             ...
             result.addAll( source.getTermOfContractWithLimitSyariahMap( 22 ) );
	             param = new HashMap<String, Object>();            
	        	 param.put( "label", "Manfaat Asuransi Syariah" );
    ...
    public List<Map<String, Object>> getBiayaList(String word, BigDecimal biaya, String cara_bayar) throws IOException
    {
    	List<Map<String, Object>> result = new ArrayList<Map<String, Object>>();
	    Map<String, Object> params = new HashMap<String, Object>();
	    params.put( "label", "-	Biaya Asuransi Syariah"+ word );

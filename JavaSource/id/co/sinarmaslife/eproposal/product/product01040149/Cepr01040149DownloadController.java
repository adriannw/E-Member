...
public class Cepr01040149DownloadController extends StandardParent implements Controller
{
            ...
            throws ServletException, IOException
    {
        ...
        Cepr01040149Business cepr01040149Business = new Cepr01040149Business( eproposalManager, editorUtil, command );
     ...
     //       jasperViewer.setApplicationContext( WebApplicationContextUtils.getWebApplicationContext( request.getSession().getServletContext() ) );
          ...
          //  result = new ModelAndView( "CEPR00000000DownloadDocumentJSP" , params );    
              result = null;        
        }
        return result;
    }
            ...
            throws ServletException, IOException
    {
    	  ...
    	  Cepr01040149Business cepr01040149Business = new Cepr01040149Business( eproposalManager, editorUtil, cepr01030000HoldingForm );
     ...
     //     jasperViewer.setUrl( "/WEB-INF/classes/" + "id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040149_product.jasper" );
...
//      		String dateStringFinal = tempDate.format(newDate);
  ...
  //        String dateFormat = sdf.format( cepr01030101Form.getTgl_input() );
  	...
  	//	}
          params.put( "title", "SIMAS KID INSURANCE SYARIAH");
          if( (cepr01030102Form.getRightPartOfBusinessCd() >= Cepr01040149Mapper.X5) ){
        	params.put( "title", "Smart Plan Protection Syariah");
          }                
          
          params.put( "dsCommonHeaderRincian", JasperReportsUtils.convertReportData( cepr01040149Business.getCommonHeaderRincianRowList()) );
      
          params.put( "dsRincian", JasperReportsUtils.convertReportData( cepr01040149Business.getPageList()) );
          params.put( "dsCommonHeaderRincianRiderBaby", JasperReportsUtils.convertReportData( cepr01040149Business.getCommonHeaderRincianSmallRowList()) );
         ...
         double[][] tahapan = new double[8][5];
         if (cepr01030102Form.getRightPartOfBusinessCd() > Cepr01040149Mapper.X4){
        	 tahapan[4][0] = 0.05;
             tahapan[4][1] = 0.1;
             tahapan[4][2] = 0.2;
             tahapan[4][3] = 0.5;
         ...
         params.put( "tipeMedisTT", cepr01040149Business.getTipeMedisTT( cepr01030000HoldingForm ));
        ...
        switch( paymentModeCd )
        {
         ...
         double premi = cepr01040149Business.computePremium( cepr01030102Form.getPaymentModeCd() ).doubleValue();
         ...
         for( int i = 1; i <= (22-usiaTT); i++ )
         {
      	 ...
      	 map.put( "age", usiaTT+i );
         	  ...
         	  if(i<=5){
         			  map.put( "premi", new BigDecimal(cepr01040149Business.computePremiumSetahun( cepr01030102Form.getPaymentModeCd()).doubleValue() + premiBaby2));
         	  }else{
         		 map.put( "premi", null );
         	  }
         	  
         	 
         	  BigDecimal nt =  cepr01040149Business.computeNT( i );
        ...
        //	 map.put( "nt", nt );
         ...
         params.put( "dsCommonBiayaRincian", JasperReportsUtils.convertReportData( cepr01040149Business.getBiayaList("", new BigDecimal(premi) , label)) );
         params.put( "dsCommonBiayaRincianRiderBaby", JasperReportsUtils.convertReportData( cepr01040149Business.getBiayaList(" SMiLe Baby", new BigDecimal(premiBaby) , label)) );
         ...
         try{
	        	   ...
	        	   //if(cekDataApprovedOrNot.get(0).getPosisi()<3){
			            JasperUtils.exportReportToPdf(
			            		"id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040149_product.jasper",
			            		dirName,
			                fileName,
							params,
							mapList,

 ...
 * Function Id         	: 
 * Program Name   		: Cepr01040133Business
 * Description         	:
...
public class Cepr01040133Business extends Cepr01040000ProductBusiness
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040133Business( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command )
    {
    ...
    {
        logger.info( "*-*-*-* Cepr01040133Business.computeManfaat" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040133Business.of_get_rate_for_pk" );
        double result;
        Cepr01030101Form cepr01030101Form = ( ( Cepr01030000HoldingForm ) command ).getCepr01030101Form();
        Cepr01030102Form cepr01030102Form = ( ( Cepr01030000HoldingForm ) command ).getCepr01030102Form();
    ...
    {
        logger.info( "*-*-*-* Cepr01040133DownloadController.getCommonHeaderRowList" );
    ...
    public List< Map<String, Object> > getHeaderSecondList( Object command ) throws IOException
    {
        logger.info( "*-*-*-* Cepr01040133DownloadController.getCommonHeaderRowList" );
        ...
        result.addAll( source.getTermOfContractMap() );
        result.addAll( source.getTermOfPaymentMap() );
        result.addAll( source.getPremiumMap() );

 ...
 * Function Id         	: 01040107
 * Program Name   		: Cepr01040107Entry
...
public class Cepr01040107Entry extends Cepr01040000Entry implements Cepr01040000EntryInterface

{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040107Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
        super( eproposalManager, editorUtil, command, errors );
        logger.info( "*-*-*-* Cepr01040107Entry constructor is called ..." );
        setDownloadUrl( "wepr01040107.pdf" );
    }

    public void initDisplayedForm()
    {
        logger.info( "*-*-*-* Cepr01040107Entry.initDisplayedForm" );
        displayStandardForm();
        ...
        /*
        if( cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040107Mapper.X1 ){
        	cepr01030102Form.setTaxBeforeAfterCd( "0" ); 
        }else{
        }  */      
    ...
    {
        logger.info( "*-*-*-* Cepr01040107Entry.initDisabledForm" );
        ...
        cepr01030102Form.setPremiumListIsDisabled( CommonConst.DISABLED_FALSE );
        cepr01030102Form.setTaxBeforeAfterListIsDisabled( CommonConst.DISABLED_FALSE );   
    }

    public void initReadOnlyForm()
    {
        logger.info( "*-*-*-* Cepr01040107Entry.initReadOnlyForm" );
        readOnlyAllForm( false );
    }

    public void fillDefaultValueEachTimeRightPartOfBusinessCdChanged()
    {
        logger.info( "*-*-*-* Cepr01040107Entry.fillDefaultValueEachTimeRightPartOfBusinessCdChanged" );
        if( cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040107Mapper.X1 ){
        }else{
        }
    }
    ...
    {
        logger.info( "*-*-*-* Cepr01040107Entry.fillDefaultValueEachTimeFormCalled" );
        ...
        cepr01030102Form.setMgiList( comboLookupBusiness.getMonthOptionVOList( true, new Integer[]{ 3, 6, 12 } ) );
    ...
    {
        logger.info( "*-*-*-* Cepr01040107Entry.validateCurrentPage" );
        ...
        if( Cepr01040107Mapper.X4 == rightPartOfBusinessCd )
        {
            minPremiumIdr = 60000000;
            minPremiumUsd = 6000;
        }
        else if( Cepr01040107Mapper.X5 == rightPartOfBusinessCd )
        {
    ...
    {
        logger.info( "*-*-*-* Cepr01040107Entry.validatePreviousPage" );
        if( Cepr01040107Mapper.X1 == rightPartOfBusinessCd )
        {
        	 if( DateUtil.dateDifference(cepr01030101Form.getInsuredBirthDay(), eproposalManager.selectNowDate(), true) < 365 ){
           	  errors.rejectValue( Cepr01030102FormConst.ASSURANCE_PLAN_CD, "error.insuredAgeMinMonth", new Object[]{ Integer.toString( 12 ) }, null );
             }		
        }else{
    ...
    {
        logger.info( "*-*-*-* Cepr01040107Entry.processFormAfterSubmitBeforeValidation" );
        ...
        if( Cepr01040107Mapper.X1 == rightPartOfBusinessCd && cepr01030101Form.getInsuredAge()>69 )
        {
        	cepr01030102Form.setTotalSumInsured( cepr01030102Form.getPremium().divide(new BigDecimal(0.5)));
            commonUsedBusiness.processMaxTotalSumInsured( new BigDecimal( "100000000" ), new BigDecimal( "10000" ) );
        }

...
public class Cepr01040216Entry extends Cepr01040000UlinkEntry implements Cepr01040000EntryInterface
{
    protected final Log logger = LogFactory.getLog( getClass() );
    private static final int ASSURANCE_TERM = 80;

    public Cepr01040216Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
        super( eproposalManager, editorUtil, command, errors );
        logger.info( "*-*-*-* Cepr01040216Entry constructor is called ..." );
        setDownloadUrl( "wepr01040216.pdf" );
    }

    public void initDisplayedForm()
    {
        logger.info( "*-*-*-* Cepr01040216Entry.initDisplayedForm" );
        displayStandardForm();
        ...
        cepr01030103Form.setWaiverCiDisplay( CommonConst.DISPLAY_TRUE );
        cepr01030103Form.setWaiverTpdDisplay( CommonConst.DISPLAY_TRUE );
        cepr01030103Form.setPayorTpdDeathDisplay( CommonConst.DISPLAY_TRUE );
        cepr01030103Form.setPayorCiDeathDisplay( CommonConst.DISPLAY_TRUE );
        ...
        cepr01030103Form.setPayorCiDisplay( CommonConst.DISPLAY_TRUE );
    }

    public void initDisabledForm()
    {
        logger.info( "*-*-*-* Cepr01040216Entry.initDisabledForm" );
...
//        restore investment choice
    ...
    {
        logger.info( "*-*-*-* Cepr01040216Entry.initReadOnlyForm" );
        readOnlyAllForm( false );
    }

    public void fillDefaultValueEachTimeRightPartOfBusinessCdChanged()
    {
        logger.info( "*-*-*-* Cepr01040216Entry.fillDefaultValueEachTimeRightPartOfBusinessCdChanged" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040216Entry.fillDefaultValueEachTimeFormCalled" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040216Entry.validateCurrentPage" );
...
//        super.validateCurrentPage( parVO );
    ...
    {
        logger.info( "*-*-*-* Cepr01040216Entry.validatePreviousPage" );
        commonValidator.validateInsuredAge( Cepr01030102FormConst.ASSURANCE_PLAN_CD, 0, 60 );
    }

    public void processFormAfterSubmitBeforeValidation()
    {
        logger.info( "*-*-*-* Cepr01040216Entry.processFormAfterSubmitBeforeValidation" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040216Entry.validateCurrentPageInCommon" );
        double premium = LazyConverter.toDouble( cepr01030102Form.getPremium() );
        ...
        {
            commonValidator.validateMinimumMoney( Cepr01030102FormConst.BASE_PREMIUM, base_premium, minPremiumIdr, minPremiumUsd );
        ...
        commonValidator.validatePremiumFurloughYear( Cepr01030102FormConst.PREMIUM_FURLOUGH_YEAR, 5, 20 );
    }

...
public class Cepr01040141DownloadController extends StandardParent implements Controller
{
    ...
    {
        logger.info( "*-*-*-* Cepr01040141DownloadController.handleRequest" );
        ...
        Cepr01040141Business cepr01040112Business = new Cepr01040141Business( eproposalManager, editorUtil, command );
        ...
        else
        {
            ...
            jasperViewer.setUrl( "/WEB-INF/classes/" + "id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040141_product.jasper" );
            ...
            if(cepr01030102Form.getRightPartOfBusinessCd() == 1 || cepr01030102Form.getRightPartOfBusinessCd() == 4)
            {
            	params.put( "type", "A");
            }
            else if(cepr01030102Form.getRightPartOfBusinessCd() == 2 || cepr01030102Form.getRightPartOfBusinessCd() == 5)
            {
            	params.put( "type", "AB");
            }
            else if(cepr01030102Form.getRightPartOfBusinessCd() == 3 || cepr01030102Form.getRightPartOfBusinessCd() == 6)
            {
            	params.put( "type", "ABD");
            }
            if(cepr01030102Form.getRightPartOfBusinessCd() == 4 || cepr01030102Form.getRightPartOfBusinessCd() == 5 || cepr01030102Form.getRightPartOfBusinessCd() == 6 )
            {
            	params.put( "plan", "(NEW)");
            } else{
            	params.put( "plan", "");
           ...
           try{
			            JasperUtils.exportReportToPdf(
			            		"id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040141_product.jasper",
			            		dirName,
			                fileName,
							params,
							temp,

...
public class Cepr01040141Business extends Cepr01040000ProductBusiness
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040141Business( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command )
    {
    ...
    {
        logger.info( "*-*-*-* Cepr01040141DownloadController.getCommonHeaderRowList" );
        ...
        result.addAll( getTermOfContractSyariahMap() );
        result.addAll( getRiskSyariahMap() );
    ...
    {
        logger.info( "*-*-*-* Cepr01040141Business.getDetailList" );
    ...
    public List<Map<String, Object>> getRiskSyariahMap() throws IOException
    {
        List<Map<String, Object>> result = new ArrayList<Map<String, Object>>();
        Map<String, Object> params = new HashMap<String, Object>();
        params.put( "label", "Risiko yang diambil" );
    ...
    public List<Map<String, Object>> getTermOfContractSyariahMap() throws IOException
    {
        List<Map<String, Object>> result = new ArrayList<Map<String, Object>>();
        Map<String, Object> params = new HashMap<String, Object>();
    ...
    public List<Map<String, Object>> getTermOfPaymentMap() throws IOException
    {
        ...
        params = new HashMap<String, Object>();   
        params.put( "label", "Kontribusi/Premi Tahunan" );           

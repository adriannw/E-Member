 ...
 * Function Id         	: 01040126
 * Program Name   		: Cepr01040126Entry
...
public class Cepr01040126Entry extends Cepr01040000Entry implements Cepr01040000EntryInterface

{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040126Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
        super( eproposalManager, editorUtil, command, errors );
        logger.info( "*-*-*-* Cepr01040126Entry constructor is called ..." );
        setDownloadUrl( "wepr01040126.pdf" );
    }

    public void initDisplayedForm()
    {
        logger.info( "*-*-*-* Cepr01040126Entry.initDisplayedForm" );
        displayStandardForm();
    ...
    {
        logger.info( "*-*-*-* Cepr01040126Entry.initDisabledForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040126Entry.initReadOnlyForm" );
        readOnlyAllForm( false );
    }

    public void fillDefaultValueEachTimeRightPartOfBusinessCdChanged()
    {
        logger.info( "*-*-*-* Cepr01040126Entry.fillDefaultValueEachTimeRightPartOfBusinessCdChanged" );
    }

    public void fillDefaultValueEachTimeFormCalled()
    {
        logger.info( "*-*-*-* Cepr01040126Entry.fillDefaultValueEachTimeFormCalled" );
        cepr01030102Form.setInvestRateInPercent(new BigDecimal("4"));
    ...
    {
        logger.info( "*-*-*-* Cepr01040126Entry.validateCurrentPage" );
        if(cepr01030102Form.getPremium()!=null)
        {
	        if( cepr01030102Form.getPremium().compareTo( new BigDecimal( "1000" ) ) < 0 )
	        {
	            errors.rejectValue( Cepr01030102FormConst.PREMIUM, "error.valueAtLeast", new Object[]{ "$.1,000.00"}, null );
	        }
        }
    ...
    {
        logger.info( "*-*-*-* Cepr01040126Entry.validatePreviousPage" );
        commonValidator.validateInsuredAge( Cepr01030102FormConst.ASSURANCE_PLAN_CD, 1, 60 );
    }

    public void processFormAfterSubmitBeforeValidation()
    {
        logger.info( "*-*-*-* Cepr01040126Entry.processFormAfterSubmitBeforeValidation" );

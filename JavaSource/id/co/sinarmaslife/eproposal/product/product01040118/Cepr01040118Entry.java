 ...
 * Function Id         	: 01040118
 * Program Name   		: Cepr01040118Entry
...
public class Cepr01040118Entry extends Cepr01040000Entry implements Cepr01040000EntryInterface

{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040118Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
        super( eproposalManager, editorUtil, command, errors );
        logger.info( "*-*-*-* Cepr01040118Entry constructor is called ..." );
        setDownloadUrl( "wepr01040118.pdf" );
    }

    public void initDisplayedForm()
    {
        logger.info( "*-*-*-* Cepr01040118Entry.initDisplayedForm" );
        displayStandardForm();
    ...
    {
        logger.info( "*-*-*-* Cepr01040118Entry.initDisabledForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040118Entry.initReadOnlyForm" );
        readOnlyAllForm( false );
    }

    public void fillDefaultValueEachTimeRightPartOfBusinessCdChanged()
    {
        logger.info( "*-*-*-* Cepr01040118Entry.fillDefaultValueEachTimeRightPartOfBusinessCdChanged" );
        cepr01030102Form.setJenisList( comboLookupBusiness.getJenisOptionVOList(true));
        cepr01030102Form.setJenisCd( 0 );
        cepr01030102Form.setMgiList( comboLookupBusiness.getMonthOptionVOList( true, new Integer[]{ 3, 6, 12, 24} ) );
        cepr01030102Form.setMgiCd(12);
    }

    public void fillDefaultValueEachTimeFormCalled()
    {
        logger.info( "*-*-*-* Cepr01040118Entry.fillDefaultValueEachTimeFormCalled" );
        cepr01030102Form.setJenisList( comboLookupBusiness.getJenisOptionVOList(true));
    ...
    {
        logger.info( "*-*-*-* Cepr01040118Entry.validateCurrentPage" );
        ...
        //if( Cepr01040118Mapper.X4 == rightPartOfBusinessCd )
        //{
            //minPremiumIdr = 60000000;
            //minPremiumUsd = 6000;
        //}
        /*else if( Cepr01040118Mapper.X5 == rightPartOfBusinessCd )
        {
    ...
    {
        logger.info( "*-*-*-* Cepr01040118Entry.validatePreviousPage" );
        commonValidator.validateInsuredAge( Cepr01030102FormConst.ASSURANCE_PLAN_CD, 1, 68 );
    }

    public void processFormAfterSubmitBeforeValidation()
    {
        logger.info( "*-*-*-* Cepr01040118Entry.processFormAfterSubmitBeforeValidation" );

package id.co.sinarmaslife.eproposal.product.product01040118;
 ...
 * Function Id         	: 
 * Program Name   		: Cepr01040118DownloadController
...
public class Cepr01040118DownloadController extends StandardParent implements Controller
{
    ...
    {
        logger.info( "*-*-*-* Cepr01040118DownloadController.handleRequest" );
        ...
        Cepr01040118Business cepr01040118Business = new Cepr01040118Business( eproposalManager, editorUtil, command );
        ...
        else
        {
            ...
            jasperViewer.setUrl( "/WEB-INF/classes/" + "id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040118_product.jasper" );
            ...
            double li_ke = 0;
            int li_tahun = 0;
            //double ldec_sc[] = {0.15, 0.10, 0.05, 0.00};
         ...
         //   Date nowDate = eproposalManager.selectNowDate();
            ...
            ciRider = cepr01040118Business.of_get_coi_ci(kursId, cepr01030101Form.getInsuredAge(), premiTotalSekaligus, premiTotalTahunan, premiTotalSemesteran, premiTotalTriwulanan, premiTotalBulanan);
            termRider = cepr01040118Business.of_get_coi_term(kursId, cepr01030101Form.getInsuredAge(), premiTotalSekaligus, premiTotalTahunan, premiTotalSemesteran, premiTotalTriwulanan, premiTotalBulanan);
            if(jenis != 0){
            	hcpFamilyRider = cepr01040118Business.of_get_coi_hcp_family(jenis, kursId, cepr01030101Form.getInsuredAge(), premiTotalSekaligus, premiTotalTahunan, premiTotalSemesteran, premiTotalTriwulanan, premiTotalBulanan);
...
//            }
	...
	//                    ldec_nt = ( 1 - ldec_sc[0] ) * premium;
	//                }
	//                else if( li_loop > li_tahun && li_loop < 5)
	//                {
	...
	//                }
	                ...
	                ldec_saldo = Math.round(ldec_saldo);
	                if( li_loop == li_years )
            	...
            	//manfaat bulanan
            		...
            		for( double li_loop = 1; li_loop <= li_years; li_loop++ )
    	            {
            			...
            			if(li_years == 48)
            			{
            				//if Mod(li_loop/li_bagi, 0.5) = 0 Then lb_cetak = True Else lb_cetak = False
            				lb_cetak = false;
            				if(li_loop <= 12)
            				{
            					lb_cetak = true;
            ...
            if(cepr01030102Form.getJenisCd() == 0){
            	...
            	params.put( "subTitle", "(Stable Save-Bukan Manfaat Bulanan)" );
            }else if(cepr01030102Form.getJenisCd() == 1){
            	params.put( "jenis", "manfaat bulanan" );
            	params.put( "subTitle", "(Stable Save-Manfaat Bulanan)" );
            }

            jasperViewer.setReportDataKey( "dataSource" );
            params.put( "title", "STABLE SAVE" );
           ...
           try{
	        	   ...
	        	   //if(cekDataApprovedOrNot.get(0).getPosisi()<3){
			            JasperUtils.exportReportToPdf(
			            		"id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040118_product.jasper",
			            		dirName,
			                fileName,
							params,
							temp,

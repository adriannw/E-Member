 ...
 * Function Id         	: 
 * Program Name   		: Cepr01040118Business
 * Description         	:
...
public class Cepr01040118Business extends Cepr01040000UlinkBusiness 
{
    protected final Log logger = LogFactory.getLog( getClass() );

    private Cepr00000000YieldResultVO yieldResultVO;

    public Cepr01040118Business( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command )
    {
        super( eproposalManager, editorUtil, command );
        setSekaligusRightPartCdArr( new Integer[]{ Cepr01040118Mapper.X1 } );
    }
...
//  i got it from of_plan
    public Istr_prop istr_prop(){
    	return istr_prop;
    }

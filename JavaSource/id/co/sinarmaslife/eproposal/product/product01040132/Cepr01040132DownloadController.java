 ...
 * Function Id         	: 
 * Program Name   		: Cepr01040132DownloadController
...
public class Cepr01040132DownloadController extends StandardParent implements Controller
{
	protected final static Log logger = LogFactory.getLog( Cepr01040132DownloadController.class );
	static Integer currentIdx;
	
    public ModelAndView handleRequest( HttpServletRequest request, HttpServletResponse response )
            throws ServletException, IOException
    {
        logger.info( "*-*-*-* Cepr01040132DownloadController.handleRequest" );
        ...
        Cepr01040132Business cepr01040132Business = new Cepr01040132Business( eproposalManager, editorUtil, command );
        ...
        {
        	List<String> messageEkaSehatList = cepr01040132Business.getEkaSehatMsgBox();
        ...
        {
            List<String> messageBoxList = cepr01040132Business.getMedicalMsgBox();
        ...
        else
        {
            ...
            jasperViewer.setUrl( "/WEB-INF/classes/" + "id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040132_product.jasper" );

            String businessIdx;
            if( cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040132Mapper.X19 )
            {
            ...
            //Index Manfaat Asuransi Bukan karena kecelakaan di thn Polis ke
...
//            	cashValueCount =
          ...
          //  params.put( "placeAndDate", "Jakarta, " + FormatDate.toIndonesian( eproposalManager.selectNowDate() ) );
            ...
            ciRider = cepr01040132Business.of_get_coi_ci(kursId, cepr01030101Form.getInsuredAge(), premiTotalSekaligus, premiTotalTahunan, premiTotalSemesteran, premiTotalTriwulanan, premiTotalBulanan);
            termRider = cepr01040132Business.of_get_coi_term(kursId, cepr01030101Form.getInsuredAge(), premiTotalSekaligus, premiTotalTahunan, premiTotalSemesteran, premiTotalTriwulanan, premiTotalBulanan);
            paRider = cepr01040132Business.of_get_coi_pa(kursId, cepr01030101Form.getInsuredAge(), premiTotalSekaligus, premiTotalTahunan, premiTotalSemesteran, premiTotalTriwulanan, premiTotalBulanan);
            hcpRider = cepr01040132Business.of_get_coi_hcp(kursId, cepr01030101Form.getInsuredAge(), premiTotalSekaligus, premiTotalTahunan, premiTotalSemesteran, premiTotalTriwulanan, premiTotalBulanan);
            tpdRider = cepr01040132Business.of_get_coi_tpd(kursId, cepr01030101Form.getInsuredAge(), premiTotalSekaligus, premiTotalTahunan, premiTotalSemesteran, premiTotalTriwulanan, premiTotalBulanan);
            ekaSehatRider = cepr01040132Business.of_get_coi_eka_sehat(kursId, cepr01030101Form.getInsuredAge(), premiTotalSekaligus, premiTotalTahunan, premiTotalSemesteran, premiTotalTriwulanan, premiTotalBulanan);
            ekaSehatIlRider = cepr01040132Business.of_get_coi_eka_sehat_il(kursId, cepr01030101Form.getInsuredAge(), premiTotalSekaligus, premiTotalTahunan, premiTotalSemesteran, premiTotalTriwulanan, premiTotalBulanan);
            ladiesInsRider = cepr01040132Business.of_get_coi_ladies_ins(kursId, cepr01030101Form.getInsuredAge(), premiTotalSekaligus, premiTotalTahunan, premiTotalSemesteran, premiTotalTriwulanan, premiTotalBulanan);
            hcpLadRider = cepr01040132Business.of_get_coi_hcp_lad(kursId, cepr01030101Form.getInsuredAge(), premiTotalSekaligus, premiTotalTahunan, premiTotalSemesteran, premiTotalTriwulanan, premiTotalBulanan);
            ladiesMedRider = cepr01040132Business.of_get_coi_ladies_med(kursId, cepr01030101Form.getInsuredAge(), premiTotalSekaligus, premiTotalTahunan, premiTotalSemesteran, premiTotalTriwulanan, premiTotalBulanan);
            ladiesMedIlRider = cepr01040132Business.of_get_coi_ladies_med_il(kursId, cepr01030101Form.getInsuredAge(), premiTotalSekaligus, premiTotalTahunan, premiTotalSemesteran, premiTotalTriwulanan, premiTotalBulanan);
            hcpProRider = cepr01040132Business.of_get_coi_hcp_pro(kursId, cepr01030101Form.getInsuredAge(), premiTotalSekaligus, premiTotalTahunan, premiTotalSemesteran, premiTotalTriwulanan, premiTotalBulanan);
            if(jenis != 0){
            	source = JrUtil.convertToDsAndSetNullIfEmpty( riderBusiness.getRiderHcpFamilyList() );
                if( source != null ){
	            	hcpFamilyRider = cepr01040132Business.of_get_coi_hcp_family(jenis, kursId, cepr01030101Form.getInsuredAge(), premiTotalSekaligus, premiTotalTahunan, premiTotalSemesteran, premiTotalTriwulanan, premiTotalBulanan);
            ...
            String titleReport = "";
            String title= "";
            if(Cepr01040132Mapper.X19 == rightPartOfBusinessCd) // Holyland Invest SILVER Bethany new
    	    {
            	titleReport = "HOLYLAND Invest SILVER";
            	  title="HOLYLAND INVEST";
    	    }
            
            else if(Cepr01040132Mapper.X20 == rightPartOfBusinessCd)// Holyland Invest GOLD Bethany new
    	    {
            	titleReport = "HOLYLAND Invest GOLD";
            	title="HOLYLAND INVEST";
    	    }
            else if(Cepr01040132Mapper.X21 == rightPartOfBusinessCd)//  Holyland Invest Platinum Bethany new
    	    {
            	titleReport = "HOLYLAND Invest PLATINUM";
            	title="HOLYLAND INVEST";
    	    }
            else if(Cepr01040132Mapper.X28 == rightPartOfBusinessCd)// MULTI INVEST PLATINUM
    	    {
            	titleReport = "SMiLe Multi Invest SILVER";
            	title="SMiLe MULTI INVEST";            	
    	    }
            else if(Cepr01040132Mapper.X29 == rightPartOfBusinessCd)// MULTI INVEST PLATINUM
    	    {
            	titleReport = "SMiLe Multi Invest GOLD";
            	title="SMiLe MULTI INVEST";
    	    }
            else if(Cepr01040132Mapper.X30 == rightPartOfBusinessCd)// MULTI INVEST PLATINUM
    	    {
            	titleReport = "SMiLe Multi Invest PLATINUM";
            	title="SMiLe MULTI INVEST";
    	    }
            ...
            putRiderParam( params, riderBusiness.getRiderCi8List(), "dsRiderCi", "riderCiIndex" );
            ...
            if(currentIdx > 0){ 
            	params.put( "dsCommonHeader2", JasperReportsUtils.convertReportData( cepr01040132Business.getHeaderRowList( command ) ) );
            	params.put( "dsCommonHeaderx", JasperReportsUtils.convertReportData( cepr01040132Business.getHeaderRowList( command ) ) );
            }
            
            params.put( "dataSource", cepr01040132Business.getPageList(currentIdx) );
            ...
            params.put( "dsCommonHeader", JasperReportsUtils.convertReportData( cepr01040132Business.getHeaderRowList( command ) ) );
            ...
            List temp = cepr01040132Business.getPageList(currentIdx);
           ...
           try{
			            JasperUtils.exportReportToPdf(
			            		"id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040132_product.jasper",
			            		dirName,
			                fileName,
							params,
							temp,
    ...
    {
       // logger.info( "*-*-*-* Cepr01040132DownloadController.getManfaatPersonalAccidentParamsMap" );
        logger.info( "*-*-*-* Cepr01040132DownloadController.getManfaatPersonalAccidentParamsMap" );
        Cepr01030000HoldingForm cepr01030000HoldingForm = ( Cepr01030000HoldingForm ) command;
        Cepr01030102Form cepr01030102Form = cepr01030000HoldingForm.getCepr01030102Form();

...
public class Cepr01040150Entry extends Cepr01040000Entry implements Cepr01040000EntryInterface
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040150Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
        super( eproposalManager, editorUtil, command, errors );
        logger.info( "*-*-*-* Cepr01040150Entry constructor is called ..." );
        setDownloadUrl( "wepr01040150.pdf" );
    }
    ...
    public void fillDefaultValueEachTimeRightPartOfBusinessCdChanged()
    {
        ...
        if( Cepr01040150Mapper.X1 == cepr01030102Form.getRightPartOfBusinessCd() || Cepr01040150Mapper.X2 == cepr01030102Form.getRightPartOfBusinessCd() || Cepr01040150Mapper.X3 == cepr01030102Form.getRightPartOfBusinessCd()
        	|| Cepr01040150Mapper.X6 == cepr01030102Form.getRightPartOfBusinessCd() )
        {
         
            payModeArr = new Integer[]{ Hardcode.PAY_MODE_CD_BULANAN};
        }else{
    ...
    {        
      //  cepr01030102Form.setPremium( computePremium( cepr01030102Form.getPaymentModeCd() ) );
        if( "onChangePremium".equals( cepr01030102Form.getTheEvent() )
        	...
        	double up = (50 * 10 * cepr01030102Form.getPremium().doubleValue()) / m;
        	cepr01030102Form.setTotalSumInsured( new BigDecimal( up ) );
       }        
    }

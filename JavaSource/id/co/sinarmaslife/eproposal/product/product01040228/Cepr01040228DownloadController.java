...
public class Cepr01040228DownloadController extends StandardParent implements Controller
{
    ...
    //    AbstractJasperReportsView jasperViewer = null;
        ...
        Cepr01040228Business cepr01040228Business = new Cepr01040228Business( eproposalManager, editorUtil, command );
...
//        }        
        ...
        {
        	List<String> messageEkaSehatList = cepr01040228Business.getEkaSehatMsgBox();
    ...
    {    	
    	  HashMap<String, Object> result = new HashMap<String, Object>();
    	   Cepr01040228Business cepr01040228Business = new Cepr01040228Business( eproposalManager, editorUtil, cepr01030000HoldingForm );
        ...
        // params.put( "title", "RENCANA CERDAS" );
         ...
         params.put( "title", "JEMPOL LINK");
         if( cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040228Mapper.X1 ){
           	params.put( "title", "SMiLe LINK PLUS");
         }else if( cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040228Mapper.X3 ){
           	params.put( "title", "SMiLe LINK PRO");
         }else if( cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040228Mapper.X4 ){
            	params.put( "title", "B SMiLe PROTECTION");
          }
      ...
      //   jasperViewer.setJdbcDataSource( eproposalManager.getDataSource() );
         ...
         IllustrationResultVO illustrationResultVO = cepr01040228Business.getIllustrationResult();
         ...
         IllustrationResultVO resultVO3 = cepr01040228Business.getIllustrationResult(); // perhitungan polis
         params.put( "resultVO3", JasperReportsUtils.convertReportData( resultVO3.getIllustrationList() ) );
         
         IllustrationResultVO resultVO4 = cepr01040228Business.getIllustrationResult2(); // perhitungan polis
         params.put( "resultVO4", JasperReportsUtils.convertReportData( resultVO4.getIllustrationList() ) );
         
         //
         IllustrationResultVO illustrationResultVO2 = cepr01040228Business.getIllustrationResult2(); // perhitungan polis
         ...
         params.put( "dsInvestmentYield2", JasperReportsUtils.convertReportData( cepr01040228Business.getInvestmentYield().getYieldList() ) );           
         params.put( "dsCommonHeaderSmall2", JasperReportsUtils.convertReportData( cepr01040228Business.getCommonHeaderSmallRowList() ) );
         params.put( "dsInvestmentChoiceSmall2", JasperReportsUtils.convertReportData( cepr01040228Business.getInvestmentChoiceSmallRowList() ) );          
         ...
         params.put( "dsCommonHeaderSmall3", JasperReportsUtils.convertReportData( cepr01040228Business.getCommonHeaderSmallRowList() ) );
         params.put( "dsInvestmentChoiceSmall3", JasperReportsUtils.convertReportData( cepr01040228Business.getInvestmentChoiceSmallRowList() ) );      
         params.put( "dsInvestmentYield3", JasperReportsUtils.convertReportData( cepr01040228Business.getInvestmentYield().getYieldList() ) );
         
         params.put( "dsCommonHeaderSmall4", JasperReportsUtils.convertReportData( cepr01040228Business.getCommonHeaderSmallRowList() ) );
         params.put( "dsInvestmentChoiceSmall4", JasperReportsUtils.convertReportData( cepr01040228Business.getInvestmentChoiceSmallRowList() ) );      
         params.put( "dsInvestmentYield4", JasperReportsUtils.convertReportData( cepr01040228Business.getInvestmentYield().getYieldList() ) );
         
         logger.info( "*-*-*-* cepr01040216Business.getInvestmentYield() = " + cepr01040228Business.getInvestmentYield() );
         params.put( "totalInvestmentAllocation", cepr01040228Business.getInvestmentYield().getTotalInvestmentAllocation() );
         params.put( "totalAssumptionLow", cepr01040228Business.getInvestmentYield().getTotalAssumptionLow() );
         params.put( "totalAssumptionMid", cepr01040228Business.getInvestmentYield().getTotalAssumptionMid() );
         params.put( "totalAssumptionHi", cepr01040228Business.getInvestmentYield().getTotalAssumptionHi() );

         params.put( "dsCommonHeader", JasperReportsUtils.convertReportData( cepr01040228Business.getCommonHeaderRowList() ) );
         params.put( "dsCommonHeaderSmall", JasperReportsUtils.convertReportData( cepr01040228Business.getCommonHeaderSmallRowList() ) );
         params.put( "dsCommonHeaderSmall2", JasperReportsUtils.convertReportData( cepr01040228Business.getCommonHeaderSmallRowList() ) );
         
         if( cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040228Mapper.X4 || cepr01030102Form.getRightPartOfBusinessCd() <= Cepr01040228Mapper.X2 ){
        	 params.put( "dsInvestmentChoice", JasperReportsUtils.convertReportData( cepr01040228Business.getInvestmentChoiceRowList2() ) );
         }else{
        	 params.put( "dsInvestmentChoice", JasperReportsUtils.convertReportData( cepr01040228Business.getInvestmentChoiceRowList() ) );
         }
         params.put( "dsInvestmentChoiceSmall", JasperReportsUtils.convertReportData( cepr01040228Business.getInvestmentChoiceSmallRowList() ) );
         params.put( "dsMonthlyPremium", JasperReportsUtils.convertReportData( cepr01040228Business.getMonthlyPremiumList( cepr01030102Form ) ) );
         params.put( "dsInvestmentPerformance", JasperReportsUtils.convertReportData( cepr01040228Business.getInvestmentPerformanceList() ) );
         params.put( "dsInvestmentYield", JasperReportsUtils.convertReportData( cepr01040228Business.of_get_rate_ds().getYieldList() ) );
         params.put( "dsOneRow", JasperReportsUtils.convertReportData( cepr01040228Business.getOneRowList() ) );
         params.put( "dsNoteSekaligus", JasperReportsUtils.convertReportData( cepr01040228Business.getNoteSekaligusRowList() ) );
         params.put( "dsNoteBerkala", JasperReportsUtils.convertReportData( cepr01040228Business.getNoteBerkalaRowList() ) );
...
//ekasehat masa tunggu
		//medical extra
         ...
         params.put( "dataSource", cepr01040228Business.getPageList( currentIdx ) );
         params.put( "titleHcp", titleHcp );
         params.put( "titleCi", titleCi );
         
         params.put( "dsEkalinkRider", JasperReportsUtils.convertReportData( cepr01040228Business.getRiderPremiumList(cepr01030102Form, cepr01030101Form.getInsuredAge()) ) );
         params.put( "dsEkalinkRider2", JasperReportsUtils.convertReportData( cepr01040228Business.getRiderPremiumList(cepr01030102Form, cepr01030101Form.getInsuredAge()) ) );
         ...
         params.put( "dsCommonHeaderRincian", JasperReportsUtils.convertReportData( cepr01040228Business.getCommonHeaderRincianRowList()) );
         double ldec_coi = cepr01040228Business.of_get_coi_basic_220( 1 );
         BigDecimal biayaAsuransiPokok =  new BigDecimal(ldec_coi);
         params.put( "dsCommonBiayaRincian", JasperReportsUtils.convertReportData( cepr01040228Business.getCommonBiayaRincianRowList( biayaAsuransiPokok ) ) );
         
         params.put("pageRider", cepr01040228Business.getPageRider( currentIdx ));
         params.put( "dsCommonHeaderRincianRiderPa", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040228Business.getCommonHeaderRincianSmallRowList(1) ) );
         params.put( "dsCommonBiayaRincianRiderPa", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040228Business.getCommonBiayaRincianRider(1) ) );
         params.put( "dsCommonHeaderRincianRiderTpd", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040228Business.getCommonHeaderRincianSmallRowList(3) ) );
         params.put( "dsCommonBiayaRincianRiderTpd", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040228Business.getCommonBiayaRincianRider(3) ) ); 
         params.put( "dsCommonHeaderRincianRiderCi", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040228Business.getCommonHeaderRincianSmallRowList(4) ) );
         params.put( "dsCommonBiayaRincianRiderCi", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040228Business.getCommonBiayaRincianRider(4) ) ); 
         params.put( "dsCommonHeaderRincianRiderHCPFamily", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040228Business.getCommonHeaderRincianSmallRowList(11) ) );
         params.put( "dsCommonBiayaRincianRiderHCPFamily", JasperReportsUtils.convertReportData( cepr01040228Business.getCommonBiayaRincianRider(11) ) );
         ...
         params.put( "dsCommonHeaderRincianRiderHCP", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040228Business.getCommonHeaderRincianSmallRowList(2) ) );
         params.put( "dsCommonBiayaRincianRiderHCP", JasperReportsUtils.convertReportData( cepr01040228Business.getCommonBiayaRincianRider(2) ) );
         params.put( "dsRincianRiderHCP", JrUtil.convertToDsAndSetNullIfEmpty( riderBusiness.getRiderHcpList() ));    
         
         params.put( "dsCommonHeaderRincianRiderHCPProvider", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040228Business.getCommonHeaderRincianSmallRowList(16) ) );
         params.put( "dsCommonBiayaRincianRiderHCPProvider", JasperReportsUtils.convertReportData( cepr01040228Business.getCommonBiayaRincianRider(16) ) );
         params.put( "dsRincianRiderHCPProvider", JrUtil.convertToDsAndSetNullIfEmpty( riderBusiness.getRiderHcpProviderList()));    
         
         params.put( "dsCommonHeaderRincianRiderTerm", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040228Business.getCommonHeaderRincianSmallRowList(12) ) );
         params.put( "dsCommonBiayaRincianRiderTerm", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040228Business.getCommonBiayaRincianRider(12) ) ); 
         params.put( "dsCommonHeaderRincianRiderEkaSehat", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040228Business.getCommonHeaderRincianSmallRowList(13) ) );
         params.put( "dsCommonBiayaRincianRiderEkaSehat", JasperReportsUtils.convertReportData( cepr01040228Business.getCommonBiayaRincianRider(13) ) );     
         ...
         params.put( "dsCommonHeaderRincianRiderEkaSehatInnerLimit", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040228Business.getCommonHeaderRincianSmallRowList(15) ) );
         params.put( "dsCommonBiayaRincianRiderEkaSehatInnerLimit", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040228Business.getCommonBiayaRincianRider(15) ) );     
         ...
         params.put( "dsCommonHeaderRincianRiderWaiverTpdCi", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040228Business.getCommonHeaderRincianSmallRowList(17) ) );
         params.put( "dsCommonBiayaRincianRiderWaiverTpdCi", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040228Business.getCommonBiayaRincianRider(17) ) );
         params.put( "dsCommonHeaderRincianRiderPayorTpdCiDeath", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040228Business.getCommonHeaderRincianSmallRowList(18) ) );
         params.put( "dsCommonBiayaRincianRiderPayorTpdCiDeath", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040228Business.getCommonBiayaRincianRider(18) ) );
         
         params.put( "dsCommonHeaderRincianRiderLadiesIns", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040228Business.getCommonHeaderRincianSmallRowList(19) ) );
         params.put( "dsCommonBiayaRincianRiderLadiesIns", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040228Business.getCommonBiayaRincianRider(19) ) ); 
         params.put( "dsCommonHeaderRincianRiderHCPLadies", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040228Business.getCommonHeaderRincianSmallRowList(20) ) );
         params.put( "dsCommonBiayaRincianRiderHCPLadies", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040228Business.getCommonBiayaRincianRider(20) ) );
         params.put( "dsRincianRiderHcpLadies", JrUtil.convertToDsAndSetNullIfEmpty( riderBusiness.getRiderHcpLadiesList()));
         params.put( "dsCommonHeaderRincianRiderLadiesMedExpense", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040228Business.getCommonHeaderRincianSmallRowList(21) ) );
         params.put( "dsCommonBiayaRincianRiderLadiesMedExpense", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040228Business.getCommonBiayaRincianRider(21) ) );     
         ...
         params.put( "dsCommonHeaderRincianRiderLadiesMedExpenseInnerLimit", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040228Business.getCommonHeaderRincianSmallRowList(22) ) );
         params.put( "dsCommonBiayaRincianRiderLadiesMedExpenseInnerLimit", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040228Business.getCommonBiayaRincianRider( 22) ) );     
         ...
         params.put( "dsCommonHeaderRincianRiderPayor5Tpd10CiDeath", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040228Business.getCommonHeaderRincianSmallRowList(23) ) );
         params.put( "dsCommonBiayaRincianRiderPayor5Tpd10CiDeath", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040228Business.getCommonBiayaRincianRider(23) ) );
         params.put( "dsCommonHeaderRincianRiderWaiver5Tpd10Ci", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040228Business.getCommonHeaderRincianSmallRowList(24) ) );
         params.put( "dsCommonBiayaRincianRiderWaiver5Tpd10Ci", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040228Business.getCommonBiayaRincianRider(24) ) );
         params.put( "dsCommonHeaderRincianRiderScholar", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040228Business.getCommonHeaderRincianSmallRowList(25) ) );
         params.put( "dsCommonBiayaRincianRiderScholar", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040228Business.getCommonBiayaRincianRider(25) ) ); 
         params.put( "dsCommonHeaderRincianRiderEarlyStageCi99", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040228Business.getCommonHeaderRincianSmallRowList(27) ) );
         params.put( "dsCommonBiayaRincianRiderEarlyStageCi99", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040228Business.getCommonBiayaRincianRider(27) ) );            
         params.put( "dsCommonHeaderRincianRiderMedicalPlus", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040228Business.getCommonHeaderRincianSmallRowList(28) ) );
         params.put( "dsCommonBiayaRincianRiderMedicalPlus", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040228Business.getCommonBiayaRincianRider(28) ) );  
         ...
         params.put( "dsCommonHeaderRincianRiderEkaSehatExtra", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040228Business.getCommonHeaderRincianSmallRowList(29) ) );
         params.put( "dsCommonBiayaRincianRiderEkaSehatExtra", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040228Business.getCommonBiayaRincianRider(29) ) );     
...
//         params.put( "tipeEkaSehat", cepr01040228Business.checkTipeEkaSehat(29) );
         
         params.put("jenis", cepr01030102Form.getRightPartOfBusinessCd()+"");
         params.put( "dsOneRow2", JasperReportsUtils.convertReportData( cepr01040228Business.getOneRowList() ) );
         params.put( "dsOneRow22", JasperReportsUtils.convertReportData( cepr01040228Business.getOneRowList() ) );
       ...
       //  String fileName="testx.pdf";
         ...
         List temp = cepr01040228Business.getPageList( currentIdx );
         ...
         try{      
	        	   //if(cekDataApprovedOrNot.get(0).getPosisi()<3){
			            JasperUtils.exportReportToPdf(
			            		"id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040228_product.jasper",
			            		dirName,
			                fileName,
							params,
							temp,

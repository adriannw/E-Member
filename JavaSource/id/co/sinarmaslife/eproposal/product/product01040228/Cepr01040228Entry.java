...
public class Cepr01040228Entry extends Cepr01040000UlinkEntry implements Cepr01040000EntryInterface
{
    protected final Log logger = LogFactory.getLog( getClass() );
    private static final int ASSURANCE_TERM = 100;

    public Cepr01040228Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
        super( eproposalManager, editorUtil, command, errors );
        logger.info( "*-*-*-* Cepr01040228Entry constructor is called ..." );
        setDownloadUrl( "wepr01040228.pdf" );
    }
...
//        restore investment choice
    ...
    public void fillDefaultValueEachTimeFormCalled()
    {
        ...
        if( Hardcode.CUR_IDR_CD.equals( cepr01030102Form.getCurrencyCd() ) )
        {
            ...
            } else if( cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040208Mapper.X4 || cepr01030102Form.getRightPartOfBusinessCd() <= Cepr01040208Mapper.X2){
	            cepr01030102Form.setLjiFixListDisplay( CommonConst.DISPLAY_TRUE );

...
public class Cepr01040104Business extends Cepr01040000ProductBusiness
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040104Business( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command )
    {
    ...
    private double of_get_rate_for_pk( List < Mst_proposal > mstProposal )
    {
        logger.info( "*-*-*-* Cepr01040104Business.of_get_rate_for_pk" );
        double result;
        Cepr01030101Form cepr012030101Form = ( ( Cepr01030000HoldingForm ) command ).getCepr01030101Form();
        Cepr01030102Form cepr01030102Form =
        		( ( Cepr01030000HoldingForm ) command ).getCepr01030102Form();
        Map<String, Object> sqlParams = new HashMap<String, Object>();
        int bisnisNo = 1;
        if( cepr01030102Form.getLeftPartOfBusinessCd() == Hardcode.PRODUK_DANA_SEJAHTERA ){
	        if( cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X6 || cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X11
	        		|| cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X16 || cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X21 ){
	        	bisnisNo = 2;
	        }else if( cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X7 || cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X12
	        		|| cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X17 || cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X22 ){
	        	bisnisNo = 3;
	        }else if( cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X8 || cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X13
	        		|| cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X18 || cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X23 ){
	        	bisnisNo = 4;
	        }else{
	        	bisnisNo = 5;
	        }
            ...
            {
            	bisnisNo = cepr01030102Form.getRightPartOfBusinessCd() - 4;                	
            }
            else
            {
            	bisnisNo = cepr01030102Form.getRightPartOfBusinessCd() + 1;
            }
        }

        sqlParams.put( "businessNo", bisnisNo );	
        sqlParams.put( "currencyCd", cepr01030102Form.getCurrencyCd() );
        sqlParams.put( "insuredAge", cepr01030101Form.getInsuredAge() );
        BigDecimal rate = eproposalManager.selectPkRateForDanaSejahtera( sqlParams );
        result = LazyConverter.toDouble( rate );
        mstProposal.add( new Mst_proposal( cepr01030102Form.getCurrencyCd(), new BigDecimal( Hardcode.MANFAAT_PENYAKIT_KRITIS ), new BigDecimal( bisnisNo ),
   			 BigDecimal.ZERO, BigDecimal.ZERO, rate, new BigDecimal(cepr01030102Form.getTermOfContract()), 
   			 new BigDecimal( cepr01030102Form.getPaymentModeCd() ),  cepr01030101Form.getInsuredBirthDay(), cepr01030101Form.getInsuredAge() ) );

...
public class Cepr01040104DownloadController extends StandardParent implements Controller
{
	protected final static Log logger = LogFactory.getLog( Cepr01040104DownloadController.class );
            ...
            throws ServletException, IOException
    {
        ...
        Cepr01040104Business cepr01040104Business = new Cepr01040104Business( eproposalManager, editorUtil, command );
        currentIdx = 0;
        ModelAndView result;
        ...
        else
        {
            ...
            String businessIdx;
            if( cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X1 || cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X6
            		|| cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X11 || cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X16 
            		|| cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X21 )
        		{ businessIdx = "5"; sekaligusOrTahunan = "tahunan"; }
            else if( cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X2 || cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X7
            		|| cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X12 || cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X17
            		|| cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X22 )
        		{ businessIdx = "10"; sekaligusOrTahunan = "tahunan"; }
            else if( cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X3 || cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X8
            		|| cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X13 || cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X18
            		|| cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X23 )
    			{ businessIdx = "15"; sekaligusOrTahunan = "tahunan"; }
            else if( cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X4 || cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X9 
            		|| cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X14 || cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X19
            		|| cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X24 )
            	{ businessIdx = "20";  sekaligusOrTahunan = "tahunan"; }
            else if( cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X5 || cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X10 ||
            		cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X15 || cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X20 ||
            		cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X25 )
...
//        	{ sekaligusOrTahunan = "sekaligus"; }
            ...
            String point3 = null;
            String point4 = null;
            if( cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X6  ||
            		cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X7 ||
            		cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X8 ||
            		cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X9 ||
            		cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X10 )
            {
            	
            	point1 = "Premi dibayar selama "+businessIdx+" tahun, dan setelah itu polis menjadi bebas premi dan pertanggungan tetap berjalan.";
            	if( cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040104Mapper.X10 ){
            		point1 = "Premi dibayar secara sekaligus di awal pertanggungan.";
            	}
            	point2 = "Apabila Tertanggung meninggal dunia dalam masa asuransi, kepada Ahli Waris akan dibayarkan 100% Uang Pertanggungan dan setelah itu kontrak asuransi berakhir. Tetapi bila Tertanggung hidup pada akhir tahun polis dimana Tertanggung berusia 79 tahun maka akan dibayarkan 100% Uang Pertanggungan dan setelah itu kontrak asuransi berakhir.";
            	point3 = null;
            	point4 = null;
            }
            else
            ...
            if( (cepr01030102Form.getRightPartOfBusinessCd() >= Cepr01040104Mapper.X11 && cepr01030102Form.getRightPartOfBusinessCd() <= Cepr01040104Mapper.X15) ||
            	(cepr01030102Form.getRightPartOfBusinessCd() >= Cepr01040104Mapper.X21 && cepr01030102Form.getRightPartOfBusinessCd() <= Cepr01040104Mapper.X25)) {
...
//            params.put( "placeAndDate", "Jakarta, " + FormatDate.toIndonesian( eproposalManager.selectNowDate() ) );
            ...
            if( cepr01030102Form.getPaymentModeCd() != null && cepr01030102Form.getPaymentModeCd() != Hardcode.PAY_MODE_CD_SEKALIGUS ){
	            if( cepr01030102Form.getPersonalAccidentFlagDisplay() != null && cepr01030102Form.getPersonalAccidentFlagDisplay().equals( CommonConst.DISPLAY_TRUE ) && CommonConst.CHECKED_TRUE.equals( cepr01030102Form.getPersonalAccidentFlag() ) && CommonConst.DISPLAY_TRUE.equals( cepr01030102Form.getPersonalAccidentFlagDisplay() ) )
	            {
	                ...
	                manfaatPersonalAccidentAmount = cepr01040104Business.computeManfaatNew( cepr01030102Form.getPaymentModeCd(), Hardcode.MANFAAT_PERSONAL_ACCIDENT, mstProposal );
	            ...
	            if( cepr01030102Form.getCriticalIllnessFlagDisplay() != null && cepr01030102Form.getCriticalIllnessFlagDisplay().equals( CommonConst.DISPLAY_TRUE ) && CommonConst.CHECKED_TRUE.equals( cepr01030102Form.getCriticalIllnessFlag() ) && CommonConst.DISPLAY_TRUE.equals( cepr01030102Form.getCriticalIllnessFlagDisplay() ) )
	            {
	            	// save mstproposal
	                additionalAssuranceExist = true;
	                manfaatPenyakitKritisAmount = cepr01040104Business.computeManfaatPk( cepr01030102Form.getPaymentModeCd(), Hardcode.MANFAAT_PENYAKIT_KRITIS, mstProposal );
	            ...
	            if( cepr01030102Form.getPayorsClauseFlagDisplay() != null && cepr01030102Form.getPayorsClauseFlagDisplay().equals( CommonConst.DISPLAY_TRUE ) &&  CommonConst.CHECKED_TRUE.equals( cepr01030102Form.getPayorsClauseFlag() ) && CommonConst.DISPLAY_TRUE.equals( cepr01030102Form.getPayorsClauseFlagDisplay() ) )
	            {
	            	// save mstproposal
	                additionalAssuranceExist = true;
	                manfaatPayorsClauseAmount = cepr01040104Business.computeManfaatNew( cepr01030102Form.getPaymentModeCd(), Hardcode.MANFAAT_PAYORS_CLAUSE, mstProposal );
	...
	//                Double theRate = cepr01040104Business.of_get_rate( cepr01030102Form.getPaymentModeCd(), Hardcode.MANFAAT_WAIVER_PREMIUM_DISABILITY );
	            ...
	            if( cepr01030102Form.getTpdFlagDisplay() != null && cepr01030102Form.getTpdFlagDisplay().equals( CommonConst.DISPLAY_TRUE ) && CommonConst.CHECKED_TRUE.equals( cepr01030102Form.getTpdFlag() ) && CommonConst.DISPLAY_TRUE.equals( cepr01030102Form.getTpdFlagDisplay() ) )
	            {
	            	// save mstproposal
	                additionalAssuranceExist = true;
	                manfaatTpdAmount = cepr01040104Business.computeManfaatTpd( cepr01030102Form.getPaymentModeCd(), Hardcode.MANFAAT_TPD, mstProposal );
            ...
            params.put( "dsCommonHeader", JasperReportsUtils.convertReportData( cepr01040104Business.getHeaderRowList( command, "title" ) ) );
            params.put( "dsAboveDetail", JasperReportsUtils.convertReportData( cepr01040104Business.getHeaderRowList( command, "aboveDetail" ) ) );
            ...
            String productLabel = "DANA SEJAHTERA";

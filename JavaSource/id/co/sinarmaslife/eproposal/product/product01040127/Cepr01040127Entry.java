 ...
 * Function Id         	: 01040127
 * Program Name   		: Cepr01040127Entry
...
public class Cepr01040127Entry extends Cepr01040000Entry implements Cepr01040000EntryInterface

{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040127Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
        super( eproposalManager, editorUtil, command, errors );
        logger.info( "*-*-*-* Cepr01040127Entry constructor is called ..." );
        setDownloadUrl( "wepr01040127.pdf" );
    }

    public void initDisplayedForm()
    {
        logger.info( "*-*-*-* Cepr01040127Entry.initDisplayedForm" );
        displayStandardForm();
    ...
    {
        logger.info( "*-*-*-* Cepr01040127Entry.initDisabledForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040127Entry.initReadOnlyForm" );
        readOnlyAllForm( false );
    }

    public void fillDefaultValueEachTimeRightPartOfBusinessCdChanged()
    {
        logger.info( "*-*-*-* Cepr01040127Entry.fillDefaultValueEachTimeRightPartOfBusinessCdChanged" );
    }

    public void fillDefaultValueEachTimeFormCalled()
    {
        logger.info( "*-*-*-* Cepr01040127Entry.fillDefaultValueEachTimeFormCalled" );

        cepr01030102Form.setTermOfContract( 8 );
    ...
    {
        logger.info( "*-*-*-* Cepr01040127Entry.validateCurrentPage" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040127Entry.validatePreviousPage" );
        commonValidator.validateInsuredAge( Cepr01030102FormConst.ASSURANCE_PLAN_CD, 1, 57 );
    }

    public void processFormAfterSubmitBeforeValidation()
    {
        logger.info( "*-*-*-* Cepr01040127Entry.processFormAfterSubmitBeforeValidation" );

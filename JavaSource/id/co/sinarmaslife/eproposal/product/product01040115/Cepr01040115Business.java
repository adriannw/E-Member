...
public class Cepr01040115Business extends Cepr01040000ProductBusiness
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040115Business( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command )
    {
    ...
    public List< Map<String, Object> > getHeaderRowList( Object command ) throws IOException
    {
        ...
        result.addAll( source.getChildNameMap() );
        result.addAll( source.getChildAgeMap() );
        result.addAll( source.getParentNameMap() );
        result.addAll( source.getParentAgeMap() );
        ...
        result.addAll( source.getChildMedicalCheckUpMap( ( String ) of_cek_medis( command ).get( "medis_tt" ) ) );
    ...
    {
        logger.info( "*-*-*-* Cepr01040115Business.getDetailList" );

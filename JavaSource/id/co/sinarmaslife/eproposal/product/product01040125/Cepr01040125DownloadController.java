 ...
 * Function Id         	:
 * Program Name   		: Cepr01040125DownloadController
...
public class Cepr01040125DownloadController extends StandardParent implements Controller
{
    public ModelAndView handleRequest( HttpServletRequest request, HttpServletResponse response )
            throws ServletException, IOException
    {
        logger.info( "*-*-*-* Cepr01040125DownloadController.handleRequest" );
        ...
        else
        {
            ...
            jasperViewer.setUrl( "/WEB-INF/classes/" + "id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040125_product.jasper" );
           // BigDecimal tempBunga = new BigDecimal("0.085");
            ...
            {
            	ratekedua = new BigDecimal( "1.05" );
            	rateKetiga = (new BigDecimal( "1" ).add(new BigDecimal( "0.085002" ))).pow(3);
            	rateKeempat = (new BigDecimal( "1" ).add(new BigDecimal( "0.08503" ))).multiply(rateKetiga);
            ...
            for( int i = 1; i <= 4; i++ )
            {
                ...
                double cashValue = FormatNumber.round(LazyConverter.toDouble(rate[ i - 1 ].multiply( cepr01030102Form.getTotalSumInsured() )), -3);
                ...
                {
                	double leftNonAccidentBenefit =  FormatNumber.round( LazyConverter.toDouble( (cepr01030102Form.getTotalSumInsured().multiply(nonAccidentBenefitSimponi[i - 1]))), -3 );
                ...
                {
                	double leftNonAccidentBenefit = FormatNumber.round( LazyConverter.toDouble( (cepr01030102Form.getTotalSumInsured().multiply(nonAccidentBenefitSecured[i - 1]))), -3);
                	map.put( "nonAccidentBenefit", editorUtil.convertToString( Math.max( leftNonAccidentBenefit, cashValue ) ) );
            ...
            if(cepr01030102Form.getRightPartOfBusinessCd() == 1) // simponi rupiah
            {
            	...
            	judul = "SIMPONI RUPIAH";
            	butirKeduaAyatSatu = "- 100 % Uang Pertanggungan(maksimum satu milyar rupiah, untuk semua Polis yang diterbitkan Penanggung);";
            ...
            else if(cepr01030102Form.getRightPartOfBusinessCd() == 2) // secured invest rupiah
            {
            	...
            	judul = "SECURED INVEST DELUVE RUPIAH";
            	butirKeduaAyatSatu = "- 100% Uang Pertanggungan (maksimum satu milyar rupiah), ditambah";
    ...
    {
        logger.info( "*-*-*-* Cepr01040125DownloadController.getCommonHeaderRowList" );

 ...
 * Function Id         	: 
 * Program Name   		: Cepr01040117DownloadController
 * Description         	:
...
public class Cepr01040117DownloadController extends StandardParent implements Controller
{
    ...
    {
        logger.info( "*-*-*-* Cepr01040117DownloadController.handleRequest" );
        ...
        Cepr01040117Business cepr01040117Business = new Cepr01040117Business( eproposalManager, editorUtil, command );

        ModelAndView result;
        if( request.getSession().getAttribute( "messageEkaSehatList" ) == null )
        {
        	List<String> messageEkaSehatList = cepr01040117Business.getEkaSehatMsgBox();
        ...
        {
            List<String> messageBoxList = cepr01040117Business.getMedicalMsgBox();
        ...
        else
        {
            ...
            jasperViewer.setUrl( "/WEB-INF/classes/" + "id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040117_product.jasper" );
            jasperViewer.setReportDataKey( "dataSource" );

            params.put( "lastYearNo", editorUtil.convertToString(cepr01030101Form.getInsuredAge() ) );
            
            //TITLE
            if(cepr01030102Form.getRightPartOfBusinessCd() == 8 || cepr01030102Form.getRightPartOfBusinessCd() == 4){
            	params.put( "title", "SMiLe MAXI INVEST US DOLLAR" );
            }else if(cepr01030102Form.getRightPartOfBusinessCd() == 9){
            	params.put( "title", "SMiLe MAXI DEPOSIT US DOLLAR" );
            }
            
            params.put( "dataSource", cepr01040117Business.getDetailList() );
          ...
          //  params.put( "placeAndDate", "Jakarta, " + FormatDate.toIndonesian( eproposalManager.selectNowDate() ) );
            ...
            params.put( "dsCommonHeader", JasperReportsUtils.convertReportData( cepr01040117Business.getHeaderRowList( command ) ) );
          ...
          //  String fileName="testx.pdf";
            ...
            List temp = cepr01040117Business.getDetailList();
           ...
           try{
	        	   ...
	        	   //if(cekDataApprovedOrNot.get(0).getPosisi()<3){
			            JasperUtils.exportReportToPdf(
			            		"id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040117_product.jasper",
			            		dirName,
			                fileName,
							params,
							temp,

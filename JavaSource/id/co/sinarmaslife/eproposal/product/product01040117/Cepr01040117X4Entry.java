...
public class Cepr01040117X4Entry extends Cepr01040000Entry implements Cepr01040000EntryInterface
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040117X4Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
        super( eproposalManager, editorUtil, command, errors );
        logger.info( "*-*-*-* Cepr01040117X4Entry constructor is called ..." );
        setDownloadUrl( "wepr01040117.pdf" );
    }

    public void initDisplayedForm()
    {
        logger.info( "*-*-*-* Cepr01040117X4Entry.initDisplayedForm" );
        displayStandardForm();
    ...
    {
        logger.info( "*-*-*-* Cepr01040117X4Entry.initDisabledForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040117X4Entry.initReadOnlyForm" );
        readOnlyAllForm( false );
    }

    public void fillDefaultValueEachTimeRightPartOfBusinessCdChanged()
    {
        logger.info( "*-*-*-* Cepr01040117X4Entry.fillDefaultValueEachTimeRightPartOfBusinessCdChanged" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040117X4Entry.fillDefaultValueEachTimeFormCalled" );
    }

    public void validateCurrentPage()
    {
        logger.info( "*-*-*-* Cepr01040117X4Entry.validateCurrentPage" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040117X4Entry.validatePreviousPage" );
        commonValidator.validateInsuredAge( Cepr01030102FormConst.ASSURANCE_PLAN_CD, 1, 60 );
    }

    public void processFormAfterSubmitBeforeValidation()
    {
        logger.info( "*-*-*-* Cepr01040117X4Entry.processFormAfterSubmitBeforeValidation" );

 ...
 * Function Id         	: 
 * Program Name   		: Cepr01040117X2Entry
 * Description         	:
...
public class Cepr01040117X2Entry extends Cepr01040000Entry implements Cepr01040000EntryInterface
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040117X2Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
        super( eproposalManager, editorUtil, command, errors );
        logger.info( "*-*-*-* Cepr01040117X2Entry constructor is called ..." );
        setDownloadUrl( "wepr01040117.pdf" );
    }

    public void initDisplayedForm()
    {
        logger.info( "*-*-*-* Cepr01040117X2Entry.initDisplayedForm" );
        displayStandardForm();
    ...
    {
        logger.info( "*-*-*-* Cepr01040117X2Entry.initDisabledForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040117X2Entry.initReadOnlyForm" );
        readOnlyAllForm( false );
    }

    public void fillDefaultValueEachTimeRightPartOfBusinessCdChanged()
    {
        logger.info( "*-*-*-* Cepr01040117X2Entry.fillDefaultValueEachTimeRightPartOfBusinessCdChanged" );
        ...
        String[] currencyCdArr = new String[]{ Hardcode.CUR_USD_CD };
        ...
        List<OptionVO> premiumList = Cepr00000000Generator.genMoneyList( editorUtil, 1000, 10000, 1000 );
        cepr01030102Form.setPremiumList( premiumList );
    }

    public void fillDefaultValueEachTimeFormCalled()
    {
        logger.info( "*-*-*-* Cepr01040117X2Entry.fillDefaultValueEachTimeFormCalled" );
    }

    public void validateCurrentPage()
    {
        logger.info( "*-*-*-* Cepr01040117X2Entry.validateCurrentPage" );

        double premium = LazyConverter.toDouble( cepr01030102Form.getPremium() );
        double minPremiumUsd = 1000;
        //double maxPremiumUsd = 10000;

        if( cepr01030102Form.getPremium() != null )
        {
            commonValidator.validateMinimumMoney( Cepr01030102FormConst.PREMIUM, premium, minPremiumUsd, -1 );
            //commonValidator.validateMaximumMoney( Cepr01030102FormConst.PREMIUM, premium, minPremiumUsd, -1 );
        }
        else
        {
    ...
    {
        logger.info( "*-*-*-* Cepr01040117X2Entry.validatePreviousPage" );
        commonValidator.validateInsuredAge( Cepr01030102FormConst.ASSURANCE_PLAN_CD, 1, 60 );
    }

    public void processFormAfterSubmitBeforeValidation()
    {
        logger.info( "*-*-*-* Cepr01040117X2Entry.processFormAfterSubmitBeforeValidation" );

 ...
 * Function Id         	: 
 * Program Name   		: Cepr01040117X3Entry
 * Description         	:
...
public class Cepr01040117X3Entry extends Cepr01040000Entry implements Cepr01040000EntryInterface
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040117X3Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
        super( eproposalManager, editorUtil, command, errors );
        logger.info( "*-*-*-* Cepr01040117X3Entry constructor is called ..." );
        setDownloadUrl( "wepr01040117.pdf" );
    }

    public void initDisplayedForm()
    {
        logger.info( "*-*-*-* Cepr01040117X3Entry.initDisplayedForm" );
        displayStandardForm();
    ...
    {
        logger.info( "*-*-*-* Cepr01040117X3Entry.initDisabledForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040117X3Entry.initReadOnlyForm" );
        readOnlyAllForm( false );
    }

    public void fillDefaultValueEachTimeRightPartOfBusinessCdChanged()
    {
        logger.info( "*-*-*-* Cepr01040117X3Entry.fillDefaultValueEachTimeRightPartOfBusinessCdChanged" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040117X3Entry.fillDefaultValueEachTimeFormCalled" );
    }

    public void validateCurrentPage()
    {
        logger.info( "*-*-*-* Cepr01040117X3Entry.validateCurrentPage" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040117X3Entry.validatePreviousPage" );
        commonValidator.validateInsuredAge( Cepr01030102FormConst.ASSURANCE_PLAN_CD, 1, 60 );
    }

    public void processFormAfterSubmitBeforeValidation()
    {
        logger.info( "*-*-*-* Cepr01040117X3Entry.processFormAfterSubmitBeforeValidation" );

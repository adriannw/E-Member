...
public class Cepr01040227Entry extends Cepr01040000UlinkEntry implements Cepr01040000EntryInterface
{
    protected final Log logger = LogFactory.getLog( getClass() );
    private static final int ASSURANCE_TERM = 100;

    public Cepr01040227Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
        super( eproposalManager, editorUtil, command, errors );
        logger.info( "*-*-*-* Cepr01040221Entry constructor is called ..." );
        setDownloadUrl( "wepr01040227.pdf" );
    }
...
//        restore investment choice
    ...
    public void fillDefaultValueEachTimeFormCalled()
    {
        ...
        cepr01030102Form.setPremiumCombinationList( getPremiumCombinationList( 5 ) );

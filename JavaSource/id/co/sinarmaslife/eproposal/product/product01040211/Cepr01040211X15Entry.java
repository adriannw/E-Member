...
public class Cepr01040211X15Entry extends Cepr01040211Entry
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040211X15Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
        super( eproposalManager, editorUtil, command, errors );
        logger.info( "*-*-*-* Cepr01040211X15Entry constructor is called ..." );
    }

    public void initDisplayedForm()
    {
        logger.info( "*-*-*-* Cepr01040211X15Entry.initDisplayedForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040211X15Entry.initDisabledForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040211X15Entry.initReadOnlyForm" );
        super.initReadOnlyForm();
    }

    public void fillDefaultValueEachTimeRightPartOfBusinessCdChanged()
    {
        logger.info( "*-*-*-* Cepr01040211X15Entry.fillDefaultValueEachTimeRightPartOfBusinessCdChanged" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040211X15Entry.fillDefaultValueEachTimeFormCalled" );
        ...
        cepr01030102Form.setTermOfPayment( 100 - cepr01030101Form.getInsuredAge() );
...
//        cepr01030102Form.setPremiumCombinationList( LookupList.getPremiumCombinationFoldedList( 20 ) );
    ...
    {
        logger.info( "*-*-*-* Cepr01040211X15Entry.validateCurrentPage" );
...
//        commonValidator.validateMinimumMoney( Cepr01030102FormConst.PREMIUM, premium, minPremiumIdr, minPremiumUsd );
        ...
        if( cepr01030102Form.getPremium() != null )
        {
        	...
        	if( cepr01030101Form.getInsuredAge() <= 5 && cepr01030102Form.getTotalSumInsured().compareTo( maksUp ) > 0 && upFix.compareTo( cepr01030102Form.getTotalSumInsured() ) >= 0 ){
...
//        	commonValidator.validateMaximumMoney( Cepr01030102FormConst.TOTAL_SUM_INSURED, LazyConverter.toDouble( cepr01030102Form.getTotalSumInsured() ), maxUp, maxUp );
    ...
    {
        logger.info( "*-*-*-* Cepr01040211X15Entry.processFormAfterSubmitBeforeValidation" );
        double premium = LazyConverter.toDouble( cepr01030102Form.getPremium() );

 ...
 * Function Id         	: 
 * Program Name   		: Cepr01040211X7Entry
 * Description         	:
...
public class Cepr01040211X7Entry extends Cepr01040211Entry
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040211X7Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
        super( eproposalManager, editorUtil, command, errors );
        logger.info( "*-*-*-* Cepr01040211X7Entry constructor is called ..." );
    }

    public void initDisplayedForm()
    {
        logger.info( "*-*-*-* Cepr01040211X7Entry.initDisplayedForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040211X7Entry.initDisabledForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040211X7Entry.initReadOnlyForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040211X7Entry.fillDefaultValueEachTimeFormCalled" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040211X7Entry.validateCurrentPage" );
...
//        commonValidator.validateMinimumMoney( Cepr01030102FormConst.PREMIUM, premium, minPremiumIdr, minPremiumUsd );
    ...
    {
        logger.info( "*-*-*-* Cepr01040211X7Entry.processFormAfterSubmitBeforeValidation" );
        double premium = LazyConverter.toDouble( cepr01030102Form.getPremium() );
        ...
        if(cepr01030102Form.getEducationPackageCd()>1){
        	...
        	cepr01030102Form.setTotalSumInsured(new BigDecimal(5).multiply(cepr01030102Form.getBasePremium().multiply(new BigDecimal (li_kali))));
        }
    }

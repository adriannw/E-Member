...
public class Cepr01040211X22Entry extends Cepr01040211Entry
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040211X22Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
        super( eproposalManager, editorUtil, command, errors );
        logger.info( "*-*-*-* Cepr01040211X10Entry constructor is called ..." );
    }

    public void initDisplayedForm()
    {
        logger.info( "*-*-*-* Cepr01040211X10Entry.initDisplayedForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040211X10Entry.initDisabledForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040211X10Entry.initReadOnlyForm" );
        super.initReadOnlyForm();
    }

    public void fillDefaultValueEachTimeRightPartOfBusinessCdChanged()
    {
        logger.info( "*-*-*-* Cepr01040211X10Entry.fillDefaultValueEachTimeRightPartOfBusinessCdChanged" );
        cepr01030102Form.setTotalSumInsuredIsDisabled( CommonConst.DISABLED_FALSE );
    ...
    {
        logger.info( "*-*-*-* Cepr01040211X10Entry.fillDefaultValueEachTimeFormCalled" );
...
//        cepr01030102Form.setPaymentModeList( comboLookupBusiness.selectPayModeOptionVOList( false, new Integer[]{ Hardcode.PAY_MODE_CD_TAHUNAN} ) );
    ...
    {
        logger.info( "*-*-*-* Cepr01040211X10Entry.validateCurrentPage" );
...
//        commonValidator.validateMinimumMoney( Cepr01030102FormConst.PREMIUM, premium, minPremiumIdr, minPremiumUsd );
        ...
        if( cepr01030102Form.getPremium() != null )
        {
            ...
            double maxUp = 0;  
            if(cepr01030102Form.getRightPartOfBusinessCd()==Cepr01040211Mapper.X22 || cepr01030102Form.getRightPartOfBusinessCd()==Cepr01040211Mapper.X19 || cepr01030102Form.getRightPartOfBusinessCd()==Cepr01040211Mapper.X10){ //SIMAS POWER LINK(120 X10)
...
//        	double minUp	= ( LazyConverter.toDouble( cepr01030102Form.getBasePremium() ) / factor_percentage ) * 5;
        	...
        	if(cepr01030102Form.getJenisCd() == 1 && cepr01030102Form.getPaymentModeCd()==Hardcode.PAY_MODE_CD_BULANAN){
...
//        parVO.setBeyond5YearsSekaligusMaxBasePremiumVO( new AmountVO( 0.0, 0.0 ) );
    ...
    {
        logger.info( "*-*-*-* Cepr01040211X10Entry.processFormAfterSubmitBeforeValidation" );
        double premium = LazyConverter.toDouble( cepr01030102Form.getPremium() );
        double premiumCombinationPercent = LazyConverter.toDouble( cepr01030102Form.getPremiumCombinationCd() );

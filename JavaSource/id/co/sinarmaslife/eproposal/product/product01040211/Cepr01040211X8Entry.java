...
public class Cepr01040211X8Entry extends Cepr01040211Entry
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040211X8Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
...
//        commonValidator.validateMinimumMoney( Cepr01030102FormConst.PREMIUM, premium, minPremiumIdr, minPremiumUsd );
    ...
    public void processFormAfterSubmitBeforeValidation()
    {
        ...
        if(cepr01030102Form.getEducationPackageCd()>1){  
        	cepr01030102Form.setTotalSumInsured(new BigDecimal(5).multiply(cepr01030102Form.getBasePremium()));
        }
    }

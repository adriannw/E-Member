 ...
 * Function Id         	: 
 * Program Name   		: Cepr01040213Entry
 * Description         	:
...
public class Cepr01040213Entry extends Cepr01040000UlinkEntry implements Cepr01040000EntryInterface
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040213Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
        super( eproposalManager, editorUtil, command, errors );
        logger.info( "*-*-*-* Cepr01040213Entry constructor is called ..." );
        setDownloadUrl( "wepr01040213.pdf" );
    }

    public void initDisplayedForm()
    {
        logger.info( "*-*-*-* Cepr01040213Entry.initDisplayedForm" );
        displayStandardForm();
    ...
    {
        logger.info( "*-*-*-* Cepr01040213Entry.initDisabledForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040213Entry.initReadOnlyForm" );
...
//    	}
        logger.info( "*-*-*-* Cepr01040213Entry.fillDefaultValueEachTimeRightPartOfBusinessCdChanged" );
    }

    public void fillDefaultValueEachTimeFormCalled()
    {
        logger.info( "*-*-*-* Cepr01040213Entry.fillDefaultValueEachTimeFormCalled" );
...
//        
    ...
    {
        logger.info( "*-*-*-* Cepr01040213Entry.validateCurrentPage" );
...
//            commonValidator.validateMinimumMoney( Cepr01030102FormConst.PREMIUM, premium, minPremiumIdr, minPremiumUsd );
    ...
    public void validatePreviousPage()
    {
        ...
        if( cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040213Mapper.X7 || cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040213Mapper.X9|| cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040213Mapper.X5 ){
    ...
    {
        logger.info( "*-*-*-* Cepr01040213Entry.processFormAfterSubmitBeforeValidation" );
    }
}
 ...
 * Function Id         	: 
 * Program Name   		: Cepr01040213DownloadController
 * Description         	:
...
public class Cepr01040213DownloadController extends StandardParent implements Controller
{
    ...
    {
        logger.info( "*-*-*-* Cepr01040213DownloadController.handleRequest" );
        ...
        Cepr01040213Business cepr01040213Business = new Cepr01040213Business( eproposalManager, editorUtil, command );

        ModelAndView result = null;
        if( request.getSession().getAttribute( "messageEkaSehatList" ) == null )
        {
        	List<String> messageEkaSehatList = cepr01040213Business.getEkaSehatMsgBox();
        ...
        {
            List<String> messageBoxList = cepr01040213Business.getMedicalMsgBox();
        ...
        //    jasperViewer.setUrl( "/WEB-INF/classes/" + "id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040213_product.jasper" );
            
//          TITLE
            String paket = "";
            if( cepr01030102Form.getSmilePensionPackageCd() != null && cepr01030102Form.getSmilePensionPackageCd().equals( 2 ) ){
            	paket = "1";
            }else if( cepr01030102Form.getSmilePensionPackageCd() != null && cepr01030102Form.getSmilePensionPackageCd().equals( 3 ) ){
            	paket = "2";
            }else if( cepr01030102Form.getSmilePensionPackageCd() != null && cepr01030102Form.getSmilePensionPackageCd().equals( 4 ) ){
            	paket = "3";
            }
            if(cepr01030102Form.getRightPartOfBusinessCd() == 1){
            	params.put( "title", "CERDAS SEJAHTERA 5" );
            	params.put( "titleRider", "CERDAS SEJAHTERA 5" );
            }else if(cepr01030102Form.getRightPartOfBusinessCd() == 2){
            	params.put( "title", "CERDAS SEJAHTERA 10" );
            	params.put( "titleRider", "CERDAS SEJAHTERA 10" );
            }else if(cepr01030102Form.getRightPartOfBusinessCd() == 3){
            	params.put( "title", "CERDAS SEJAHTERA PLUS 5" );
            	params.put( "titleRider", "CERDAS SEJAHTERA PLUS 5" );
            }else if(cepr01030102Form.getRightPartOfBusinessCd() == 4){
            	params.put( "title", "CERDAS SEJAHTERA PLUS 10" );
            	params.put( "titleRider", "CERDAS SEJAHTERA PLUS 10" );
            }else if(cepr01030102Form.getRightPartOfBusinessCd() == 5){
            	params.put( "title", "Excellent Link \n (For Your Pension Paket "+ paket +")" );
            	params.put( "titleRider", "EXCELLENT LINK (FOR YOUR PENSION PAKET "+ paket +")" );
            }else if(cepr01030102Form.getRightPartOfBusinessCd() == 6){
            	params.put( "title", "Excellent Link \n (For Your Pension Paket "+ paket +")" );
            	params.put( "titleRider", "EXCELLENT LINK (FOR YOUR PENSION PAKET "+ paket +")" );
            }else if(cepr01030102Form.getRightPartOfBusinessCd() == 7){
            	params.put( "title", "Excellent Link \n (For Your Pension)" );
            	params.put( "titleRider", "EXCELLENT LINK (FOR YOUR PENSION)" );
            }else if(cepr01030102Form.getRightPartOfBusinessCd() == 8){
            	params.put( "title", "Excellent Link \n (For Your Pension)" );
            	params.put( "titleRider", "EXCELLENT LINK (FOR YOUR PENSION)" );
            }else if(cepr01030102Form.getRightPartOfBusinessCd() == 9){
            	params.put( "title", "Excellent Link \n (For Your Pension Plus)" );
            	params.put( "titleRider", "EXCELLENT LINK (FOR YOUR PENSION PLUS)" );
            ...
            double li_kali = 0.0;
            if( cepr01030102Form.getPaymentModeCd().intValue() == 1 )      //triwulan
                li_kali = 4;
            else if( cepr01030102Form.getPaymentModeCd().intValue() == 2 ) //semesteran
                li_kali = 2;
            else if( cepr01030102Form.getPaymentModeCd().intValue() == 6 ) //bulanan
                li_kali = 12;
            else li_kali = 1;
            
            if( cepr01030102Form.getRightPartOfBusinessCd() == 5 || cepr01030102Form.getRightPartOfBusinessCd() == 6 ){
            	 params.put( "paket_no", cepr01030102Form.getSmilePensionPackageCd() );
            }
...
//            BigDecimal biayaAsuransiPokok = cepr01030102Form.getBasePremium().multiply(new BigDecimal("0.00094"));
            BigDecimal biayaAsuransiPokok =  new BigDecimal(cepr01040213Business.of_get_coi_basic(1));
            ...
            if(cepr01030102Form.getDynamicIdr() != null){
            	...
            	alokasiInvestasiSedang = alokasiInvestasiSedang + (new BigDecimal("15.0").multiply(cepr01030102Form.getDynamicIdr().divide(percent))) + "%\n";
            	alokasiInvestasiTinggi = alokasiInvestasiTinggi + (new BigDecimal("20.0").multiply(cepr01030102Form.getDynamicIdr().divide(percent))) + "%\n";
            }else{
            ...
            if(cepr01030102Form.getAggresiveIdr() != null){
            	...
            	alokasiInvestasiSedang = alokasiInvestasiSedang + (new BigDecimal("20.0").multiply(cepr01030102Form.getAggresiveIdr().divide(percent))) + "%";
            	alokasiInvestasiTinggi = alokasiInvestasiTinggi + (new BigDecimal("30.0").multiply(cepr01030102Form.getAggresiveIdr().divide(percent))) + "%";
            }else{
            	alokasiInvestasi = alokasiInvestasi + "0%";
            	alokasiInvestasiRendah = alokasiInvestasiRendah + "0.00%";
            	alokasiInvestasiSedang = alokasiInvestasiSedang + "0.00%";
...
//            params.put( "uangPertanggunganPa", currencySymbol + " " + editorUtil.convertToTwoDigit(Math.min(up * 2, 1000000000.0)) );
//            params.put( "uangPertanggunganPa2", currencySymbol + " " + editorUtil.convertToTwoDigit(Math.min(up,1000000000.0)) );
//            params.put( "uangPertanggunganPa3", currencySymbol + " " + editorUtil.convertToTwoDigit(Math.min(up * 0.4,500000000.0)) );
            ...
            params.put( "uangPertanggunganCIPaket", currencySymbol + " " + editorUtil.convertToTwoDigit(Math.min( cepr01030102Form.getTotalSumInsured().doubleValue() / 2,maksUangPertanggunganCI)) );
            params.put( "uangPertanggunganPa", currencySymbol + " " + editorUtil.convertToTwoDigit(Math.min(up * 2, maksUangPertanggunganPa)) );
            params.put( "uangPertanggunganPa2", currencySymbol + " " + editorUtil.convertToTwoDigit(Math.min(up,maksUangPertanggunganPa)) );
            params.put( "uangPertanggunganPa3", currencySymbol + " " + editorUtil.convertToTwoDigit(Math.min( ( cepr01030102Form.getBasePremium().doubleValue()  * li_kali ) * 2 ,maksUangPertanggunganPa3)) );
            String tipeMedisPP = cepr01040213Business.getTipeMedis(cepr01030101Form.getPolicyHolderAge());
            String tipeMedisTT = cepr01040213Business.getTipeMedis(cepr01030101Form.getInsuredAge());
         ...
         //   jasperViewer.setJdbcDataSource( eproposalManager.getDataSource() );
            ...
            mapMaster = cepr01040213Business.getIllustration213Result(cepr01030102Form.getTermOfPayment());
            ...
            //int exr = 0;
            String[][] riderTambahan = cepr01040213Business.getRiderPremiumList( cepr01030102Form );
            ...
            if(cepr01030102Form.getRightPartOfBusinessCd() >= 9){
            ...
            logger.info( "*-*-*-* cepr01040201Business.getInvestmentYield() = " + cepr01040213Business.getInvestmentYield() );
            params.put( "totalInvestmentAllocation", cepr01040213Business.getInvestmentYield().getTotalInvestmentAllocation() );
            params.put( "totalAssumptionLow", cepr01040213Business.getInvestmentYield().getTotalAssumptionLow() );
            params.put( "totalAssumptionMid", cepr01040213Business.getInvestmentYield().getTotalAssumptionMid() );
            params.put( "totalAssumptionHi", cepr01040213Business.getInvestmentYield().getTotalAssumptionHi() );

            params.put( "dsCommonHeader", JasperReportsUtils.convertReportData( cepr01040213Business.getCommonHeaderRowList() ) );
            params.put( "dsCommonHeader2", JasperReportsUtils.convertReportData( cepr01040213Business.getCommonHeaderRowList() ) );
            params.put( "dsCommonHeader3", JasperReportsUtils.convertReportData( cepr01040213Business.getCommonHeaderRowList() ) );
            params.put( "dsCommonHeaderSmall", JasperReportsUtils.convertReportData( cepr01040213Business.getCommonHeaderSmallRowList() ) );
            params.put( "dsInvestmentChoice", JasperReportsUtils.convertReportData( cepr01040213Business.getInvestmentChoiceRowList() ) );
            params.put( "dsInvestmentChoiceSmall", JasperReportsUtils.convertReportData( cepr01040213Business.getInvestmentChoiceSmallRowList() ) );
            ...
            params.put( "dsInvestmentYield", JasperReportsUtils.convertReportData( cepr01040213Business.getInvestmentYield().getYieldList() ) );
            ...
            params.put( "dataSource", cepr01040213Business.getPageList( currentIdx ) );
          ...
          //  String fileName="testx.pdf";
            ...
            List temp = cepr01040213Business.getPageList( currentIdx );
            ...
            try{      
	        	   //if(cekDataApprovedOrNot.get(0).getPosisi()<3){
			            JasperUtils.exportReportToPdf(
			            		"id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040213_product.jasper",
			            		dirName,
			                fileName,
							params,
							temp,
    ...
    public void putRiderParam( Map<String, Object> params, List contentList, String dsParamName, String idxParamName )
    {
        ...
        if( "dsRiderEkaSehat".equals( dsParamName ) ){
            params.put( dsParamName, source );
            params.put( idxParamName, "5." );
        }else{
            params.put( dsParamName, source );
            params.put( idxParamName, "" );
        }

 ...
 * Function Id         	: 
 * Program Name   		: Cepr01040213X9Entry
 * Description         	:
...
public class Cepr01040213X9Entry extends Cepr01040213Entry
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040213X9Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
        super( eproposalManager, editorUtil, command, errors );
        logger.info( "*-*-*-* Cepr01040213X9Entry constructor is called ..." );
    }

    public void initDisplayedForm()
    {
        logger.info( "*-*-*-* Cepr01040213X9Entry.initDisplayedForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040213X9Entry.initDisabledForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040213X9Entry.initReadOnlyForm" );
        super.initReadOnlyForm();
    }

    public void fillDefaultValueEachTimeRightPartOfBusinessCdChanged()
    {
        logger.info( "*-*-*-* Cepr01040213X9Entry.fillDefaultValueEachTimeRightPartOfBusinessCdChanged" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040213X9Entry.fillDefaultValueEachTimeFormCalled" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040213X9Entry.validateCurrentPage" );
...
//        commonValidator.validateMinimumMoney( Cepr01030102FormConst.PREMIUM, premium, minPremiumIdr, minPremiumUsd );
    ...
    {
        logger.info( "*-*-*-* Cepr01040213X9Entry.processFormAfterSubmitBeforeValidation" );
        double premium = LazyConverter.toDouble( cepr01030102Form.getPremium() );

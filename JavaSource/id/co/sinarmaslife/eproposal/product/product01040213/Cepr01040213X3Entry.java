 ...
 * Function Id         	: 
 * Program Name   		: Cepr01040213X3Entry
 * Description         	:
...
public class Cepr01040213X3Entry extends Cepr01040213Entry
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040213X3Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
        super( eproposalManager, editorUtil, command, errors );
        logger.info( "*-*-*-* Cepr01040213X3Entry constructor is called ..." );
    }

    public void initDisplayedForm()
    {
        logger.info( "*-*-*-* Cepr01040213X3Entry.initDisplayedForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040213X3Entry.initDisabledForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040213X3Entry.initReadOnlyForm" );
        super.initReadOnlyForm();
    }

    public void fillDefaultValueEachTimeRightPartOfBusinessCdChanged()
    {
        logger.info( "*-*-*-* Cepr01040213X3Entry.fillDefaultValueEachTimeRightPartOfBusinessCdChanged" );
        cepr01030102Form.setTotalSumInsuredIsDisabled( CommonConst.DISABLED_TRUE );
    ...
    {
        logger.info( "*-*-*-* Cepr01040213X3Entry.fillDefaultValueEachTimeFormCalled" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040213X3Entry.validateCurrentPage" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040213X3Entry.processFormAfterSubmitBeforeValidation" );
        double premium = LazyConverter.toDouble( cepr01030102Form.getPremium() );

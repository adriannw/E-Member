 ...
 * Function Id         	: 
 * Program Name   		: Cepr01040213X1Entry
 * Description         	:
...
public class Cepr01040213X2Entry extends Cepr01040213Entry
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040213X2Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
        super( eproposalManager, editorUtil, command, errors );
        logger.info( "*-*-*-* Cepr01040213X2Entry constructor is called ..." );
    }

    public void initDisplayedForm()
    {
        logger.info( "*-*-*-* Cepr01040213X2Entry.initDisplayedForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040213X2Entry.initDisabledForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040213X2Entry.initReadOnlyForm" );
        super.initReadOnlyForm();
    }

    public void fillDefaultValueEachTimeRightPartOfBusinessCdChanged()
    {
        logger.info( "*-*-*-* Cepr01040213X2Entry.fillDefaultValueEachTimeRightPartOfBusinessCdChanged" );
        cepr01030102Form.setTotalSumInsuredIsDisabled( CommonConst.DISABLED_TRUE );
    ...
    {
        logger.info( "*-*-*-* Cepr01040213X2Entry.fillDefaultValueEachTimeFormCalled" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040213X2Entry.validateCurrentPage" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040213X2Entry.processFormAfterSubmitBeforeValidation" );
        double premium = LazyConverter.toDouble( cepr01030102Form.getPremium() );

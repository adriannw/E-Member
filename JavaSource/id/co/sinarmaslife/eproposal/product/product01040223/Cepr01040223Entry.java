...
public class Cepr01040223Entry extends Cepr01040000UlinkEntry implements Cepr01040000EntryInterface
{
    protected final Log logger = LogFactory.getLog( getClass() );
    
    private static final int ASSURANCE_TERM = 80;

    public Cepr01040223Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
        super( eproposalManager, editorUtil, command, errors );
        logger.info( "*-*-*-* Cepr01040208Entry constructor is called ..." );
        setDownloadUrl( "wepr01040223.pdf" );
    }
...
//        restore investment choice
    ...
    public void fillDefaultValueEachTimeFormCalled()
    {
        ...
        if( cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040223Mapper.X1 || cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040223Mapper.X2 
        	|| cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040223Mapper.X3 || cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040223Mapper.X4 ){ //SIMAS PRIME LINK
...
//        super.validateCurrentPage( parVO );
    ...
    {
    	if( cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040223Mapper.X1){	
    ...
    public void validateCurrentPageInCommon()
    {
        ...
        if( cepr01030102Form.getBasePremium() != null && cepr01030102Form.getPremium() != null)
        {        	

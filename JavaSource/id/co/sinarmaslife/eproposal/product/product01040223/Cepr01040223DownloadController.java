...
public class Cepr01040223DownloadController extends StandardParent implements Controller
{
 ...
 //       AbstractJasperReportsView jasperViewer = new JasperReportsPdfView();
        ...
        Cepr01040223Business cepr01040223Business = new Cepr01040223Business( eproposalManager, editorUtil, command );
        
        
        HashMap<String, Object> map = new HashMap<String, Object>();
        if( request.getSession().getAttribute( "messageEkaSehatList" ) == null )
        {
        	List<String> messageEkaSehatList = cepr01040223Business.getEkaSehatMsgBox();
        ...
        {
            List<String> messageBoxList = cepr01040223Business.getMedicalMsgBox();
...
//           result = new ModelAndView( jasperViewer, params );
            ...
            throws ServletException, IOException
    {
    	HashMap<String, Object> result = new HashMap<String, Object>();
    	 Cepr01040223Business cepr01040223Business = new Cepr01040223Business( eproposalManager, editorUtil, cepr01030000HoldingForm );
    ...
    //    jasperViewer.setUrl( "/WEB-INF/classes/" + "id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040223_product.jasper" );
        ...
        if( cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040223Mapper.X4 ){
         	title = "B SMiLe INSURANCE SYARIAH"; 
         }    
    ...
    //    jasperViewer.setJdbcDataSource( eproposalManager.getDataSource() );
        ...
        IllustrationResultVO illustrationResultVO = cepr01040223Business.getIllustrationResult();
        ...
        IllustrationResultVO illustrationResultVO3 = cepr01040223Business.getIllustrationResult();
        ...
        if( cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040223Mapper.X4){
        	 params.put( "totalInvestmentAllocation", cepr01040223Business.of_get_rate_ds().getTotalInvestmentAllocation() );
        	 params.put( "totalAssumptionLow", cepr01040223Business.of_get_rate_ds().getTotalAssumptionLow() );
        	 params.put( "totalAssumptionMid", cepr01040223Business.of_get_rate_ds().getTotalAssumptionMid() );
        	 params.put( "totalAssumptionHi", cepr01040223Business.of_get_rate_ds().getTotalAssumptionHi() );
        }else{            	 
        	 params.put( "totalInvestmentAllocation", cepr01040223Business.of_get_rate_ds_ProAsset().getTotalInvestmentAllocation());
             params.put( "totalAssumptionLow", cepr01040223Business.of_get_rate_ds_ProAsset().getTotalAssumptionLow() );
             params.put( "totalAssumptionMid", cepr01040223Business.of_get_rate_ds_ProAsset().getTotalAssumptionMid() );
             params.put( "totalAssumptionHi", cepr01040223Business.of_get_rate_ds_ProAsset().getTotalAssumptionHi() );            	
        	
       }        
        
        params.put( "dsCommonHeader", JasperReportsUtils.convertReportData( cepr01040223Business.getCommonHeaderRowList() ) );
        params.put( "dsCommonHeaderSmall", JasperReportsUtils.convertReportData( cepr01040223Business.getCommonHeaderSmallRowList() ) );
        params.put( "dsCommonHeaderSmall2", JasperReportsUtils.convertReportData( cepr01040223Business.getCommonHeaderSmallRowList() ) );
        params.put( "dsCommonHeaderSmall3", JasperReportsUtils.convertReportData( cepr01040223Business.getCommonHeaderSmallRowList() ) );
        
        if( cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040223Mapper.X4 ){
        	params.put( "dsInvestmentChoice", JasperReportsUtils.convertReportData( cepr01040223Business.getInvestmentChoiceRowList() ) );
        }else{
        	  params.put( "dsInvestmentChoice", JasperReportsUtils.convertReportData( cepr01040223Business.getInvestmentChoiceRowList_ProAsset() ) );
        	  params.put( "dsInvestmentChoice3", JasperReportsUtils.convertReportData( cepr01040223Business.getInvestmentChoiceRowList_ProAsset() ) );
        }
        
       
        if( cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040223Mapper.X4){
        	params.put( "dsInvestmentChoiceSmall", JasperReportsUtils.convertReportData( cepr01040223Business.getInvestmentChoiceSmallRowList() ) );
        }else {
        	params.put( "dsInvestmentChoiceSmall", JasperReportsUtils.convertReportData( cepr01040223Business.getInvestmentChoiceSmallRowList_ProAsset() ) );
        	params.put( "dsInvestmentChoiceSmall3", JasperReportsUtils.convertReportData( cepr01040223Business.getInvestmentChoiceSmallRowList_ProAsset() ) );
        }            
        
        params.put( "dsMonthlyPremium", JasperReportsUtils.convertReportData( cepr01040223Business.getMonthlyPremiumList( cepr01030102Form ) ) );
        params.put( "dsInvestmentPerformance", JasperReportsUtils.convertReportData( cepr01040223Business.getInvestmentPerformanceList() ) );  
        
        if( cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040223Mapper.X4){
        	params.put( "dsInvestmentYield", JasperReportsUtils.convertReportData( cepr01040223Business.of_get_rate_ds().getYieldList() ) );
        }else{
        	params.put( "dsInvestmentYield", JasperReportsUtils.convertReportData( cepr01040223Business.of_get_rate_ds_ProAsset().getYieldList() ) );
        	params.put( "dsInvestmentYield3", JasperReportsUtils.convertReportData( cepr01040223Business.of_get_rate_ds_ProAsset().getYieldList() ) );
        }            
        
        params.put( "dsOneRow", JasperReportsUtils.convertReportData( cepr01040223Business.getOneRowList() ) );
        params.put( "dsOneRow2", JasperReportsUtils.convertReportData( cepr01040223Business.getOneRowList() ) );
        params.put( "dsOneRow3", JasperReportsUtils.convertReportData( cepr01040223Business.getOneRowList() ) );
        params.put( "dsNoteSekaligus", JasperReportsUtils.convertReportData( cepr01040223Business.getNoteSekaligusRowList() ) );
        params.put( "dsNoteBerkala", JasperReportsUtils.convertReportData( cepr01040223Business.getNoteBerkalaRowList() ) );
        ...
        putRiderParam( params, riderBusiness.getRiderPayor5Tpd10CiDeathSyariahList(), "dsRiderPayor5Tpd10CiDeath", "riderPayor5Tpd10CiDeathIndex", null );
        putRiderParam( params, riderBusiness.getRiderWaiver5Tpd10CiSyariahList(), "dsRiderWaiver5Tpd10Ci", "riderWaiver5Tpd10CiIndex", null );
        ...
        putRiderParam( params, riderBusiness.getRiderPayorTpdDeathSyariahList(), "dsRiderPayorTpdDeath", "riderPayorTpdDeathIndex", null );
        putRiderParam( params, riderBusiness.getRiderPayorCiDeathSyariahList(), "dsRiderPayorCiDeath", "riderPayorCiDeathIndex", null );
        putRiderParam( params, riderBusiness.getRiderPayorCiSyariahList(), "dsRiderPayorCi", "riderPayorCiIndex", null );
        ...
        putRiderParam( params, riderBusiness.getRiderWaiverTpdSyariahList(), "dsRiderWaiverTpd", "riderWaiverTpdIndex", null );
        putRiderParam( params, riderBusiness.getRiderWaiverCiSyariahList(), "dsRiderWaiverCi", "riderWaiverCiIndex", null );
        ...
        params.put( "dataSource", cepr01040223Business.getPageList( currentIdx ) );
        params.put( "titleHcp", titleHcp );
        
        params.put( "dsEkalinkRider", JasperReportsUtils.convertReportData( cepr01040223Business.getRiderPremiumList(cepr01030102Form, cepr01030101Form.getInsuredAge()) ) );
        params.put( "dsEkalinkRider2", JasperReportsUtils.convertReportData( cepr01040223Business.getRiderPremiumList(cepr01030102Form, cepr01030101Form.getInsuredAge()) ) );
                    
        params.put( "dsCommonHeaderRincian", JasperReportsUtils.convertReportData( cepr01040223Business.getCommonHeaderRincianRowList()) );
        ...
        || cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040223Mapper.X3 || cepr01030102Form.getRightPartOfBusinessCd() == Cepr01040223Mapper.X4 ){
    		ldec_coi = cepr01040223Business.of_get_coi_basic_190(1);
    	}else{
    		ldec_coi = cepr01040223Business.of_get_coi_basic(1);
    	}           
        BigDecimal biayaAsuransiPokok =  new BigDecimal(ldec_coi);
        params.put( "dsCommonBiayaRincian", JasperReportsUtils.convertReportData( cepr01040223Business.getCommonBiayaRincianRowList( biayaAsuransiPokok ) ) );
        
        params.put("pageRider", cepr01040223Business.getPageRider( currentIdx ));
        params.put( "dsCommonHeaderRincianRiderPa", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040223Business.getCommonHeaderRincianSmallRowList(1) ) );
        params.put( "dsCommonBiayaRincianRiderPa", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040223Business.getCommonBiayaRincianRider(1) ) );
        params.put( "dsCommonHeaderRincianRiderTpd", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040223Business.getCommonHeaderRincianSmallRowList(3) ) );
        params.put( "dsCommonBiayaRincianRiderTpd", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040223Business.getCommonBiayaRincianRider(3) ) ); 
        params.put( "dsCommonHeaderRincianRiderCi", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040223Business.getCommonHeaderRincianSmallRowList(4) ) );
        params.put( "dsCommonBiayaRincianRiderCi", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040223Business.getCommonBiayaRincianRider(4) ) ); 
        params.put( "dsCommonHeaderRincianRiderHCPFamily", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040223Business.getCommonHeaderRincianSmallRowList(11) ) );
        params.put( "dsCommonBiayaRincianRiderHCPFamily", JasperReportsUtils.convertReportData( cepr01040223Business.getCommonBiayaRincianRider(11) ) );
        ...
        params.put( "dsCommonHeaderRincianRiderHCP", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040223Business.getCommonHeaderRincianSmallRowList(2) ) );
        params.put( "dsCommonBiayaRincianRiderHCP", JasperReportsUtils.convertReportData( cepr01040223Business.getCommonBiayaRincianRider(2) ) );
        params.put( "dsRincianRiderHCP", JrUtil.convertToDsAndSetNullIfEmpty( riderBusiness.getRiderHcpList() ));    
        
        params.put( "dsCommonHeaderRincianRiderHCPProvider", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040223Business.getCommonHeaderRincianSmallRowList(16) ) );
        params.put( "dsCommonBiayaRincianRiderHCPProvider", JasperReportsUtils.convertReportData( cepr01040223Business.getCommonBiayaRincianRider(16) ) );
        params.put( "dsRincianRiderHCPProvider", JrUtil.convertToDsAndSetNullIfEmpty( riderBusiness.getRiderHcpProviderList()));    
        
        params.put( "dsCommonHeaderRincianRiderTerm", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040223Business.getCommonHeaderRincianSmallRowList(12) ) );
        params.put( "dsCommonBiayaRincianRiderTerm", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040223Business.getCommonBiayaRincianRider(12) ) ); 
        params.put( "dsCommonHeaderRincianRiderEkaSehat", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040223Business.getCommonHeaderRincianSmallRowList(13) ) );
        params.put( "dsCommonBiayaRincianRiderEkaSehat", JasperReportsUtils.convertReportData( cepr01040223Business.getCommonBiayaRincianRider(13) ) );     
        ...
        params.put( "dsCommonHeaderRincianRiderEkaSehatInnerLimit", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040223Business.getCommonHeaderRincianSmallRowList(15) ) );
        params.put( "dsCommonBiayaRincianRiderEkaSehatInnerLimit", JasperReportsUtils.convertReportData( cepr01040223Business.getCommonBiayaRincianRider(15) ) );     
        ...
        params.put( "dsCommonHeaderRincianRiderWaiverTpdCi", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040223Business.getCommonHeaderRincianSmallRowList(17) ) );
        params.put( "dsCommonBiayaRincianRiderWaiverTpdCi", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040223Business.getCommonBiayaRincianRider(17) ) );
        params.put( "dsCommonHeaderRincianRiderPayorTpdCiDeath", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040223Business.getCommonHeaderRincianSmallRowList(18) ) );
        params.put( "dsCommonBiayaRincianRiderPayorTpdCiDeath", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040223Business.getCommonBiayaRincianRider(18) ) );
        
        params.put( "dsCommonHeaderRincianRiderLadiesIns", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040223Business.getCommonHeaderRincianSmallRowList(19) ) );
        params.put( "dsCommonBiayaRincianRiderLadiesIns", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040223Business.getCommonBiayaRincianRider(19) ) ); 
        params.put( "dsCommonHeaderRincianRiderHCPLadies", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040223Business.getCommonHeaderRincianSmallRowList(20) ) );
        params.put( "dsCommonBiayaRincianRiderHCPLadies", JasperReportsUtils.convertReportData( cepr01040223Business.getCommonBiayaRincianRider(20) ) );
        params.put( "dsRincianRiderHcpLadies", JrUtil.convertToDsAndSetNullIfEmpty( riderBusiness.getRiderHcpLadiesList()));
        params.put( "dsCommonHeaderRincianRiderLadiesMedExpense", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040223Business.getCommonHeaderRincianSmallRowList(21) ) );
        params.put( "dsCommonBiayaRincianRiderLadiesMedExpense", JasperReportsUtils.convertReportData( cepr01040223Business.getCommonBiayaRincianRider(21) ) );     
        ...
        params.put( "dsCommonHeaderRincianRiderLadiesMedExpenseInnerLimit", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040223Business.getCommonHeaderRincianSmallRowList(22) ) );
        params.put( "dsCommonBiayaRincianRiderLadiesMedExpenseInnerLimit", JasperReportsUtils.convertReportData( cepr01040223Business.getCommonBiayaRincianRider( 22) ) );     
        ...
        params.put( "dsCommonHeaderRincianRiderPayor5Tpd10CiDeath", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040223Business.getCommonHeaderRincianSmallRowList(23) ) );
        params.put( "dsCommonBiayaRincianRiderPayor5Tpd10CiDeath", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040223Business.getCommonBiayaRincianRider(23) ) );
        params.put( "dsCommonHeaderRincianRiderWaiver5Tpd10Ci", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040223Business.getCommonHeaderRincianSmallRowList(24) ) );
        params.put( "dsCommonBiayaRincianRiderWaiver5Tpd10Ci", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040223Business.getCommonBiayaRincianRider(24) ) );
        params.put( "dsCommonHeaderRincianRiderScholar", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040223Business.getCommonHeaderRincianSmallRowList(25) ) );
        params.put( "dsCommonBiayaRincianRiderScholar", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040223Business.getCommonBiayaRincianRider(25) ) ); 
        params.put( "dsCommonHeaderRincianRiderEarlyStageCi99", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040223Business.getCommonHeaderRincianSmallRowList(27) ) );
        params.put( "dsCommonBiayaRincianRiderEarlyStageCi99", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040223Business.getCommonBiayaRincianRider(27) ) );            
        params.put( "dsCommonHeaderRincianRiderMedicalPlus", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040223Business.getCommonHeaderRincianSmallRowList(28) ) );
        params.put( "dsCommonBiayaRincianRiderMedicalPlus", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040223Business.getCommonBiayaRincianRider(28) ) );  
        ...
        /* ADRIAN -- DEV TERM 55/65/75 RIDER -- */
        params.put( "dsCommonHeaderRincianRiderTerm5575", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040223Business.getCommonHeaderRincianSmallRowList(30) ) );
        params.put( "dsCommonBiayaRincianRiderTerm5575", JrUtil.convertToDsAndSetNullIfEmpty( cepr01040223Business.getCommonBiayaRincianRider(30) ) ); 
      ...
      //  String fileName="testx.pdf";
        ...
        List temp = cepr01040223Business.getPageList( currentIdx );
       ...
       try{      
        	   //if(cekDataApprovedOrNot.get(0).getPosisi()<3){
		            JasperUtils.exportReportToPdf(
		            		"id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040223_product.jasper",
		            		dirName,
		                fileName,
						params,
						temp,

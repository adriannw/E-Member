 ...
 * Function Id         	:
 * Program Name   		: Cepr01040106DownloadController
...
public class Cepr01040106DownloadController extends StandardParent implements Controller
{
    public ModelAndView handleRequest( HttpServletRequest request, HttpServletResponse response )
            throws ServletException, IOException
    {
        logger.info( "*-*-*-* Cepr01040106DownloadController.handleRequest" );
        ...
        else
        {
            ...
            jasperViewer.setUrl( "/WEB-INF/classes/" + "id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040106_product.jasper" );
            ...
            for( int i = 1; i <= 8; i++ )
            {
                ...
                map.put( "cashValue", editorUtil.convertToString( rate[ i - 1 ].multiply( cepr01030102Form.getTotalSumInsured() ).multiply( CommonConst.PER_MIL ) ) );
                map.put( "nonAccidentBenefit", editorUtil.convertToString( nonAccidentBenefit[ i - 1 ].multiply( cepr01030102Form.getTotalSumInsured() ) ) );
                map.put( "accidentBenefit", editorUtil.convertToString( accidentBenefit[ i - 1 ].multiply( cepr01030102Form.getTotalSumInsured() ) ) );
                mapList.add( map );
            }
...
//            params.put( "placeAndDate", "Jakarta, " + FormatDate.toIndonesian( eproposalManager.selectNowDate() ) );
    ...
    {
        logger.info( "*-*-*-* Cepr01040106DownloadController.getCommonHeaderRowList" );

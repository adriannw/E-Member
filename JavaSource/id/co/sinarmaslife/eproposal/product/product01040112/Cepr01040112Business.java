...
public class Cepr01040112Business extends Cepr01040000ProductBusiness
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040112Business( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command )
    {
    ...
    {
        logger.info( "*-*-*-* Cepr01040112DownloadController.getCommonHeaderRowList" );
        ...
        params.put( "content", "5% dari Uang Pertanggungan" );
        result.add( params );
    ...
    {
        logger.info( "*-*-*-* Cepr01040112Business.getDetailList" );

        double[] cashRate = { 0.98, 1.04, 1.09, 1.17, 1.34 };
        double[] nonAccBenefitRate = { 1.1, 1.8, 1.8, 1.8, 1.8 };
        double[] accBenefitRate = { 2.0, 2.0, 2.0, 2.0, 2.0 };
        double[] stageBonusRate = { 0.0, 0.0, 0.0, 0.0, 0.05 };

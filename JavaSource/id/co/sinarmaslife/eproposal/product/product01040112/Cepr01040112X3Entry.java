...
public class Cepr01040112X3Entry extends Cepr01040000Entry implements Cepr01040000EntryInterface
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040112X3Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
        super( eproposalManager, editorUtil, command, errors );
        logger.info( "*-*-*-* Cepr01040112X3Entry constructor is called ..." );
        setDownloadUrl( "wepr01040112.pdf" );
    }

    public void initDisplayedForm()
    {
        logger.info( "*-*-*-* Cepr01040112X3Entry.initDisplayedForm" );
        displayStandardForm();
    ...
    {
        logger.info( "*-*-*-* Cepr01040112X3Entry.initDisabledForm" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040112X3Entry.initReadOnlyForm" );
        readOnlyAllForm( false );
    }

    public void fillDefaultValueEachTimeRightPartOfBusinessCdChanged()
    {
        logger.info( "*-*-*-* Cepr01040112X3Entry.fillDefaultValueEachTimeRightPartOfBusinessCdChanged" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040112X3Entry.fillDefaultValueEachTimeFormCalled" );
    }

    public void validateCurrentPage()
    {
        logger.info( "*-*-*-* Cepr01040112X3Entry.validateCurrentPage" );
    ...
    {
        logger.info( "*-*-*-* Cepr01040112X3Entry.validatePreviousPage" );
        commonValidator.validateInsuredAge( Cepr01030102FormConst.ASSURANCE_PLAN_CD, 1, 60 );
    }

    public void processFormAfterSubmitBeforeValidation()
    {
        logger.info( "*-*-*-* Cepr01040112X3Entry.processFormAfterSubmitBeforeValidation" );

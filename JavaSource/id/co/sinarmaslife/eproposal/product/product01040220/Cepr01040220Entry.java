...
public class Cepr01040220Entry extends Cepr01040000UlinkEntry implements Cepr01040000EntryInterface
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040220Entry( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command, Errors errors )
    {
        super( eproposalManager, editorUtil, command, errors );
        setDownloadUrl( "wepr01040220.pdf" );
    } 
    ...
    public void initDisplayedForm()
    {
        ...
        if( Cepr01040220Mapper.X2 == cepr01030102Form.getRightPartOfBusinessCd())
        {
        ...
        if( Cepr01040220Mapper.X1 == cepr01030102Form.getRightPartOfBusinessCd() || Cepr01040220Mapper.X5 == cepr01030102Form.getRightPartOfBusinessCd())
        {
        ...
        else if( Cepr01040220Mapper.X2 == cepr01030102Form.getRightPartOfBusinessCd() )
        {
        	 cepr01030103Form.setWaiverTpdCiDisplay( CommonConst.DISPLAY_TRUE);
        ...
        else if( Cepr01040220Mapper.X3 == cepr01030102Form.getRightPartOfBusinessCd() )
        {
        	 cepr01030103Form.setPayorTpdDeathDisplay( CommonConst.DISPLAY_FALSE );
             cepr01030103Form.setPayorCiDeathDisplay( CommonConst.DISPLAY_FALSE );
             cepr01030103Form.setPayorCiDisplay( CommonConst.DISPLAY_FALSE );
        ...
        else if( Cepr01040220Mapper.X4 == cepr01030102Form.getRightPartOfBusinessCd() )
        {
        	 cepr01030103Form.setPayorTpdDeathDisplay( CommonConst.DISPLAY_FALSE );
             cepr01030103Form.setPayorCiDeathDisplay( CommonConst.DISPLAY_FALSE );
             cepr01030103Form.setPayorCiDisplay( CommonConst.DISPLAY_FALSE );
        ...
        if( credentialsVO.getGroupId() != null && credentialsVO.getGroupId().equals(Hardcode.GROUP_MNC)){
        	 cepr01030102Form.setEducationPackageListDisplay( CommonConst.DISPLAY_FALSE );
        	  ...
        	  if( Cepr01040220Mapper.X1 == cepr01030102Form.getRightPartOfBusinessCd() || Cepr01040220Mapper.X3 == cepr01030102Form.getRightPartOfBusinessCd() )
              {
        		  cepr01030102Form.setSpecialOfferListDisplay( CommonConst.DISPLAY_FALSE );
              }
              else if( Cepr01040220Mapper.X2 == cepr01030102Form.getRightPartOfBusinessCd() || Cepr01040220Mapper.X4 == cepr01030102Form.getRightPartOfBusinessCd() )
              {
        	...
        	if( cepr01030102Form.getLeftPartOfBusinessCd() == 159 ){// ekalink family
	        	 if( Cepr01040220Mapper.X1 == cepr01030102Form.getRightPartOfBusinessCd() )
	             {
    ...
    public void initDisabledForm()
    {
        ...
        cepr01030102Form.setExtraPremiumIsDisabled( CommonConst.DISABLED_FALSE );
...
//		 (Helpdesk 56020): Bridge Agency
    ...
    public void fillDefaultValueEachTimeRightPartOfBusinessCdChanged()
    {
        ...
        if( Cepr01040220Mapper.X1 == cepr01030102Form.getRightPartOfBusinessCd() ||  Cepr01040220Mapper.X3 == cepr01030102Form.getRightPartOfBusinessCd() || Cepr01040220Mapper.X5 == cepr01030102Form.getRightPartOfBusinessCd()){
            cepr01030102Form.setPremiumFurloughYear( 1 );
            cepr01030102Form.setPaymentModeCd( Hardcode.PAY_MODE_CD_SEKALIGUS );        
           
        }
        else if( Cepr01040220Mapper.X2 == cepr01030102Form.getRightPartOfBusinessCd() || Cepr01040220Mapper.X4 == cepr01030102Form.getRightPartOfBusinessCd() || Cepr01040220Mapper.X6 == cepr01030102Form.getRightPartOfBusinessCd()) {
    ...
    public void fillDefaultValueEachTimeFormCalled()
    {
        ...
        if( cepr01030102Form.getPremium() != null  && cepr01030102Form.getPaymentModeCd().equals( Hardcode.PAY_MODE_CD_BULANAN ) ){
        	...
        	if( premi >= 150000.0 && premi <= 250000){
        		if(Cepr01040220Mapper.X6 == cepr01030102Form.getRightPartOfBusinessCd()){
        			cepr01030102Form.setPremiumCombinationList( LookupList.getPremiumCombination5FoldedList().subList(6, 15) );
        		}else{
        			cepr01030102Form.setPremiumCombinationList( LookupList.getPremiumCombinationFoldedStart70List(10) );
        		}
        	}else{
        		if( Cepr01040220Mapper.X2 == cepr01030102Form.getRightPartOfBusinessCd()){
        			cepr01030102Form.setPremiumCombinationList( LookupList.getPremiumCombinationFoldedList(1).subList(10, 96));
        		}else if( Cepr01040220Mapper.X4 == cepr01030102Form.getRightPartOfBusinessCd()){
        			cepr01030102Form.setPremiumCombinationList( LookupList.getPremiumCombination5FoldedList().subList(2, 20) );
        		}
        	}        		
        }else{        	
        	if( Cepr01040220Mapper.X2 == cepr01030102Form.getRightPartOfBusinessCd()){
    			...
    			cepr01030102Form.setPremiumCombinationList( LookupList.getPremiumCombination5FoldedList().subList(2, 20) );
    		}else if( Cepr01040220Mapper.X6 == cepr01030102Form.getRightPartOfBusinessCd()){
    			cepr01030102Form.setPremiumCombinationList( LookupList.getPremiumCombination5FoldedList().subList(2, 15) );
    		}
        }               
        ...
        {        	
            ...
            if( Cepr01040220Mapper.X5 == cepr01030102Form.getRightPartOfBusinessCd())cepr01030102Form.setTotalSumInsuredIsDisabled( CommonConst.DISABLED_FALSE );
...
//		 (Helpdesk 56020): Bridge Agency
        if( Cepr01040220Mapper.X2 == cepr01030102Form.getRightPartOfBusinessCd() && CommonConst.DISPLAY_TRUE.equals(cepr01030102Form.getJenisListDisplay())){
    ...
    public void validateCurrentPage()
    {
        ...
        if( cepr01030102Form.getTotalSumInsured() != null )
        {
            ...
            if( Cepr01040220Mapper.X5 == cepr01030102Form.getRightPartOfBusinessCd() ){
            	 minTotalSumInsuredIdr = 15000000;
            	 minTotalSumInsuredUsd = 1500;
    ...
    public void processFormAfterSubmitBeforeValidation()
    {
        ...
        if( "onChangePremium".equals( cepr01030102Form.getTheEvent() )
        	|| ("onPressButtonPreviewProposal".equals( cepr01030102Form.getTheEvent() ) && (Cepr01040220Mapper.X3 == cepr01030102Form.getRightPartOfBusinessCd() || Cepr01040220Mapper.X1 == cepr01030102Form.getRightPartOfBusinessCd())) 
            ...
            || cepr01030102Form.getTotalSumInsured() != null && cepr01030102Form.getTotalSumInsured().equals( new BigDecimal( "0" ) ))                   
        {
            ...
            else if( Cepr01040220Mapper.X5 == cepr01030102Form.getRightPartOfBusinessCd())
            {
        ...
        if( Cepr01040220Mapper.X2 == cepr01030102Form.getRightPartOfBusinessCd() && CommonConst.DISPLAY_TRUE.equals(cepr01030102Form.getJenisListDisplay())){        	
         if(cepr01030102Form.getJenisCd() != null){
           	if(cepr01030102Form.getJenisCd()==27){
           		...
           		cepr01030102Form.setPaymentModeCd(6);
    ...
    public void validateCurrentPageInCommon()
    {
        ...
        switch( cepr01030102Form.getPaymentModeCd() )
        {
            ...
            case Hardcode.PAY_MODE_CD_TAHUNAN:
                ...
                minPremiumUsd = 180;
                if( Cepr01040220Mapper.X4 == cepr01030102Form.getRightPartOfBusinessCd()){
             	   minPremiumIdr = 1800000;
                    minPremiumUsd = 180; 
                }
                break;
        ...
        if( Cepr01040220Mapper.X2 == cepr01030102Form.getRightPartOfBusinessCd() || Cepr01040220Mapper.X4 == cepr01030102Form.getRightPartOfBusinessCd()) commonValidator.validatePremiumFurloughYear( Cepr01030102FormConst.PREMIUM_FURLOUGH_YEAR, 2, 20 );

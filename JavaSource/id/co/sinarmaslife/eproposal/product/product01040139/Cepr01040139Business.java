...
public class Cepr01040139Business extends Cepr01040000ProductBusiness
{
    protected final Log logger = LogFactory.getLog( getClass() );

    public Cepr01040139Business( EproposalManager eproposalManager, Cepr00000000EditorUtil editorUtil, Object command )
    {
    ...
    public BigDecimal computeManfaat( Integer payModeCd, Integer manfaatCd )
    {
      ...
      //Ibroy update New SMiLe Kids
        if( cepr01030102Form.getRightPartOfBusinessCd() >= Cepr01040139Mapper.X9 && cepr01030102Form.getRightPartOfBusinessCd() <= Cepr01040139Mapper.X12 ){       
        	sqlParams.put( "termOfPayment", cepr01030102Form.getPremiumFurloughYear() );        
        }else{
    ...
    public BigDecimal computeNT( Integer yearNo )
    {
        ...
        if( cepr01030102Form.getRightPartOfBusinessCd() > Cepr01040139Mapper.X24 && cepr01030102Form.getRightPartOfBusinessCd() <= Cepr01040139Mapper.X28 ){
      	  		sqlParams.put("plan", cepr01030102Form.getRightPartOfBusinessCd() - 20);
        }else if( cepr01030102Form.getRightPartOfBusinessCd() > Cepr01040139Mapper.X8 && cepr01030102Form.getRightPartOfBusinessCd() <= Cepr01040139Mapper.X12 ){
        	//NT SMile Kid Sub kode nya 208-37 s/d 208-40 Untuk MPP 10 tahun
        	//NT SMile Kid Sub kode nya 208-41 s/d 208-44 Untuk MPP 15 tahun
        	if( cepr01030102Form.getPremiumFurloughYearCd() == 10 ){
        		sqlParams.put("plan", cepr01030102Form.getRightPartOfBusinessCd() + 28);        		
        	}else if( cepr01030102Form.getPremiumFurloughYearCd() == 15 ){
      		  	sqlParams.put("plan", cepr01030102Form.getRightPartOfBusinessCd() + 32);        		
    	...
    	sqlParams.put("lamaBayar",null);
    	
        double nt = LazyConverter.toDouble(eproposalManager.selectNTKid(sqlParams)) * LazyConverter.toDouble(cepr01030102Form.getTotalSumInsured()) * 0.001 ;
        ...
        List<Map<String, Object>> result = new ArrayList<Map<String, Object>>();
          ...
          result.addAll( source.getPolicyHolderNameMap() );
            result.addAll( source.getPolicyHolderAgeMap() );
            	 ...
            	 param = new HashMap<String, Object>();            
            	 param.put( "label", "Cara Pembayaran Premi" );
            	 param.put( "content", label );
            	 result.add( param );
            	 
            	 param = new HashMap<String, Object>();            
            	 param.put( "label", "Masa Asuransi" );
            	// String date = FormatDate.toIndonesianWoClock( eproposalManager.selectNowDate() );
            	 String date = FormatDate.toIndonesianWoClock( eproposalManager.selectNowDate() );
            	 Map<String, Object> prm= new HashMap<String, Object>();  
            	 prm.put( "beginDate", eproposalManager.selectNowDate() );
          
            	 if(cepr01030101Form.getBabyFlag()!=CommonConst.CHECKED_FALSE){
                  	if(cepr01030101Form.getBabyFlag().equalsIgnoreCase(CommonConst.CHECKED_TRUE)){         	
                  		 prm.put( "noOfMonths", 264 - (12 * 0) );
                  	}
             	 }else{
             		prm.put( "noOfMonths", 264 - (12 * cepr01030101Form.getInsuredAge()) );
             	 }            
            	 Date dateTo2 = eproposalManager.selectAddMonths(prm);
            	 	  dateTo2 = FormatDate.add(dateTo2, Calendar.DATE, -1);
            	 String dateTo = FormatDate.toIndonesianWoClock( dateTo2 );            	 
            	 param.put( "content", date +" s/d "+ dateTo);
            	 result.add( param );                       
                    
             result.addAll( source.getTermOfContractWithLimitMap( 22 ) );
	             param = new HashMap<String, Object>();            
	        	 param.put( "label", "Uang Pertanggungan" );
	        	 cepr01030102Form.getTotalSumInsured().doubleValue(); 
	        	  String currencySymbol = MappingUtil.getLabel( cepr01030102Form.getCurrencyList(), cepr01030102Form.getCurrencyCd() );
	        	 param.put( "content",  currencySymbol + " " + editorUtil.convertToTwoDigit(cepr01030102Form.getTotalSumInsured()) );
	        	 result.add( param );  
    ...
    public List<Map<String, Object>> getBiayaList(String word, BigDecimal biaya, String cara_bayar) throws IOException
    {
    	List<Map<String, Object>> result = new ArrayList<Map<String, Object>>();
	    Map<String, Object> params = new HashMap<String, Object>();
	    params.put( "label", "-	Biaya Asuransi "+ word );
    ...
    public String getTipeMedisTT( Object command ) throws IOException
    {      
       return ( String ) of_cek_medis( command ).get( "medis_tt" ) ;
    }

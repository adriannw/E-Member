 ...
 * Function Id         	: 
 * Program Name   		: Cepr01040210DownloadController
 * Description         	: Excel Link 80 / Eka Link 80 (115)
 * Environment      	: Java  1.5.0_06
 * Author               : fadly mathendra
 * Version              : 1.0
 * Creation Date    	: Feb 8, 2008 2:26:26 PM
 *
...
public class Cepr01040210DownloadController extends StandardParent implements Controller
{
    ...
    {
        logger.info( "*-*-*-* Cepr01040210DownloadController.handleRequest" );
        ...
        Cepr01040210Business cepr01040210Business = new Cepr01040210Business( eproposalManager, editorUtil, command );

        ModelAndView result;
        if( request.getSession().getAttribute( "messageEkaSehatList" ) == null )
        {
        	List<String> messageEkaSehatList = cepr01040210Business.getEkaSehatMsgBox();
        ...
        {
            List<String> messageBoxList = cepr01040210Business.getMedicalMsgBox();
        ...
        else
        {
            ...
            jasperViewer.setUrl( "/WEB-INF/classes/" + "id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040210_product.jasper" );
            ...
            IllustrationResultVO illustrationResultVO = cepr01040210Business.getIllustrationResult();
            ...
            logger.info( "*-*-*-* cepr01040210Business.getInvestmentYield() = " + cepr01040210Business.getInvestmentYield() );
            params.put( "totalInvestmentAllocation", cepr01040210Business.getInvestmentYield().getTotalInvestmentAllocation() );
            params.put( "totalAssumptionLow", cepr01040210Business.getInvestmentYield().getTotalAssumptionLow() );
            params.put( "totalAssumptionMid", cepr01040210Business.getInvestmentYield().getTotalAssumptionMid() );
            params.put( "totalAssumptionHi", cepr01040210Business.getInvestmentYield().getTotalAssumptionHi() );

            params.put( "ciRiderManfaat", kursLabel + editorUtil.convertToRoundedTwoDigits(cepr01030102Form.getTotalSumInsured().multiply(new BigDecimal(0.5))));
            params.put( "dsCommonHeader", JasperReportsUtils.convertReportData( cepr01040210Business.getCommonHeaderRowList() ) );
            params.put( "dsCommonHeaderSmall", JasperReportsUtils.convertReportData( cepr01040210Business.getCommonHeaderSmallRowList() ) );
            params.put( "dsInvestmentChoice", JasperReportsUtils.convertReportData( cepr01040210Business.getInvestmentChoiceRowList() ) );
            params.put( "dsInvestmentChoiceSmall", JasperReportsUtils.convertReportData( cepr01040210Business.getInvestmentChoiceSmallRowList() ) );
            params.put( "dsMonthlyPremium", JasperReportsUtils.convertReportData( cepr01040210Business.getMonthlyPremiumList( cepr01030102Form, cepr01030101Form.getInsuredAge() ) ) );
            params.put( "dsInvestmentPerformance", JasperReportsUtils.convertReportData( cepr01040210Business.getInvestmentPerformanceList() ) );
            params.put( "dsInvestmentYield", JasperReportsUtils.convertReportData( cepr01040210Business.getInvestmentYield().getYieldList() ) );
            params.put( "dsOneRow", JasperReportsUtils.convertReportData( cepr01040210Business.getOneRowList() ) );
            params.put( "dsNoteSekaligus", JasperReportsUtils.convertReportData( cepr01040210Business.getNoteSekaligusRowList() ) );
            params.put( "dsNoteBerkala", JasperReportsUtils.convertReportData( cepr01040210Business.getNoteBerkalaRowList() ) );
            ...
            params.put( "dataSource", cepr01040210Business.getPageList( currentIdx ) );
          ...
          //  String fileName="testx.pdf";
            ...
            List temp = cepr01040210Business.getPageList( currentIdx );
            ...
            try{      
	        	   //if(cekDataApprovedOrNot.get(0).getPosisi()<3){
			            JasperUtils.exportReportToPdf(
			            		"id/co/sinarmaslife/eproposal/source/report/jasper/xepr_01040210_product.jasper",
			            		dirName,
			                fileName,
							params,
							temp,
    ...
    public void putRiderParam( Map<String, Object> params, List contentList, String dsParamName, String idxParamName )
    {
        ...
        if( source != null ){
        	...
        	if("dsRiderPayorTpdDeath".equals(dsParamName)){
        		params.put( dsParamName, "on" );
        		params.put( idxParamName, currentIdx.toString() + "." );
        	}else if("dsRiderWaiverTpd".equals(dsParamName)){
        		params.put( dsParamName, "on" );
        		params.put( idxParamName, currentIdx.toString() + "." );

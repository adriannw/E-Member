  ...
  <!--DWLayoutTable-->
	...
	<TR>
	  <TD ROWSPAN=4 style="background-image:url(${path}/include/images/web_proposal_12.jpg); ">&nbsp;			</TD>
		<TD height="40" colspan="9" class="fontLabel1 style2">Daftar Rumah Sakit Swine Flu (H1N1) </TD>
	    <TD ROWSPAN=4 style="background-image:url(${path}/include/images/web_proposal_15.jpg); ">&nbsp;			</TD>
	</TR>
	<TR>
	  <TD colspan="9" style="background-image:url(${path}/include/images/bg_form1.jpg); background-repeat:repeat-x; "><table width=100% cellpadding="3">
        <tr>
      ...
      <img src="${path}/include/images/RS_rujukan.jpg" width="837" height="4865" /> </TD>
	</TR>
	<TR>

...
<script type="text/javascript" src="${path}/include/js/top/cepr01030104JSP_top.js"></script>
	...
	<TR>
	  ...
	  <table>
        ...
        <tr>
            ...
            <td>&nbsp;</td>
            <td class="tdFormError">
                    <form:errors path="cepr01030104Form.totalTopupAmount"/>                    
                </td>
            <td>&nbsp;</td>
        </tr>

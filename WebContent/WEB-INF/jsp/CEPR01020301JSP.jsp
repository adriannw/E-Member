 ...
 <script type="text/javascript">
		...
		function checkEvent()
        {
            ...
            }else if( document.getElementById('theEvent').value == 'onPressButtonBack' )
            {
                ...
                document.getElementById('formpost').submit();
            }else if( document.getElementById('theEvent').value == 'onPressButtonChange' )
            {
		...
		function copy()
        {
        	var checkbox = document.getElementById('delAllRow');
        	var checkboxes = document.getElementById('chkArr');
...
<TABLE WIDTH=1280 BORDER=0 CELLPADDING=0 CELLSPACING=0>
  <!--DWLayoutTable-->
	...
	<TR>
	  <TD colspan="9" style="background-image:url(${path}/include/images/bg_form1.jpg); background-repeat:repeat-x; ">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td width="22%" align="left" style="background-color:#EAEAEA;">
                            	<form:select path="cepr01020301Form.noRow" cssClass="fontForm" onchange="document.getElementById('theEvent').value='onPressButtonSearch'; checkEvent();"
                        ...
                        <tr>
                            ...
                            <td align="left" style="background-color:#EAEAEA;">
                     			<form:select path="cepr01020301Form.lcaId" cssClass="fontForm" onchange="document.getElementById('theEvent').value='onPressButtonSearch'; checkEvent();"
                            ...
                            <td align="left" style="background-color:#EAEAEA;">
                     			<form:select path="cepr01020301Form.acPass" cssClass="fontForm" onchange="document.getElementById('theEvent').value='onPressButtonSearch'; checkEvent();"
        ...
        <tr>
            ...
            <td>
            	<a href="#" onclick="document.getElementById('theEvent').value='onPressButtonChange'; checkEvent();" onmouseover="changeButtonChangeToGlow();" onmouseout="changeButtonChangeToNormal();">
      ...
      <br style="font-size: 7px">
        ...
        <colgroup>
            ...
            <tbody>
                <tr>
					<td class="thead"><input type="checkbox" name="delAllRow" id="delAllRow" value="delAllRow" onclick="copy()" ></td>
                    ...
                    <td class="thead" ><a href="#" onclick="document.getElementById( 'sortRow' ).value = 'sortedByAccount'; document.getElementById('theEvent').value='onPressButtonSearch'; checkEvent()" ><font color="white">Account</font></a></td>
					...
					<td class="thead" ><a href="#" onclick="document.getElementById( 'sortRow' ).value = 'sortedByDivision'; document.getElementById('theEvent').value='onPressButtonSearch'; checkEvent()" ><font color="white">Nama Divisi</font></a></td>
					...
					<td class="thead" ><a href="#" onclick="document.getElementById( 'sortRow' ).value = 'sortedByRegion'; document.getElementById('theEvent').value='onPressButtonSearch'; checkEvent()" ><font color="white">Nama Region</font></a></td>
                    ...
                    <td class="thead" ><a href="#" onclick="document.getElementById( 'sortRow' ).value = 'sortedByTgl'; document.getElementById('theEvent').value='onPressButtonSearch'; checkEvent()" ><font color="white">Tanggal Lahir</font></a></td>
                </tr>
                <tr>
				...
				<td align="center">
					<c:choose>
        				<c:when test='${"checked" == ViewListAgent.flag}'>
        					<input type="checkbox" checked="checked" name="chkArr" id="chkArr" value="${ViewListAgent.msagId},${ViewListAgent.groupId},${ViewListAgent.idAccount}" onclick="document.getElementById( 'isCheckEvent' ).value = true" >
        				</c:when>
        				<c:otherwise>
        					<input type="checkbox" name="chkArr" id="chkArr" value="${ViewListAgent.msagId},${ViewListAgent.groupId},${ViewListAgent.idAccount}" onclick="document.getElementById( 'isCheckEvent' ).value = true" >
        				</c:otherwise>
    				</c:choose>
                </td>
                <td class="fontForm">
	  ...
	  <table width="100%" cellpadding="2">
        ...
        <tr>
            ...
            <td width= align="right" class="fontForm">Go
                <input name="cPage" id="cPage" type="text" style="width:45px" maxlength="4" class="fontForm"/>
			<td>
                <a href="#" onclick="document.getElementById('theEvent').value='onPressButtonSearch'; checkEvent();" onmouseover="changeButtonGoToGlow();" onmouseout="changeButtonGoToNormal();">
			...
			<td style="font-family: Arial; font-size: 11px;">
                ...
                <c:choose>
        			...
        			<c:otherwise>
               			<a href="#"  onclick="document.getElementById('cPage').value='${cepr01020000HoldingForm.cepr01020301Form.firstPage}'; document.getElementById('theEvent').value='onPressButtonSearch'; checkEvent()">First</a> | 
                		<a href="#"  onclick="document.getElementById('cPage').value='${cepr01020000HoldingForm.cepr01020301Form.previousPage}'; document.getElementById('theEvent').value='onPressButtonSearch'; checkEvent()">Prev</a> | 
                	</c:otherwise>
                </c:choose>
                ...
                <c:choose>
        			...
        			<c:otherwise>
               			<a href="#"  onclick="document.getElementById('cPage').value='${cepr01020000HoldingForm.cepr01020301Form.nextPage}'; document.getElementById('theEvent').value='onPressButtonSearch'; checkEvent()">Next</a> | 
                		 <a href="#"  onclick="document.getElementById('cPage').value='${cepr01020000HoldingForm.cepr01020301Form.lastPage}'; document.getElementById('theEvent').value='onPressButtonSearch'; checkEvent()">Last</a> 
                	</c:otherwise>
                </c:choose>
	...
	<TR>
		<TD height="100" COLSPAN=13 style="background-image:url(${path}/include/images/web_proposal_41.jpg); ">			<div align="center" class="fontBot">Copyright &copy; 2008 PT MSIG Life Insurance Indonesia Tbk All Right Reserved.<br>

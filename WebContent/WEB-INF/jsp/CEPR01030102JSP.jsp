...
<script type="text/javascript" src="${path}/include/js/top/cepr01030102JSP_top.js"></script>
...
function cTrig(clickedid) { 
   var box= confirm("Syarat pengajuan untuk Tabel Medis VIP: \n\n 1.	Minimal premi regular di-Setahunkan 100juta. "
   +"\n 2.	Penghasilan > 2M per tahun yang dapat dibuktikan dengan SPT, Bank reference, Mutasi rekening 3 bulanan, Slip Gaji,\n\tLaporan Laba Rugi atau Neraca Perusahaan." 
   +"\n 3.	Bagi anak usia dibawah 18 tahun, Mahasiswa dan IRT tanpa penghasilan tetap tidak bisa mendapatkan manfaat ini." 
   +"\n 4.	Perhitungan simultan Uang Pertanggungan untuk penentuan tipe medis yang diperhitungkan dengan produk atau polis lama\n\tdi PT Asuransi Jiwa Sinarmas MSIG Tbk. berlaku dalam waktu 2 tahun terbit polis."
   +"\n 5.	Apabila nasabah memiliki riwayat penyakit atau gangguan kesehatan atau pada polis sebelumnya pernah diberikan keputusan\n\tsubstandard atau ditunda pada pengajuan sebelumnya maka UW tetap berhak meminta pemeriksaan medis tambahan sesuai kondisi,\n\tmeskipun UP dalam tabel medis VIP dinyatakan Non Medis (NM)."
   +"\n 6.	Ketentuan ini hanya berlaku untuk bisnis Konvensional.");
   ...
   <c:if test="${cepr01030000HoldingForm.credentialsVO.msagId != '999993'}">
	<tr>
		...
		<TD COLSPAN=3 style="background-image:url(${path}/include/images/web_proposal_03.jpg); background-repeat:repeat-x; background-position:bottom;"><div align="center">
		  <p class="fontUp">WELCOME TO MSIG LIFE E-PROPOSAL [${sessionScope.deebee}]</p>
		</div></TD>
...
<tr style="display: ${cepr01030000HoldingForm.cepr01030102Form.flagOfVIPDisplay}">
<td width="130" height="33" class="fontForm"><div align="right"><fmt:message key="words.flagOfVIP"/> :</div></td>
    	  <td height="30"><div align="left">
               <form:checkbox  path="cepr01030102Form.flagOfVIP" cssClass="fontForm" value="true" id="check1" onchange="cTrig('check1')" disabled="${cepr01030000HoldingForm.cepr01030102Form.flagOfVIPIsDisabled}" />
               
           </div></td>
		<td width="257" class="tdFormError">
       		<form:errors path="cepr01030102Form.flagOfVIP"/>
   	   </td> 
</tr>
...
&nbsp;&nbsp;&nbsp;&nbsp; <form:errors path="cepr01030102Form.fixIdr" cssClass="tdFormError"/> </td>
	  ...
	  <c:choose>
     <c:when test="${(cepr01030000HoldingForm.cepr01030102Form.leftPartOfBusinessCd == '134' && (cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '5' || cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd >= '12' || cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '7' || cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '8' )) 
     			  || (cepr01030000HoldingForm.cepr01030102Form.leftPartOfBusinessCd == '220' && (cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '4' || cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '1' || cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '2')) 
     			  || (cepr01030000HoldingForm.cepr01030102Form.leftPartOfBusinessCd == '190' && (cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '7' || cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '8' ))
    			  || (cepr01030000HoldingForm.cepr01030102Form.leftPartOfBusinessCd == '118' && (cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '3' || cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '4'))
    			  || (cepr01030000HoldingForm.cepr01030102Form.leftPartOfBusinessCd == '120' && (cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '22' ||cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '23' || cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '24')&& cepr01030000HoldingForm.cepr01030102Form.currencyCd == '01')
    			  }">
     	  <tr style="display: ${cepr01030000HoldingForm.cepr01030102Form.fixIdrDisplay}">
...
&nbsp;&nbsp;&nbsp;&nbsp; <form:errors path="cepr01030102Form.dynamicIdr" cssClass="tdFormError" /> </td>
    ...
    <c:choose>
     	<c:when test="${(cepr01030000HoldingForm.cepr01030102Form.leftPartOfBusinessCd == '134' && (cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '5' || cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd >= '12' || cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '7' || cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '8')) 
     	|| (cepr01030000HoldingForm.cepr01030102Form.leftPartOfBusinessCd == '220' && (cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '4' || cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '1' || cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '2')) 
     	|| (cepr01030000HoldingForm.cepr01030102Form.leftPartOfBusinessCd == '190' && (cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '7' || cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '8' || cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '3' || cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '4'))
      	|| (cepr01030000HoldingForm.cepr01030102Form.leftPartOfBusinessCd == '116' && (cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '3' || cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '4')) || (cepr01030000HoldingForm.cepr01030102Form.leftPartOfBusinessCd == '217' && (cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '1')) 
      	|| (cepr01030000HoldingForm.cepr01030102Form.leftPartOfBusinessCd == '118' && (cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '3' || cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '4'))
      	|| (cepr01030000HoldingForm.cepr01030102Form.leftPartOfBusinessCd == '120' && (cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '22' ||cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '23' || cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '24')&& cepr01030000HoldingForm.cepr01030102Form.currencyCd == '01')
      	}">
     	<tr style="display: ${cepr01030000HoldingForm.cepr01030102Form.dynamicIdrDisplay}">
...
&nbsp;&nbsp;&nbsp;&nbsp; <form:errors path="cepr01030102Form.aggresiveIdr" cssClass="tdFormError"/> </td>
   ...
   <c:choose>
     	<c:when test="${ ((cepr01030000HoldingForm.cepr01030102Form.leftPartOfBusinessCd == '134' && cepr01030000HoldingForm.cepr01030102Form.currencyCd == '01')  && (cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '5' || cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '10' || cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd >= '12' || cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '7' || cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '8')) 
     	|| (cepr01030000HoldingForm.cepr01030102Form.leftPartOfBusinessCd == '220' && cepr01030000HoldingForm.cepr01030102Form.currencyCd == '01' && (cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '4' || cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '1' || cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '2') )
     	|| (cepr01030000HoldingForm.cepr01030102Form.leftPartOfBusinessCd == '190' && cepr01030000HoldingForm.cepr01030102Form.currencyCd == '01' && (cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '7' || cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '8' ))
     	|| ( cepr01030000HoldingForm.cepr01030102Form.leftPartOfBusinessCd == '118' && (cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '3' || cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '4') && cepr01030000HoldingForm.cepr01030102Form.currencyCd == '01') 
		|| (cepr01030000HoldingForm.cepr01030102Form.leftPartOfBusinessCd == '120' && (cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '22' ||cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '23' || cepr01030000HoldingForm.cepr01030102Form.rightPartOfBusinessCd == '24')&& cepr01030000HoldingForm.cepr01030102Form.currencyCd == '01')
     	}">
     	<tr style="display:''">
    ...
    <form:input path="cepr01030102Form.cashFundIdr" cssClass="fontForm" cssStyle="width: 35px;" disabled="${cepr01030000HoldingForm.cepr01030102Form.cashFundIdrIsDisabled}" onfocus="showForm( 'cashFundIdrHelper', 'true' ); showForm( 'cashFundIdrListDisplayHelper', 'true' );" onblur="showForm( 'cashFundIdrHelper', 'false' );" onchange="this.value=formatCurrency( this.value );" onkeyup="showFormatCurrency('cashFundIdrHelper', this.value);"/>% <span id="cashFundIdrListDisplayHelper" style="display: none;"> <span id="cepr01030102Form.cashFundIdrListDisplay" style="display: ${cepr01030000HoldingForm.cepr01030102Form.cashFundIdrListDisplay}"> <form:select path="cepr01030102Form.cashFundIdrCd" cssClass="fontForm"
                     ...
                     onchange="document.getElementById( 'cepr01030102Form.cashFundIdr' ).value = document.getElementById( 'cepr01030102Form.cashFundIdrCd' ).value;
                               showFormatCurrency('cashFundIdrHelper', this.value);
...
&nbsp;&nbsp;&nbsp;&nbsp; <form:errors path="cepr01030102Form.cashFundIdr" cssClass="tdFormError"/> </td>
  ...
  <tr style="display: ${cepr01030000HoldingForm.cepr01030102Form.excellinkEquityIdrDisplay}">
 	
     		<td class="tdFormLabel"><fmt:message key="words.excellinkEquity"/> : </td>  
  
    <td colspan="3" style="font-size: 11px; font-family:Arial;">
    
    <span id="cepr01030102Form.ljiExcellinkEquityDisplay" style="display: ${cepr01030000HoldingForm.cepr01030102Form.ljiExcellinkEquityDisplay}">
      <form:select path="cepr01030102Form.ljiExcellinkEquityCd" cssClass="fontForm" cssStyle="width: 160px;"
                     items="${cepr01030000HoldingForm.cepr01030102Form.ljiExcellinkEquityList}"
                     itemLabel="label"
                     itemValue="value"
                     disabled="${cepr01030000HoldingForm.cepr01030102Form.ljiExcellinkEquityIsDisabled}"
                    /></span> 
    <form:input path="cepr01030102Form.excellinkEquityIdr" cssClass="fontForm" cssStyle="width: 35px;" disabled="${cepr01030000HoldingForm.cepr01030102Form.excellinkEquityIsDisabled}" onfocus="showForm( 'excellinkEquityIdrHelper', 'true' ); showForm( 'excellinkEquityIdrListDisplayHelper', 'true' );" onblur="showForm( 'excellinkEquityIdrHelper', 'false' );" onchange="this.value=formatCurrency( this.value );" onkeyup="showFormatCurrency('excellinkEquityIdrHelper', this.value);"/>% <span id="excellinkEquityIdrListDisplayHelper" style="display: none;"> <span id="cepr01030102Form.excellinkEquityIdrListDisplay" style="display: ${cepr01030000HoldingForm.cepr01030102Form.excellinkEquityListDisplay}"> <form:select path="cepr01030102Form.excellinkEquityIdrCd" cssClass="fontForm"
                     items="${cepr01030000HoldingForm.cepr01030102Form.excellinkEquityIdrList}"
                     itemLabel="label"
                     itemValue="value"
                     disabled="${cepr01030000HoldingForm.cepr01030102Form.excellinkEquityIdrListIsDisabled}"
                     onchange="document.getElementById( 'cepr01030102Form.excellinkEquityIdr' ).value = document.getElementById( 'cepr01030102Form.excellinkEquityIdrCd' ).value;
                               showFormatCurrency('excellinkEquityIdrHelper', this.value);
                               document.getElementById( 'cepr01030102Form.excellinkEquityIdrListDisplay' ).focus();"
                     onblur="showForm( 'excellinkEquityIdrListDisplayHelper', 'false' );"
                /> </span> </span>
        <input type="text" id="excellinkEquityIdrHelper" disabled="disabled" style="display: none; width: 35px; font-family:Arial; font-size:11px" tabindex="-1"/>
&nbsp;&nbsp;&nbsp;&nbsp; <form:errors path="cepr01030102Form.excellinkEquityIdr" cssClass="tdFormError"/> </td>
  </tr>  
...
&nbsp;&nbsp;&nbsp;&nbsp; <form:errors path="cepr01030102Form.dynamicUsd" cssClass="tdFormError"/> </td>
  ...
  <!-- new fund 2021 -->
  <tr style="display: ${cepr01030000HoldingForm.cepr01030102Form.aggresiveUsdDisplay}"> 
    
      <td class="tdFormLabel"><fmt:message key="words.aggresive"/>$ : </td>  
      <td colspan="3" style="font-size: 11px; font-family:Arial;">    
    <span id="cepr01030102Form.ljiAggresiveUsdListDisplay" style="display: ${cepr01030000HoldingForm.cepr01030102Form.ljiAggresiveUsdListDisplay}">  
        <form:select path="cepr01030102Form.ljiAggresiveUsdCd" cssClass="fontForm" cssStyle="width: 160px;"
                     items="${cepr01030000HoldingForm.cepr01030102Form.ljiAggresiveUsdList}"
                     itemLabel="label"
                     itemValue="value"
                     disabled="${cepr01030000HoldingForm.cepr01030102Form.ljiAggresiveUsdListIsDisabled}"                    
                    /></span>
        <form:input path="cepr01030102Form.aggresiveUsd" cssClass="fontForm" cssStyle="width: 35px;" 
        disabled="${cepr01030000HoldingForm.cepr01030102Form.aggresiveUsdIsDisabled}" 
        onfocus="showForm( 'aggresiveUsdHelper', 'true' ); showForm( 'aggresiveUsdListDisplayHelper', 'true' );" 
        onblur="showForm( 'aggresiveUsdHelper', 'false' );" 
        onchange="this.value=formatCurrency( this.value );" 
        onkeyup="showFormatCurrency('aggresiveUsdHelper', this.value);"/>% <span id="aggresiveUsdListDisplayHelper" style="display: none;"> <span id="cepr01030102Form.aggresiveUsdListDisplay" style="display: ${cepr01030000HoldingForm.cepr01030102Form.aggresiveUsdListDisplay}"> <form:select path="cepr01030102Form.aggresiveUsdCd" cssClass="fontForm"
                     items="${cepr01030000HoldingForm.cepr01030102Form.aggresiveUsdList}"
                     itemLabel="label"
                     itemValue="value"
                     disabled="${cepr01030000HoldingForm.cepr01030102Form.aggresiveUsdListIsDisabled}"
                     onchange="document.getElementById( 'cepr01030102Form.aggresiveUsd' ).value = document.getElementById( 'cepr01030102Form.aggresiveUsdCd' ).value;
                               showFormatCurrency('aggresiveUsdHelper', this.value);
                               document.getElementById( 'cepr01030102Form.aggresiveUsdListDisplay' ).focus();"
                     onblur="showForm( 'aggresiveUsdListDisplayHelper', 'false' );"
                /> </span> </span>
        <input type="text" id="aggresiveUsdHelper" disabled="disabled" style="display: none; width: 35px; font-family:Arial; font-size:11px" tabindex="-1"/>
&nbsp;&nbsp;&nbsp;&nbsp; <form:errors path="cepr01030102Form.aggresiveUsd" cssClass="tdFormError"/> </td>
  </tr>
      </table>
      <p>&nbsp;</p></TD>
  </tr>
...
<script type="text/javascript" src="${path}/include/js/bottom/cepr01030102JSP_bottom.js"></script>
</BODY>

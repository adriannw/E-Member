...
-->
 ...
 <script type="text/javascript">
		...
		function checkEvent()
        {
            if( document.getElementById('theEvent').value == 'onPressButtonGroup' )
            {
                document.getElementById('targetParam').name = CEPR01020201JSP;
                document.getElementById('formpost').submit();
            }
            else if( document.getElementById('theEvent').value == 'onPressButtonAgent' )
            {
                document.getElementById('targetParam').name = CEPR01020301JSP;
                document.getElementById('formpost').submit();
            }
            else if( document.getElementById('theEvent').value == 'onPressButtonConsole' )
            {
...
<TABLE WIDTH=100% BORDER=0 CELLPADDING=0 CELLSPACING=0>
  <!--DWLayoutTable-->
	...
	<TR>
      ...
      <p>&nbsp;</p>
	  <p class="fontForm"><a href="#" onclick="document.getElementById('theEvent').value='onPressButtonGroup'; checkEvent();"><b>Maintain Access Group</b></a></p>
	  <p class="fontForm"><a href="#" onclick="document.getElementById('theEvent').value='onPressButtonAgent'; checkEvent();"><b>Maintain Agent Products Access</b></a></p>
	  <p class="fontForm"><a href="#" onclick="document.getElementById('theEvent').value='onPressButtonConsole'; checkEvent();"><b>Console</b></a></p>
		<p>&nbsp;</p>
	           </TD>
	</TR>
	<TR>

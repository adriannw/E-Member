...
<script type="text/javascript" src="${path}/include/js/top/cepr01030111JSP_top.js"></script>
	...
	<TR>
        ...
        <c:forEach var="participantVO" items="${cepr01030000HoldingForm.cepr01030111Form.participantVOList}" varStatus="xt">
            <tr>
                ...
                <td>
                    <form:input path="cepr01030111Form.participantVOList[${xt.index}].age" cssClass="fontForm" cssStyle="width: 20px"/>
                </td>
                <td>

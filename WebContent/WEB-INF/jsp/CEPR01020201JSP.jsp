 ...
 <script type="text/javascript">
		...
		function checkEvent()
        {
            ...
            }else if( document.getElementById('theEvent').value == 'onPressButtonBack' )
            {
                ...
                document.getElementById('formpost').submit();
            }else if( document.getElementById('theEvent').value == 'onPressButtonAddGroup' )
            {
                document.getElementById('targetParam').name = CEPR01020201JSP;
                document.getElementById('formpost').submit();
            }else if( document.getElementById('theEvent').value == 'onPressButtonDeleteGroup' )
            {
                document.getElementById('targetParam').name = CEPR01020201JSP;
                document.getElementById('formpost').submit();
            }else if( document.getElementById('theEvent').value == 'onPressButtonChange' )
            {
                document.getElementById('targetParam').name = CEPR01020201JSP;
                document.getElementById('formpost').submit();
            }else if( document.getElementById('theEvent').value == 'onSelectRow' )
            {
	...
	<TR>
	  <TD colspan="9" style="background-image:url(${path}/include/images/bg_form1.jpg); background-repeat:repeat-x; ">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td width="22%" align="left" style="background-color:#EAEAEA;">
                            	<form:select path="cepr01020201Form.noRow" cssClass="fontForm" onchange="document.getElementById('theEvent').value='onPressButtonSearch'; checkEvent();"
		  ...
		  <table width=100% cellpadding="3">
            ...
            <td style="width: 12%">
            	<a href="#" onclick="document.getElementById('theEvent').value='onPressButtonAddGroup'; checkEvent();" onmouseover="changeButtonAddToGlow();" onmouseout="changeButtonAddToNormal();">
					<img src="${path}/include/images/bt_add.gif" alt="" style="border: 0;" id="buttonAddId">
				</a>
			</td>
			<td>
				<a href="#" onclick="document.getElementById('theEvent').value='onPressButtonDeleteGroup'; checkEvent();" onmouseover="changeButtonDeleteToGlow();" onmouseout="changeButtonDeleteToNormal();">
      ...
      <br style="font-size: 7px">
        ...
        <colgroup>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="thead" ><a href="#" onclick="document.getElementById( 'sortRow' ).value = 'sortedById'; document.getElementById('theEvent').value='onPressButtonSearch'; " ><font color="white">ID</font></a></td>
                    <td class="thead" ><a href="#" onclick="document.getElementById( 'sortRow' ).value = 'sortedByGroup'; document.getElementById('theEvent').value='onPressButtonSearch';" ><font color="white">Nama Group</font></a></td>
                </tr>
                <tr>
		...
		<c:forEach var="ViewListGroup" items="${allList}" varStatus="xt">
           ...
           <tr class="rowClass" style="background-color: ${backGroundColor};" onClick="document.getElementById( 'selectedGroupId' ).value = '${ViewListGroup.groupId}'; document.getElementById('theEvent').value='onSelectRow'; checkEvent()" onMouseOver="change_bgcolor( this, '#FFD6CA' );" onMouseOut="change_bgcolor(this, '${backGroundColor}')" valign="top" >
				<td align="center">
                	<input type="checkbox" name="chkArr" id="chkArr" value="${ViewListGroup.groupId}" onclick="document.getElementById( 'isCheckEvent' ).value = true" >
                </td>
                <td class="fontForm">
        ...
        <tr>
			...
			<td style="font-family: Arial; font-size: 11px;">
                ...
                <c:choose>
        			...
        			<c:otherwise>
               			<a href="#"  onclick="document.getElementById('cPage').value='${cepr01020000HoldingForm.cepr01020201Form.firstPage}'; document.getElementById('theEvent').value='onPressButtonSearch'; checkEvent()">First</a> | 
                		<a href="#"  onclick="document.getElementById('cPage').value='${cepr01020000HoldingForm.cepr01020201Form.previousPage}'; document.getElementById('theEvent').value='onPressButtonSearch'; checkEvent()">Prev</a> | 
                	</c:otherwise>
                </c:choose>
                ...
                <c:choose>
        			...
        			<c:otherwise>
               			<a href="#"  onclick="document.getElementById('cPage').value='${cepr01020000HoldingForm.cepr01020201Form.nextPage}'; document.getElementById('theEvent').value='onPressButtonSearch'; checkEvent()">Next</a> | 
                		 <a href="#"  onclick="document.getElementById('cPage').value='${cepr01020000HoldingForm.cepr01020201Form.lastPage}'; document.getElementById('theEvent').value='onPressButtonSearch'; checkEvent()">Last</a> 
                	</c:otherwise>
                </c:choose>

...
<script type="text/javascript" src="${path}/include/js/top/cepr01010101JSP_top.js"></script>
<script type="text/javascript">
var path = '${path}';
var user = '${user}';
var pass = '${pass}';
var clickForLife = '${clickForLife}';
</script>
</head>
    ...
    <table>
        <tr>
            <td style="text-align: center;">
                <img src="${path}/include/images/MSIG_Logo.gif" alt="" style=""/>
            </td>
        </tr>
        <tr>
            <td style="text-align: center;">
                                    ...
                                    <td style="padding: 0; width: 350px;">
                                        <table cellspacing="0">
                                                    ...
                                                    <table cellspacing="0">
                                                        <tr>
                                                                ...
                                                                <table cellspacing="0">
                                                                    ...
                                                                    <tr style="display: ${cepr01010101Form.loginFormDisplay}; height: 35px; vertical-align: middle;">
                                                                        <td style="width: 80px; text-align: right;">
                                                                            ...
                                                                            <form:hidden path="theEvent" id="theEvent"></form:hidden>
                                                                        </td>
                                                                    ...
                                                                    <tr style="display: none; height: 35px; vertical-align: middle;">
                                                                        <td style="width: 80px; text-align: right;">
                                                                            <span style="font-family: sans-serif; font-variant: normal; font-size: 18px; font-weight: 300; color: #737373; text-align: right;">
                                                                                Jenis
                                                                            </span>
                                                                        ...
                                                                        <td style="padding-left: 15px;" align="left">
																			...
																			<form:radiobutton path="jenisUserCd" value="99" id="others"/> Others
																			</br>
																			<form:radiobutton path="jenisUserCd" value="8" id="sekuritas"/> Sinarmas Sekuritas 
                                                                        </td>
                                                                    </tr>
                                                            ...
                                                            <td style="padding-left: 15px; padding-top: 4px;">
                                                                <a href="#" onclick="document.getElementById('theEvent').value='onPressButtonOk'; doLogin();" onmouseover="changeButtonOkToOrange();" onmouseout="changeButtonOkToNormal();">
                                            ...
                                            <tr style="height: 20px;">
                                                <td style="padding: 0; width: 350px; background-image: url('${path}/include/images/accessories/bor-log-ajs-info.gif'); text-align: right;" colspan="3"><div align="left">
                                                	<span style="font-family: sans-serif; font-variant: normal; font-size: 12px; font-weight: 300; color: #737373; text-align: right; padding-right: 30px;">
                                                		&nbsp&nbsp&nbsp&nbsp MSIG Life Insurance IT Department [${sessionScope.deebee}]
                                                	</span>
                                                </div></td>
                                            </tr>
                                            ...
                                            <tr style="height: 15px;">
                                                <td style="padding: 0; width: 350px; background-image: url('${path}/include/images/accessories/bor-log-ajs-info.gif'); text-align: right;" colspan="3">
                                                    <span style="font-family: sans-serif; font-variant: normal; font-size: 12px; font-weight: 300; color: #737373; text-align: right; padding-right: 30px;">
                                                        Head Office: Sinarmas MSIG Tower Lantai 6
                                                    </span>
                                                </td>
                                            </tr>
                                            <tr style="height: 15px;">
                                            ...
                                            <tr style="height: 15px;">
                                                <td style="padding: 0; width: 350px; background-image: url('${path}/include/images/accessories/bor-log-ajs-info.gif'); text-align: right;" colspan="3">
                                                    <span style="font-family: sans-serif; font-variant: normal; font-size: 12px; font-weight: 300; color: #737373; text-align: right; padding-right: 30px;">
                                                        Telp CS: (021) 5060 9999 atau (021) 2650 8300
                                                    </span>
                                                </td>
                                            </tr>
                                            <tr style="height: 15px;">
        ...
        <tr>
            <td style="text-align: center; vertical-align: top; padding-top: 10px;">
                <span style="font-family: sans-serif; font-variant: normal; font-size: 11px; font-weight: 300; color: #737373; text-align: right; padding-right: 30px;">
                    Copyright &copy 2023 PT MSIG Life Insurance Indonesia Tbk All Right Reserved.
                </span>
            </td>
        </tr>
    </table>
...
<script type="text/javascript" src="${path}/include/js/bottom/cepr01010101JSP_bottom.js"></script>
</body>
</html>
...
-->
 ...
 var CEPR01030901JSP = '_target18';
		...
		function checkEvent()
        {
			...
			else if( document.forms[ 0 ].theEvent.value == 'onPreviewPercentPremiumFirstMonth' )
            {
                var percentPremiumCompany =  document.getElementById('cepr01030901Form.percentPremiumCompany').value;
           		var percentPremiumEmployee = document.getElementById('cepr01030901Form.percentPremiumEmployee').value;
           		var a= parseFloat(percentPremiumCompany);
           	
           		var b =parseFloat(percentPremiumEmployee);
           		var percentPremiumFirstMonth = (a+b);
           	    document.getElementById('cepr01030901Form.percentPremiumFirstMonth').value = formatCurrency(percentPremiumFirstMonth);           	
...
<tr>
    ...
    <td>
        <form:input path="cepr01030901Form.percentPremiumFirstMonth" cssClass="fontForm" size="1" onchange="this.value=formatCurrency( this.value );" readonly="true"/>
...
<tr>
    ...
    <td colspan="2">                      
      <form:input path="cepr01030901Form.percentPremiumCompany" cssClass="fontForm" size="1" onfocus="showForm( 'percentPremiumCompanyListDisplayHelper', 'true' );" onchange="this.value=formatCurrency( this.value ); document.forms[ 0 ].theEvent.value='onPreviewPercentPremiumFirstMonth'; checkEvent()" />
         <span class="tdFormLabel">% Gaji</span> 
        ...
        <span id="cepr01030901Form.percentPremiumCompanyListDisplay" style="display: ${cepr01030000HoldingForm.cepr01030901Form.percentPremiumCompanyListDisplay}">
            <form:select path="cepr01030901Form.percentPremiumCompanyCd"
                     ...
                     onchange="document.getElementById( 'cepr01030901Form.percentPremiumCompany' ).value = document.getElementById( 'cepr01030901Form.percentPremiumCompanyCd' ).value;                             
                               ...
                               document.forms[ 0 ].theEvent.value='onPreviewPercentPremiumFirstMonth'; checkEvent()"
...
<tr>
    ...
    <td>
         ...
         <form:input path="cepr01030901Form.percentPremiumEmployee" cssClass="fontForm" size="1" onfocus="showForm( 'percentPremiumEmployeeListDisplayHelper', 'true' );" onchange="this.value=formatCurrency( this.value ); document.forms[ 0 ].theEvent.value='onPreviewPercentPremiumFirstMonth'; checkEvent()" />
          <span class="tdFormLabel">% Gaji</span> 

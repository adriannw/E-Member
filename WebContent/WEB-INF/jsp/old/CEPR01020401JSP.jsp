 ...
 <script type="text/javascript">
		...
		function checkEvent()
        {
            ...
            }else if( document.forms[ 0 ].theEvent.value == 'onPressButtonBack' )
            {
                ...
                document.getElementById('formpost').submit();
            }else if( document.forms[ 0 ].theEvent.value == 'onPressButtonKick' )
            {
                document.getElementById('targetParam').name = CEPR01020401JSP;
                document.getElementById('formpost').submit();
            }else if( document.forms[ 0 ].theEvent.value == 'onPressButtonKickAllOffUsers' )
            {
                document.getElementById('targetParam').name = CEPR01020401JSP;
                document.getElementById('formpost').submit();
            }else if( document.forms[ 0 ].theEvent.value == 'onPressButtonPingIp' )
            {
                document.getElementById('targetParam').name = CEPR01020401JSP;
                document.getElementById('formpost').submit();
            }
	  ...
	  <TD colspan="9" style="background-image:url(${path}/include/images/bg_form1.jpg); background-repeat:repeat-x; ">
        ...
        <tr>
            <td align="left" class="fontForm" style="width: 11%">
                <input type="button" name="kickAllOffUser" class="fontForm" value="KICK ALL OFFLINE USERS" onclick="document.forms[ 0 ].theEvent.value='onPressButtonKickAllOffUsers'; document.forms[ 0 ].lusIdUser.value='${user.lus_id}'; checkEvent();"/>
            </td>
            <td>
      ...
      <br style="font-size: 7px">
		...
		<c:forEach var="user" items="${daftarUser}" varStatus="xt">
           ...
           <tr class="rowClass" style="background-color: ${backGroundColor};" onMouseOver="change_bgcolor( this, '#FFD6CA' );" onMouseOut="change_bgcolor(this, '${backGroundColor}')" valign="top" >
				<td class="fontForm">
					<input type="button" name="kickUser" class="fontForm" value="KICK" onclick="document.forms[ 0 ].theEvent.value='onPressButtonKick'; document.forms[ 0 ].lusIdUser.value='${user.lus_id}'; checkEvent();"/>
					<input type="button" name="pingUser" class="fontForm" value="PING" onclick="document.forms[ 0 ].theEvent.value='onPressButtonPingIp'; document.forms[ 0 ].ipAddressUser.value='${user.ip}'; checkEvent();"/>
                </td>
...
<script type="text/javascript">
	if( document.forms[ 0 ].ipAddressUserTemp.value != '' )
    {
    	alert(document.forms[ 0 ].ipAddressUserTemp.value);
    }
</script>
</form:form>

  ...
  <!--DWLayoutTable-->
	...
	<TR>
	  <TD ROWSPAN=5 style="background-image:url(${path}/include/images/web_proposal_12.jpg); ">&nbsp;			</TD>
		<TD height="40" colspan="9" class="fontLabel1 style2"><fmt:message key="words.createLetter"/>			</TD>
	    <TD ROWSPAN=5 style="background-image:url(${path}/include/images/web_proposal_15.jpg); ">&nbsp;			</TD>
	</TR>
	<TR>
		<TD height="24" class="fontLabel1"><fmt:message key="words.editLetter"/></TD>
		<TD COLSPAN=8>&nbsp;			</TD>
    </TR>
	<TR>
...
<tr>
    ...
    <td>
        <form:textarea path="cepr01030301Form.content" cssStyle="" rows="40" cols="110" cssClass="fontForm"/>
    </td>
...
<tr>
	...
	<TR>
		...
		<TD ><div align="center">
		<a href="#" onclick="document.forms[ 0 ].theEvent.value='onPressButtonPreviewLetter'; checkEvent()" onmouseover="changeButtonPreviewLetterToGlow();" onmouseout="changeButtonPreviewLetterToNormal();">
		<img src="${path}/include/images/bt_lihatsurat.gif"   alt="" style="border: 0;" id="buttonPreviewLetterId"> 
		</a>
		</div></TD>
		
		<TD COLSPAN=2><div align="center">
		<a href="#" onclick="document.forms[ 0 ].theEvent.value='onPressButtonResetLetterContent'; checkEvent();" onmouseover="changeButtonResetToGlow();" onmouseout="changeButtonResetToNormal();">
		<img src="${path}/include/images/bt_resetisisurat.gif"   alt="" style="border: 0;" id="buttonResetId">
		</a>
	    </div></TD>
		<TD><div align="center">

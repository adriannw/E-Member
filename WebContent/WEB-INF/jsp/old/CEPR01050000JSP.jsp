...
-->
 ...
 <script type="text/javascript">
		...
		function checkEvent()
        {
            ...
            {
                document.getElementById('targetParam').name = CEPR01050000JSP;
                document.getElementById('cepr01050000FormId').submit();
            }
...
<tr>
    ...
    <td>
        <form:input path="cepr01050000Form.customerName" cssClass="fontForm"/>
    </td>
    <td class="tdFormError">
        <form:errors path="cepr01050000Form.customerName"/>
    </td>
</tr>
<tr>
    <td class="tdFormLabel">
    ...
    <td>
        <form:input path="cepr01050000Form.agentName" cssClass="fontForm"/>
    </td>
    <td class="tdFormError">
        <form:errors path="cepr01050000Form.agentName"/>
    </td>
</tr>
<tr>
    <td class="tdFormLabel">
    ...
    <td>
        <form:input path="cepr01050000Form.branchName" cssClass="fontForm"/>
    </td>
    <td class="tdFormError">
        <form:errors path="cepr01050000Form.branchName"/>
    </td>
</tr>
<tr>
    <td class="tdFormLabel">
    ...
    <td>
        <form:input path="cepr01050000Form.homePhoneNo" cssClass="fontForm"/>
    </td>
    <td class="tdFormError">
        <form:errors path="cepr01050000Form.homePhoneNo"/>
    </td>
</tr>
<tr>
    <td class="tdFormLabel">
    ...
    <td>
        <form:input path="cepr01050000Form.mobilePhoneNo" cssClass="fontForm"/>
    </td>
    <td class="tdFormError">
        <form:errors path="cepr01050000Form.mobilePhoneNo"/>
    </td>
</tr>
...
<tr>
    <td colspan="3">
        ...
        <form:hidden path="cepr01050000Form.downloadFlag"/>
...
<script type="text/javascript">
    var downloadFlag = document.getElementById('cepr01050000Form.downloadFlag').value;
    if( downloadFlag == 'newPage' )
    {
        document.getElementById('cepr01050000Form.downloadFlag').value = '';
        document.getElementById('cepr01050000FormId').target = '_blank';
        document.getElementById('targetParam').name = CEPR00000000DownloadDocumentJSP;
        document.getElementById('cepr01050000FormId').submit();
        document.getElementById('cepr01050000FormId').target = '_self';
        document.getElementById('targetParam').name = CEPR01050000JSP;
        document.getElementById('cepr01050000FormId').submit();
    }
    ...
    {
        document.getElementById('cepr01050000Form.downloadFlag').value = '';
        document.getElementById('cepr01050000FormId').action='${downloadUrlSession}';
        document.getElementById('cepr01050000FormId').submit();
        document.getElementById('cepr01050000FormId').target = '_self';
    }
</script>

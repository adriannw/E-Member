...
//            }
           ...
           //  while(document.getElementById("namaAdminBCList").childNodes.length>0) 
			...
			var nm = document.getElementById('cariNamaAdminBC').value;
				ajax(nm, "nama", '${sessionScope.jn_bank}');              
           ...
           //  while(document.getElementById("namaAdminBCList").childNodes.length>0) 
			...
			var kd = document.getElementById('cariKodeAdminBC').value;
              ...
              ajax(kd, "kode", '${sessionScope.jn_bank}');
   ...
   <c:if test="${cepr01030000HoldingForm.credentialsVO.msagId != '999993'}">
	<TR>
	  ...
	  <TD style="background-image:url(${path}/include/images/web_proposal_03.jpg); background-repeat:repeat-x; background-position:bottom;">
		...
		<a href="${path}/wepr01010102.htm" onmouseover="changeButtonLogOffToGlow();" onmouseout="changeButtonLogOffToNormal();">
	...
	<TR>
	  <TD height="220" valign="top" style="background-image:url(${path}/include/images/bg_out.jpg); background-repeat:repeat-x; background-position:bottom;"><!--DWLayoutEmptyCell-->&nbsp;</TD>
		<TD COLSPAN=11>
			<IMG SRC="${path}/include/images/web_proposal_008.jpg" WIDTH=925 HEIGHT=220 ALT=""></TD>
	...
	<TR>		
		...
		<TD height="75" COLSPAN=5 class="fontLink" ><p class="style3">&nbsp;</p>
		  <p class="style3"><a href="#" onclick="document.getElementById('theEvent').value='onPressButtonPreviewLetter'; checkEvent();"><fmt:message key="main.createLetter"/></a></p>
		  <p class="style3"><a href="#" onclick="document.getElementById('theEvent').value='onPressButtonCreateCover'; checkEvent();"><fmt:message key="main.createCover"/></a></p>
		  <p class="style3"><a href="#" onclick="document.getElementById('theEvent').value='onPressButtonLookUpProvider'; checkEvent();"><fmt:message key="main.seeProvider"/></a></p>
		  <p class="style3"><a href="#" onclick="document.getElementById('theEvent').value='onPressButtonLookUpSwineFluProvider'; checkEvent();"><fmt:message key="main.seeSwineFluProvider"/></a></p>
		  <p class="style3"><a href="#" onclick="document.getElementById('theEvent').value='onPressButtonDownloadMedical'; checkEvent();"><fmt:message key="main.seeMedical"/></a></p>
		  <p class="style3"><a href="#" onclick="document.getElementById('theEvent').value='onPressButtonDownloadViewMedical'; checkEvent();"><fmt:message key="main.viewMedical"/></a></p>
		  <p class="style3"><a href="#" onclick="document.getElementById('theEvent').value='onPressButtonCreateDPLK'; checkEvent();"><fmt:message key="main.createDPLK"/></a></p>
		  <p class="style3"><a href="${path}/include/installer/full_sekuritas.exe" onclick="alert('cara install : \n 1. download file \n 2. klik kanan di file, run as administrator')" id="updateProduct" name="updateProduct" style="display: ${cepr01030000HoldingForm.cepr01030101Form.downloadLinkDisplay}"><fmt:message key="main.updateProduct"/></a></p>
	    <p style="font-size: 12px;"><fmt:message key="main.createProposal"/></p>
		<p>&nbsp;</p>
      </TD>	
		<TD height="65" COLSPAN=4 class="fontLink" >
		<table bgcolor="#FFF0E0"><tr><td>
			<p style="font-size: 12px;"><font color=darkred><b><fmt:message key="main.attention"/></b></font></p>
			<p style="font-size: 12px;">Mulai 1 Maret 2017 nasabah yang mengambil produk unitlink</p>		
			<p style="font-size: 12px;">wajib mengisi Form Profil Risiko Nasabah</p> </td></tr></table>
			<p>&nbsp;</p>
		  <p class="style3"><a href="#" onclick="document.getElementById('theEvent').value='onPressButtonDowloadRiskProfil'; checkEvent();"><fmt:message key="main.downloadRiskProfilNsbh"/></a></p>
	     <p class="style3"><a href="#" onclick="document.getElementById('theEvent').value='onPressButtonDownloadGuideRiskProfil'; checkEvent();"><fmt:message key="main.downloadGuideRiskProfilNsbh"/></a></p>
		 <p class="style3"><a href="#" onclick="document.getElementById('theEvent').value='onPressButtonDownloadGuideRiskProfil'; checkEvent();">Nasabah</a></p>
		<p>&nbsp;</p>
		</TD>
	...
	<TR>		
		<TD height="48" COLSPAN=8 class="fontLabel1 style2"><fmt:message key="words.proposalData"/></TD>	
    </TR>
	<TR>
		...
		<TD height="170" colspan="9" style="background-image:url(${path}/include/images/bg_form1.jpg); background-repeat:repeat-x; ">
	      ...
	      <table width="600" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td width="213" height="33">              <div align="left">
                <form:input path="cepr01030101Form.policyHolderBirthDay" onchange="copyToInsured();" size="15" maxlength="10"  title="Tanggal Lahir Pemegang Polis [format: dd/mm/yyyy (d=date, m=month, y=year)]" onblur="calculateAge('cepr01030101Form.policyHolderBirthDay','cepr01030101Form.policyHolderAge');"  />
              	dd/mm/yyyy
              </div></td>
          ...
          <table width="600" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td height="33"><div align="left">
              	<form:input path="cepr01030101Form.insuredBirthDay"  size="15" maxlength="10"  title="Tanggal Lahir Tertanggung [format: dd/mm/yyyy (d=date, m=month, y=year)]" onblur="calculateAge('cepr01030101Form.insuredBirthDay','cepr01030101Form.insuredAge');"  />
              	dd/mm/yyyy
              </div></td>
			  <td width="257" class="tdFormError">
            ...
            <tr>           
             <td width="130" height="33" class="fontForm"><div align="right"><fmt:message key="words.calonBaby"/> :</div></td>
              <td class="fontForm">&nbsp;</td>         
    		  <td height="30"><div align="left">
                <form:checkbox path="cepr01030101Form.babyFlag" cssClass="fontForm" value="true" />
              </div></td>
			  <td width="257" class="tdFormError">
        		<form:errors path="cepr01030101Form.babyFlag"/>
    		   </td>    
    		</tr>
          </table>
	    </TD>
	...
	<tr>
		...
		<td colspan="4">&nbsp;			</td>
		<td height="24" class="fontLabel1" style="display: ${cepr01030000HoldingForm.cepr01030101Form.assurancePlanPackageListDisplay}"><fmt:message key="words.packages"/></td>
		<td colspan="4">&nbsp;			</td>
    </tr>
	<TR>
		<TD height="170" colspan="4" style="background-image:url(${path}/include/images/bg_form3.jpg); background-repeat:repeat-x; ">
          <p>&nbsp;</p>
	    ...
	    <td height="170" colspan="5" style="background-image:url(${path}/include/images/bg_form3.jpg); background-repeat:repeat-x; ">
		<table width="350;" border="0" cellpadding="0" cellspacing="0" style="display: ${cepr01030000HoldingForm.cepr01030101Form.assurancePlanPackageListDisplay}">
          <p>&nbsp;</p>
            <tr>
              <td width="130" height="33" class="fontForm"><div align="right"></div></td>
              <td width="1" class="fontForm">&nbsp;</td>
              <td width="213" height="33"><div align="left">
                  <form:select path="cepr01030101Form.assurancePlanPackageCd1" cssClass="fontForm" id="assurancePlanPackageCd1" onchange="cekKetProduk();"
                     items="${cepr01030000HoldingForm.cepr01030101Form.assurancePlanPackageList}" itemLabel="label"
                     itemValue="value"/>
              </div></td>
			  <td width="257" class="tdFormError">
        		<form:errors path="cepr01030101Form.assurancePlanPackageCd1"/>
    		  </td>
            </tr>
              <tr>
              <td width="130" height="33" class="fontForm"><div align="right"></div></td>
	...
	<TR>
		<TD height="137" colspan="9" style="background-image:url(${path}/include/images/bg_form4.jpg); background-repeat:repeat-x; ">
          <p>&nbsp;</p>
          <table width="600" border="0" cellpadding="0" cellspacing="0" style="display: ${cepr01030000HoldingForm.cepr01030101Form.disajikanListDisplay}">
            <tr>
              <td width="130" height="33" class="fontForm"><div align="right"><fmt:message key="words.name"/> :</div></td>
              <td width="1" class="fontForm">&nbsp;</td>
              <td width="213" height="33"><div align="left">
         ...
         <table width="460" border="0" cellpadding="0" cellspacing="0" style="display: ${cepr01030000HoldingForm.cepr01030101Form.disajikanAdminListDisplay}">
         <tr>
         
												 <td width="230"  class="fontForm"><div align="right"><fmt:message key="words.name"/> :</div></td>
												<td width="500">
												   
													<form:input path="cepr01030101Form.cariNamaAdminBC" id="cariNamaAdminBC" cssStyle="width: 120px;" cssClass="fontForm" onkeypress="if(event.keyCode==13){ document.getElementById('theEvent').value='onPressButtonCari'; checkEvent()}"/>													
													<input type="button" name="btncari1" value="Cari"
													onclick="document.getElementById('theEvent').value='onPressButtonCari'; checkEvent()"></td>
											</tr>
											<tr>
												<td width="230"  class="fontForm"><div align="right"><fmt:message key="words.code"/> :</div></td>
												<td width="500">
												<form:input path="cepr01030101Form.cariKodeAdminBC" id="cariKodeAdminBC" cssStyle="width: 44px;" cssClass="fontForm" onkeypress="if(event.keyCode==13){ document.getElementById('theEvent').value='onPressButtonCari2'; checkEvent()}"/>	
												<input type="button" name="btncari2" value="Cari"
													onclick="document.getElementById('theEvent').value='onPressButtonCari2'; checkEvent()"></td>
											</tr>
											<tr>
												<td width="130" height="33" class="fontForm"><div align="right">Agen Penutup :</div></td>
												<td>
													<div id="nama">
													<form:select path="cepr01030101Form.namaAdminBC" cssClass="fontForm" id="namaAdminBCList" onchange="cekKetProduk();" items="${cepr01030000HoldingForm.cepr01030101Form.namaAdminBCList}" itemLabel="label" itemValue="value"/>
													 </div>
													</td>
													 <td class="tdFormError">
													<form:errors path="cepr01030101Form.namaAdminBC"/>													
													</td>
											</tr>											
         </table>
          ...
          <table width="600" border="0" cellpadding="0" cellspacing="0">
           <tr>
              <td width="200" height="33" class="fontForm"><div align="right"><fmt:message key="words.proposalDate"/> :</div></td>
              <td class="fontForm">&nbsp;</td>
              <td width="713" height="30"><div align="left">
	...
	<TR>
		...
		<TD ><div align="center">
		<a href="#" onclick="document.getElementById('theEvent').value='onPressButtonNext'; checkEvent()" onmouseover="changeButtonBerikutToGlow();" onmouseout="changeButtonBerikutToNormal();">
	...
	<TR>
		...
		<div align="center" class="fontBot">Copyright &copy; 2008 PT. Asuransi Jiwa Sinarmas MSIG. All Right Reserved.<br>

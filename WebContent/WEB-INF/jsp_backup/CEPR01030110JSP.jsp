...
-->
 ...
 <script type="text/javascript">
        ...
        {
            document.getElementById( 'cepr01030110Form.participantVOList[' + rowIdx + '].name' ).value = '';
            document.getElementById( 'cepr01030110Form.participantVOList[' + rowIdx + '].birthDay' ).value = '';
            document.getElementById( '_cepr01030110Form.participantVOList[' + rowIdx + '].birthDay' ).value = '__/__/____';
            document.getElementById( 'cepr01030110Form.participantVOList[' + rowIdx + '].age' ).value = '';
            document.getElementById( 'cepr01030110Form.participantVOList[' + rowIdx + '].lsre_id').selectedIndex = 0;
        }
	...
	<TR>
        ...
        <c:forEach var="participantVO" items="${cepr01030000HoldingForm.cepr01030110Form.participantVOList}" varStatus="xt">
            <tr>
                ...
                <td>
                    <form:input path="cepr01030110Form.participantVOList[${xt.index}].age" cssClass="fontForm" cssStyle="width: 20px" readonly="true"/>
                </td>
                <td>

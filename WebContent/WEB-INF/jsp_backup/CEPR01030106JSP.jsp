	...
	<TR>
        ...
        <c:forEach var="participantVO" items="${cepr01030000HoldingForm.cepr01030106Form.participantVOList}" varStatus="xt">
            <tr>
                ...
                <td>
                    <form:input path="cepr01030106Form.participantVOList[${xt.index}].age" cssClass="fontForm" cssStyle="width: 20px" readonly="true"/>
                </td>
                <td>
                    <form:select path="cepr01030106Form.participantVOList[${xt.index}].lsre_id" cssClass="fontForm">
